.section .late_rodata
nonmatching D_8022FA30_ovl19

dlabel D_8022FA30_ovl19
    /* 250140 8022FA30 477FFF00 */ .float 65535
enddlabel D_8022FA30_ovl19
.size D_8022FA30_ovl19, . - D_8022FA30_ovl19


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8022CE18_ovl19, 0x324

glabel func_8022CE18_ovl19
    /* 24D528 8022CE18 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 24D52C 8022CE1C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* 24D57C 8022CE6C 0C02C7DA */  jal        setProcessMain
    /* 24D580 8022CE70 24A51870 */   addiu     $a1, $a1, %lo(func_800B1870)
    /* 24D584 8022CE74 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 24D588 8022CE78 0C02BB30 */  jal        func_800AECC0
    /* 24D58C 8022CE7C C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 24D590 8022CE80 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 24D594 8022CE84 0C02BB48 */  jal        func_800AED20
    /* 24D598 8022CE88 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 24D59C 8022CE8C 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* 24D5A0 8022CE90 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
    ...
    /* 24D5C4 8022CEB4 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 24D5C8 8022CEB8 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* 24D5E8 8022CED8 3C058005 */  lui        $a1, %hi(omCurrentObj)
    /* 24D5EC 8022CEDC 24A5A7C4 */  addiu      $a1, $a1, %lo(omCurrentObj)
  ...
  .L8022CF58_ovl19:
    ...
    /* 24D708 8022CFF8 0C008322 */  jal        auFunc80020C88
    ...
    /* 24D724 8022D014 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    ...
    /* 24D738 8022D028 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L8022D068_ovl19:
    ...
    /* 24D7BC 8022D0AC 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 24D7C0 8022D0B0 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8022D124_ovl19:
    /* 24D834 8022D124 0C02BE85 */  jal        curObjSleepForever
