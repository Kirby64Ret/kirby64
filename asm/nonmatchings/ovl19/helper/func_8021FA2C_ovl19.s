.section .rodata
.align 2
nonmatching D_8022F720_ovl19

dlabel D_8022F720_ovl19
    /* 24FE30 8022F720 */ .asciz "drawItemReq  Request Error!![helper.cc]\n"
    /* 647261774974656D526571202052657175657374204572726F7221215B68656C7065722E63635D0A00000000 */
.align 2
enddlabel D_8022F720_ovl19
.size D_8022F720_ovl19, . - D_8022F720_ovl19


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8021FA2C_ovl19, 0x250

glabel func_8021FA2C_ovl19
    /* 24013C 8021FA2C 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 240140 8021FA30 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 240188 8021FA78 3C038005 */   lui       $v1, %hi(omCurrentObj)
  .L8021FA7C_ovl19:
  ...
  .L8021FA90_ovl19:
    ...
    /* 2401A4 8021FA94 0C02909C */  jal        utilPrintf
  ...
  .L8021FAA4_ovl19:
    /* 2401B4 8021FAA4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8021FB40_ovl19:
    ...
    /* 24034C 8021FC3C 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 240350 8021FC40 E4206D90 */  swc1       $f0, %lo(D_800E6D90)($at)
    /* 240354 8021FC44 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
