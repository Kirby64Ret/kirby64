.section .late_rodata
nonmatching jtbl_80197250_ovl3

dlabel jtbl_80197250_ovl3
    /* F7C90 80197250 8016B4B8 */ .word .L8016B4B8_ovl3
    /* F7C94 80197254 8016B734 */ .word .L8016B734_ovl3
    /* F7C98 80197258 8016B734 */ .word .L8016B734_ovl3
    /* F7C9C 8019725C 8016B734 */ .word .L8016B734_ovl3
    /* F7CA0 80197260 8016B538 */ .word .L8016B538_ovl3
    /* F7CA4 80197264 8016B6F4 */ .word .L8016B6F4_ovl3
    /* F7CA8 80197268 8016B734 */ .word .L8016B734_ovl3
enddlabel jtbl_80197250_ovl3
.size jtbl_80197250_ovl3, . - jtbl_80197250_ovl3

nonmatching D_8019726C_ovl3

dlabel D_8019726C_ovl3
    /* F7CAC 8019726C 3F4CCCCD */ .float 0.8000000119
enddlabel D_8019726C_ovl3
.size D_8019726C_ovl3, . - D_8019726C_ovl3

nonmatching D_80197270_ovl3

dlabel D_80197270_ovl3
    /* F7CB0 80197270 3FC90FDB */ .float 1.570796371
enddlabel D_80197270_ovl3
.size D_80197270_ovl3, . - D_80197270_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016B410_ovl3, 0x33C
...
glabel func_8016B410_ovl3
  ...
  .L8016B47C_ovl3:
    /* CBEBC 8016B47C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* CBEC0 8016B480 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8016B538_ovl3:
    ...
    /* CBFAC 8016B56C 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* CBFB0 8016B570 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8016B590_ovl3:
    ...
    /* CC008 8016B5C8 3C098005 */  lui        $t1, %hi(omCurrentObj)
  ...
  .L8016B5DC_ovl3:
    /* CC01C 8016B5DC 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L8016B608_ovl3:
    ...
    /* CC050 8016B610 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* CC054 8016B614 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8016B6D0_ovl3:
    /* CC110 8016B6D0 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* CC114 8016B6D4 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
