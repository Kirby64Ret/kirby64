.section .late_rodata
nonmatching D_80196EC0_ovl3

dlabel D_80196EC0_ovl3
    /* F7900 80196EC0 3EC90FDB */ .float 0.3926990926
enddlabel D_80196EC0_ovl3
.size D_80196EC0_ovl3, . - D_80196EC0_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801530BC_ovl3, 0x5AC

glabel func_801530BC_ovl3
    /* B3AFC 801530BC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* B3B00 801530C0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801531BC_ovl3:
    /* B3BFC 801531BC 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* B3C00 801531C0 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L801532E0_ovl3:
    /* B3D20 801532E0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* B3D24 801532E4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L80153368_ovl3:
    ...
    /* B3DB0 80153370 54CE0004 */  bnel       $a2, $t6, .L80153384_ovl3
  ...
  .L80153390_ovl3:
    /* B3DD0 80153390 11890009 */  beq        $t4, $t1, .L801533B8_ovl3
    ...
    /* B3DE8 801533A8 14CE0003 */  bne        $a2, $t6, .L801533B8_ovl3
  ...
  .L801533D8_ovl3:
    ...
    /* B3E50 80153410 05E10004 */  bgez       $t7, .L80153424_ovl3
  ...
  .L8015344C_ovl3:
    ...
    /* B3EA8 80153468 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    ...
    /* B3EC4 80153484 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L8015349C_ovl3:
    ...
    /* B3F04 801534C4 10000048 */  b          .L801535E8_ovl3
  ...
  .L801534CC_ovl3:
    ...
    /* B3F18 801534D8 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* B3F1C 801534DC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801535A8_ovl3:
    ...
    /* B4000 801535C0 10000009 */  b          .L801535E8_ovl3
    /* B4004 801535C4 24020001 */   addiu     $v0, $zero, 0x1
  .L801535C8_ovl3:
    /* B4008 801535C8 55690007 */  bnel       $t3, $t1, .L801535E8_ovl3
    /* B400C 801535CC 8FA20118 */   lw        $v0, 0x118($sp)
    /* B4010 801535D0 51890005 */  beql       $t4, $t1, .L801535E8_ovl3
    /* B4014 801535D4 8FA20118 */   lw        $v0, 0x118($sp)
    /* B4018 801535D8 11A90002 */  beq        $t5, $t1, .L801535E4_ovl3
    /* B401C 801535DC 24020003 */   addiu     $v0, $zero, 0x3
    /* B4020 801535E0 AFA20118 */  sw         $v0, 0x118($sp)
  .L801535E4_ovl3:
    /* B4024 801535E4 8FA20118 */  lw         $v0, 0x118($sp)
  .L801535E8_ovl3:
    /* B4028 801535E8 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* B402C 801535EC 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
