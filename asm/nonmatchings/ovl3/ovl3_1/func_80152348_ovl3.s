nonmatching func_80152348_ovl3, 0x4E0
...
glabel func_80152348_ovl3
    ...
    /* B2E0C 801523CC 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B2E10 801523D0 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L801524A4_ovl3:
    ...
    /* B2F10 801524D0 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B2F14 801524D4 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
    ...
    /* B2F5C 8015251C 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B2F60 80152520 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L80152548_ovl3:
    ...
    /* B2FC8 80152588 45030017 */  bc1tl      .L801525E8_ovl3
  ...
  .L80152594_ovl3:
    ...
    /* B2FE0 801525A0 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B2FE4 801525A4 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L801525E8_ovl3:
    ...
    /* B3040 80152600 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B3044 80152604 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
    ...
    /* B30A4 80152664 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* B30A8 80152668 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L8015272C_ovl3:
    ...
    /* B3170 80152730 54AD0006 */  bnel       $a1, $t5, .L8015274C_ovl3
  ...
  .L80152794_ovl3:
    ...
    /* B31DC 8015279C 3C028013 */  lui        $v0, %hi(D_8012E944 + 0x4)
    ...
    /* B31EC 801527AC 2442E948 */  addiu      $v0, $v0, %lo(D_8012E944 + 0x4)
