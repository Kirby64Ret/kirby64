.section .late_rodata
nonmatching D_80197068_ovl3

dlabel D_80197068_ovl3
    /* F7AA8 80197068 3E4CCCCD */ .float 0.200000003
enddlabel D_80197068_ovl3
.size D_80197068_ovl3, . - D_80197068_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015BBE4_ovl3, 0x428
...
glabel func_8015BBE4_ovl3
    ...
    /* BC64C 8015BC0C 3C128005 */  lui        $s2, %hi(omCurrentObj)
    /* BC650 8015BC10 2652A7C4 */  addiu      $s2, $s2, %lo(omCurrentObj)
    ...
    /* BC680 8015BC40 3C0B8016 */  lui        $t3, %hi(func_8015C00C_ovl3)
    ...
    /* BC698 8015BC58 256BC00C */  addiu      $t3, $t3, %lo(func_8015C00C_ovl3)
  ...
  .L8015BF8C_ovl3:
    /* BC9CC 8015BF8C 0C002DAF */  jal        ohSleep
  ...
  .L8015BFCC_ovl3:
    ...
    /* BCA2C 8015BFEC 0C02BE85 */  jal        curObjSleepForever
