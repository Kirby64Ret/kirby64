.section .late_rodata
nonmatching D_8019709C_ovl3

dlabel D_8019709C_ovl3
    /* F7ADC 8019709C 3E4CCCCD */ .float 0.200000003
enddlabel D_8019709C_ovl3
.size D_8019709C_ovl3, . - D_8019709C_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015E8E0_ovl3, 0x44C

glabel func_8015E8E0_ovl3
    /* BF320 8015E8E0 27BDFFA8 */  addiu      $sp, $sp, -0x58
    /* BF324 8015E8E4 AFB2001C */  sw         $s2, 0x1C($sp)
    /* BF328 8015E8E8 3C128005 */  lui        $s2, %hi(omCurrentObj)
    /* BF32C 8015E8EC 2652A7C4 */  addiu      $s2, $s2, %lo(omCurrentObj)
    ...
    /* BF514 8015EAD4 3C01800F */  lui        $at, %hi(D_800E8060)
    ...
    /* BF52C 8015EAEC AC208060 */  sw         $zero, %lo(D_800E8060)($at)
  ...
  .L8015EC84_ovl3:
    ...
    /* BF6CC 8015EC8C 10000007 */  b          .L8015ECAC_ovl3
    /* BF6D0 8015EC90 E4246850 */   swc1      $f4, %lo(D_800E6850)($at)
  .L8015EC94_ovl3:
    /* BF6D4 8015EC94 54600004 */  bnel       $v1, $zero, .L8015ECA8_ovl3
    /* BF6D8 8015EC98 46006006 */   mov.s     $f0, $f12
    /* BF6DC 8015EC9C 10000002 */  b          .L8015ECA8_ovl3
  ...
  .L8015ECC0_ovl3:
    ...
    /* BF718 8015ECD8 0C002DAF */  jal        ohSleep
    /* BF71C 8015ECDC 24040001 */   addiu     $a0, $zero, 0x1
    /* BF720 8015ECE0 26100001 */  addiu      $s0, $s0, 0x1
    /* BF724 8015ECE4 5611FFF6 */  bnel       $s0, $s1, .L8015ECC0_ovl3
    /* BF728 8015ECE8 8E4C0000 */   lw        $t4, 0x0($s2)
    /* BF72C 8015ECEC 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* BF730 8015ECF0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L8015ECFC_ovl3:
    ...
    /* BF748 8015ED08 0C02BE85 */  jal        curObjSleepForever
