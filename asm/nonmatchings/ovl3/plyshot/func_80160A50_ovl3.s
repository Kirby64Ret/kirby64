.section .late_rodata
nonmatching D_801970DC_ovl3

dlabel D_801970DC_ovl3
    /* F7B1C 801970DC 3E4CCCCD */ .float 0.200000003
enddlabel D_801970DC_ovl3
.size D_801970DC_ovl3, . - D_801970DC_ovl3

nonmatching D_801970E0_ovl3

dlabel D_801970E0_ovl3
    /* F7B20 801970E0 477FFF00 */ .float 65535
enddlabel D_801970E0_ovl3
.size D_801970E0_ovl3, . - D_801970E0_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80160A50_ovl3, 0x334

glabel func_80160A50_ovl3
    /* C1490 80160A50 27BDFFE0 */  addiu      $sp, $sp, -0x20
    /* C1494 80160A54 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* C1498 80160A58 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* C14D4 80160A94 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* C14D8 80160A98 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
    ...
    /* C157C 80160B3C 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* C1580 80160B40 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
    ...
    /* C15DC 80160B9C 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* C15E0 80160BA0 8CE5A7C4 */  lw         $a1, %lo(omCurrentObj)($a3)
    ...
    /* C1610 80160BD0 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* C1614 80160BD4 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L80160C28_ovl3:
    ...
    /* C16E4 80160CA4 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* C16E8 80160CA8 1000000D */  b          .L80160CE0_ovl3
    /* C16EC 80160CAC 8CE7A7C4 */   lw        $a3, %lo(omCurrentObj)($a3)
  ...
  .L80160CB4_ovl3:
    ...
    /* C16FC 80160CBC 0C002DAF */  jal        ohSleep
    /* C1700 80160CC0 24040001 */   addiu     $a0, $zero, 0x1
    /* C1704 80160CC4 3C078005 */  lui        $a3, %hi(omCurrentObj)
    ...
    /* C171C 80160CDC 8CE7A7C4 */   lw        $a3, %lo(omCurrentObj)($a3)
  .L80160CE0_ovl3:
    /* C1720 80160CE0 24040001 */  addiu      $a0, $zero, 0x1
  .L80160CE4_ovl3:
    /* C1724 80160CE4 0C02BEED */  jal        func_800AFBB4
    /* C1728 80160CE8 00E02825 */   or        $a1, $a3, $zero
    /* C172C 80160CEC 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* C1730 80160CF0 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* C1768 80160D28 0C002DAF */  jal        ohSleep
    /* C176C 80160D2C 2404000A */   addiu     $a0, $zero, 0xA
    /* C1770 80160D30 10000007 */  b          .L80160D50_ovl3
    /* C1774 80160D34 00000000 */   nop
  .L80160D38_ovl3:
    /* C1778 80160D38 0C002DAF */  jal        ohSleep
    /* C177C 80160D3C 24040002 */   addiu     $a0, $zero, 0x2
    /* C1780 80160D40 10000003 */  b          .L80160D50_ovl3
    /* C1784 80160D44 00000000 */   nop
  .L80160D48_ovl3:
    /* C1788 80160D48 0C002DAF */  jal        ohSleep
    /* C178C 80160D4C 2404000A */   addiu     $a0, $zero, 0xA
  .L80160D50_ovl3:
    /* C1790 80160D50 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* C1794 80160D54 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* C17A8 80160D68 0C02BE85 */  jal        curObjSleepForever
