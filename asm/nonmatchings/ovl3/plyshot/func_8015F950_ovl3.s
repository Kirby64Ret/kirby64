.section .late_rodata
nonmatching D_801970B4_ovl3

dlabel D_801970B4_ovl3
    /* F7AF4 801970B4 3E4CCCCD */ .float 0.200000003
enddlabel D_801970B4_ovl3
.size D_801970B4_ovl3, . - D_801970B4_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015F950_ovl3, 0x408
...
glabel func_8015F950_ovl3
    ...
    /* C03A0 8015F960 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* C03A4 8015F964 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* C03DC 8015F99C 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C03E0 8015F9A0 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* C04B8 8015FA78 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C04BC 8015FA7C 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* C052C 8015FAEC 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C0530 8015FAF0 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  ...
  .L8015FB64_ovl3:
    ...
    /* C05C4 8015FB84 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C05C8 8015FB88 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  ...
  .L8015FBF8_ovl3:
    ...
    /* C0658 8015FC18 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C065C 8015FC1C 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* C0694 8015FC54 45000008 */  bc1f       .L8015FC78_ovl3
  ...
  .L8015FCCC_ovl3:
    ...
    /* C0738 8015FCF8 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C073C 8015FCFC 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  .L8015FD00_ovl3:
    ...
    /* C077C 8015FD3C 0C02BE85 */  jal        curObjSleepForever
