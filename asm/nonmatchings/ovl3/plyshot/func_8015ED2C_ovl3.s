.section .late_rodata
nonmatching D_801970A0_ovl3

dlabel D_801970A0_ovl3
    /* F7AE0 801970A0 3E19999A */ .float 0.150000006
enddlabel D_801970A0_ovl3
.size D_801970A0_ovl3, . - D_801970A0_ovl3

nonmatching D_801970A4_ovl3

dlabel D_801970A4_ovl3
    /* F7AE4 801970A4 461C3C00 */ .float 9999
enddlabel D_801970A4_ovl3
.size D_801970A4_ovl3, . - D_801970A4_ovl3

nonmatching D_801970A8_ovl3

dlabel D_801970A8_ovl3
    /* F7AE8 801970A8 40490FDB */ .float 3.141592741
enddlabel D_801970A8_ovl3
.size D_801970A8_ovl3, . - D_801970A8_ovl3

nonmatching D_801970AC_ovl3

dlabel D_801970AC_ovl3
    /* F7AEC 801970AC 40490FDB */ .float 3.141592741
enddlabel D_801970AC_ovl3
.size D_801970AC_ovl3, . - D_801970AC_ovl3

nonmatching D_801970B0_ovl3

dlabel D_801970B0_ovl3
    /* F7AF0 801970B0 40490FDB */ .float 3.141592741
enddlabel D_801970B0_ovl3
.size D_801970B0_ovl3, . - D_801970B0_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015ED2C_ovl3, 0xC24

glabel func_8015ED2C_ovl3
    /* BF76C 8015ED2C 27BDFF58 */  addiu      $sp, $sp, -0xA8
    /* BF770 8015ED30 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* BF774 8015ED34 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
    ...
    /* BF7A8 8015ED68 11C00021 */  beqz       $t6, .L8015EDF0_ovl3
    ...
    /* BF7E4 8015EDA4 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* BF7E8 8015EDA8 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8015EF14_ovl3:
    ...
    /* BF96C 8015EF2C 3C01800F */  lui        $at, %hi(D_800E8060)
    ...
    /* BF980 8015EF40 AC398060 */  sw         $t9, %lo(D_800E8060)($at)
  .L8015EF44_ovl3:
  ...
  .L8015EF48_ovl3:
    ...
    /* BF9F4 8015EFB4 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* BF9F8 8015EFB8 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* BFA64 8015F024 3C188005 */  lui        $t8, %hi(omCurrentObj)
    ...
    /* BFA78 8015F038 3C108005 */   lui       $s0, %hi(omCurrentObj)
    /* BFA7C 8015F03C 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L8015F05C_ovl3:
    /* BFA9C 8015F05C 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* BFAE0 8015F0A0 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* BFAE4 8015F0A4 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L8015F0AC_ovl3:
    ...
    /* BFB04 8015F0C4 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* BFB08 8015F0C8 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8015F170_ovl3:
    ...
    /* BFBE4 8015F1A4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BFBE8 8015F1A8 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* BFDAC 8015F36C 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BFDB0 8015F370 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* BFE0C 8015F3CC 3C108005 */  lui        $s0, %hi(omCurrentObj)
  ...
  .L8015F3FC_ovl3:
    ...
    /* BFE40 8015F400 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* BFEBC 8015F47C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BFEC0 8015F480 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L8015F4F8_ovl3:
    ...
    /* BFF78 8015F538 1000000F */  b          .L8015F578_ovl3
  ...
  .L8015F578_ovl3:
    ...
    /* BFFC4 8015F584 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BFFC8 8015F588 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8015F5D0_ovl3:
    ...
    /* C001C 8015F5DC 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C0020 8015F5E0 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  ...
  .L8015F654_ovl3:
    ...
    /* C00A0 8015F660 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C00A4 8015F664 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  ...
  .L8015F758_ovl3:
    ...
    /* C01A0 8015F760 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* C01A4 8015F764 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8015F7E8_ovl3:
    ...
    /* C0230 8015F7F0 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* C0234 8015F7F4 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8015F840_ovl3:
    /* C0280 8015F840 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* C0284 8015F844 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
    ...
    /* C0304 8015F8C4 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* C0308 8015F8C8 8E05A7C4 */  lw         $a1, %lo(omCurrentObj)($s0)
    ...
    /* C0330 8015F8F0 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* C0334 8015F8F4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
