.section .late_rodata
nonmatching D_80197054_ovl3

dlabel D_80197054_ovl3
    /* F7A94 80197054 3E4CCCCD */ .float 0.200000003
enddlabel D_80197054_ovl3
.size D_80197054_ovl3, . - D_80197054_ovl3

nonmatching D_80197058_ovl3

dlabel D_80197058_ovl3
    /* F7A98 80197058 BECCCCCD */ .float -0.400000006
enddlabel D_80197058_ovl3
.size D_80197058_ovl3, . - D_80197058_ovl3

nonmatching D_8019705C_ovl3

dlabel D_8019705C_ovl3
    /* F7A9C 8019705C BF7B0CDD */ .float -0.9806650281
enddlabel D_8019705C_ovl3
.size D_8019705C_ovl3, . - D_8019705C_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015B190_ovl3, 0x5CC

glabel func_8015B190_ovl3
    /* BBBD0 8015B190 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BBBD4 8015B194 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BBCA8 8015B268 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BBCAC 8015B26C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    /* BBCB0 8015B270 3C01800F */  lui        $at, %hi(D_800EA520)
    /* BBCB4 8015B274 3C0A8013 */  lui        $t2, %hi(D_8012E7FC)
    /* BBCB8 8015B278 8C6C0000 */  lw         $t4, 0x0($v1)
    /* BBCBC 8015B27C 8D4AE7FC */  lw         $t2, %lo(D_8012E7FC)($t2)
  ...
  .L8015B2A4_ovl3:
    /* BBCE4 8015B2A4 0C002DAF */  jal        ohSleep
    /* BBCE8 8015B2A8 24040001 */   addiu     $a0, $zero, 0x1
    /* BBCEC 8015B2AC 3C198013 */  lui        $t9, %hi(D_8012E7FC)
    /* BBCF0 8015B2B0 8F39E7FC */  lw         $t9, %lo(D_8012E7FC)($t9)
    /* BBCF4 8015B2B4 1320FFFB */  beqz       $t9, .L8015B2A4_ovl3
    /* BBCF8 8015B2B8 00000000 */   nop
    /* BBCFC 8015B2BC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BBD00 8015B2C0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  .L8015B2C4_ovl3:
  ...
  .L8015B370_ovl3:
    ...
    /* BBDB8 8015B378 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* BBDBC 8015B37C 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
    ...
    /* BBDF4 8015B3B4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BBDF8 8015B3B8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BBE78 8015B438 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BBE7C 8015B43C 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* BBEAC 8015B46C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BBEB0 8015B470 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* BBED8 8015B498 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BBEDC 8015B49C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015B744_ovl3:
    /* BC184 8015B744 0C02BE85 */  jal        curObjSleepForever
