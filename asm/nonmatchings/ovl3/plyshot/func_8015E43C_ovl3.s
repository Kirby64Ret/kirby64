.section .late_rodata
nonmatching D_80197098_ovl3

dlabel D_80197098_ovl3
    /* F7AD8 80197098 3E4CCCCD */ .float 0.200000003
enddlabel D_80197098_ovl3
.size D_80197098_ovl3, . - D_80197098_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015E43C_ovl3, 0x318

glabel func_8015E43C_ovl3
    /* BEE7C 8015E43C 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* BEE80 8015E440 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* BEEB8 8015E478 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* BEEBC 8015E47C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8015E534_ovl3:
    ...
    /* BEFE0 8015E5A0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* BEFE4 8015E5A4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* BF07C 8015E63C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* BF080 8015E640 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* BF0B8 8015E678 45000008 */  bc1f       .L8015E69C_ovl3
  ...
  .L8015E71C_ovl3:
    ...
    /* BF17C 8015E73C 0C02BE85 */  jal        curObjSleepForever
