.section .late_rodata
nonmatching D_8019706C_ovl3

dlabel D_8019706C_ovl3
    /* F7AAC 8019706C 3E4CCCCD */ .float 0.200000003
enddlabel D_8019706C_ovl3
.size D_8019706C_ovl3, . - D_8019706C_ovl3

nonmatching D_80197070_ovl3

dlabel D_80197070_ovl3
    /* F7AB0 80197070 3FCCCCCD */ .float 1.600000024
enddlabel D_80197070_ovl3
.size D_80197070_ovl3, . - D_80197070_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015C7F4_ovl3, 0x490

glabel func_8015C7F4_ovl3
    /* BD234 8015C7F4 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* BD238 8015C7F8 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* BD26C 8015C82C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BD270 8015C830 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* BD298 8015C858 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BD29C 8015C85C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BD378 8015C938 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BD37C 8015C93C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015C9EC_ovl3:
    /* BD42C 8015C9EC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BD430 8015C9F0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BD460 8015CA20 3C198013 */  lui        $t9, %hi(D_8012E7FC + 0x8)
  ...
  .L8015CA44_ovl3:
    /* BD484 8015CA44 8F39E804 */  lw         $t9, %lo(D_8012E7FC + 0x8)($t9)
  ...
  .L8015CAB4_ovl3:
    /* BD4F4 8015CAB4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BD4F8 8015CAB8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015CC4C_ovl3:
    ...
    /* BD694 8015CC54 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* BD698 8015CC58 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* BD6AC 8015CC6C 0C02BE85 */  jal        curObjSleepForever
