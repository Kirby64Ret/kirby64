.section .late_rodata
nonmatching D_801970B8_ovl3

dlabel D_801970B8_ovl3
    /* F7AF8 801970B8 40490FDB */ .float 3.141592741
enddlabel D_801970B8_ovl3
.size D_801970B8_ovl3, . - D_801970B8_ovl3

nonmatching D_801970BC_ovl3

dlabel D_801970BC_ovl3
    /* F7AFC 801970BC 3DB2B8C3 */ .float 0.08726646751
enddlabel D_801970BC_ovl3
.size D_801970BC_ovl3, . - D_801970BC_ovl3

nonmatching D_801970C0_ovl3

dlabel D_801970C0_ovl3
    /* F7B00 801970C0 402B760E */ .float 2.679080486
enddlabel D_801970C0_ovl3
.size D_801970C0_ovl3, . - D_801970C0_ovl3

nonmatching D_801970C4_ovl3

dlabel D_801970C4_ovl3
    /* F7B04 801970C4 3DB2B8C3 */ .float 0.08726646751
enddlabel D_801970C4_ovl3
.size D_801970C4_ovl3, . - D_801970C4_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015FD58_ovl3, 0x620
...
glabel func_8015FD58_ovl3
    ...
    /* C07A8 8015FD68 1040016C */  beqz       $v0, .L8016031C_ovl3
    /* C07AC 8015FD6C 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* C07B0 8015FD70 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8015FDC4_ovl3:
    /* C0804 8015FDC4 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* C0808 8015FDC8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8015FDEC_ovl3:
    ...
    /* C0840 8015FE00 1160001B */  beqz       $t3, .L8015FE70_ovl3
    /* C0844 8015FE04 00000000 */   nop
    /* C0848 8015FE08 0C0445EF */  jal        func_801117BC
    /* C084C 8015FE0C 01002825 */   or        $a1, $t0, $zero
    /* C0850 8015FE10 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* C0854 8015FE14 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
    ...
    /* C0880 8015FE40 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0884 8015FE44 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8015FE70_ovl3:
    ...
    /* C095C 8015FF1C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0960 8015FF20 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* C0990 8015FF50 10A00005 */  beqz       $a1, .L8015FF68_ovl3
  ...
  .L8015FF68_ovl3:
    ...
    /* C09E0 8015FFA0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C09E4 8015FFA4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* C0A78 80160038 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* C0A8C 8016004C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* C0AB4 80160074 45000004 */  bc1f       .L80160088_ovl3
  ...
  .L801600E4_ovl3:
    ...
    /* C0B30 801600F0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0B34 801600F4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80160154_ovl3:
    ...
    /* C0BA4 80160164 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0BA8 80160168 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801601DC_ovl3:
    ...
    /* C0C2C 801601EC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0C30 801601F0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80160278_ovl3:
    ...
    /* C0CD4 80160294 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* C0CD8 80160298 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801602D4_ovl3:
    ...
    /* C0D1C 801602DC 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* C0D20 801602E0 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L8016031C_ovl3:
    ...
    /* C0D68 80160328 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    ...
    /* C0D78 80160338 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80160358_ovl3:
    /* C0D98 80160358 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* C0D9C 8016035C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
