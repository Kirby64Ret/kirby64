.section .late_rodata
nonmatching D_8019708C_ovl3

dlabel D_8019708C_ovl3
    /* F7ACC 8019708C 477FFF00 */ .float 65535
enddlabel D_8019708C_ovl3
.size D_8019708C_ovl3, . - D_8019708C_ovl3

nonmatching D_80197090_ovl3

dlabel D_80197090_ovl3
    /* F7AD0 80197090 3E4CCCCD */ .float 0.200000003
enddlabel D_80197090_ovl3
.size D_80197090_ovl3, . - D_80197090_ovl3

nonmatching D_80197094_ovl3

dlabel D_80197094_ovl3
    /* F7AD4 80197094 3D8F5C29 */ .float 0.0700000003
enddlabel D_80197094_ovl3
.size D_80197094_ovl3, . - D_80197094_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015DBE4_ovl3, 0x858
...
glabel func_8015DBE4_ovl3
    ...
    /* BE63C 8015DBFC 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* BE640 8015DC00 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* BE644 8015DC04 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* BE66C 8015DC2C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BE670 8015DC30 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* BE68C 8015DC4C 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BE690 8015DC50 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* BE6B8 8015DC78 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* BE6BC 8015DC7C 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8015DC94_ovl3:
    /* BE6D4 8015DC94 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015DCD4_ovl3:
    ...
    /* BE728 8015DCE8 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* BE72C 8015DCEC 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* BE748 8015DD08 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BE74C 8015DD0C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BE768 8015DD28 5080000B */  beql       $a0, $zero, .L8015DD58_ovl3
    /* BE76C 8015DD2C AC400000 */   sw        $zero, 0x0($v0)
    /* BE770 8015DD30 0C0287CC */  jal        func_800A1F30
    /* BE774 8015DD34 00000000 */   nop
    /* BE778 8015DD38 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BE77C 8015DD3C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015DDE8_ovl3:
    ...
    /* BE874 8015DE34 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BE878 8015DE38 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015DEE4_ovl3:
    ...
    /* BE964 8015DF24 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BE968 8015DF28 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BE9F8 8015DFB8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BE9FC 8015DFBC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015E000_ovl3:
    ...
    /* BEAC0 8015E080 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* BEAC4 8015E084 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* BEAF0 8015E0B0 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* BEAF4 8015E0B4 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8015E0C4_ovl3:
    ...
    /* BEB14 8015E0D4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BEB18 8015E0D8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015E134_ovl3:
    ...
    /* BEBC8 8015E188 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BEBCC 8015E18C 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* BEBF8 8015E1B8 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* BEBFC 8015E1BC 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8015E1C8_ovl3:
    ...
    /* BEC34 8015E1F4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BEC38 8015E1F8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015E218_ovl3:
    ...
    /* BECC0 8015E280 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    ...
    /* BED04 8015E2C4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* BED44 8015E304 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    ...
    /* BED84 8015E344 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* BEDCC 8015E38C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    ...
    /* BEE04 8015E3C4 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
