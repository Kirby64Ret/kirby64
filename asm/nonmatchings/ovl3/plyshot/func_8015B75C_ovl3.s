.section .late_rodata
nonmatching D_80197060_ovl3

dlabel D_80197060_ovl3
    /* F7AA0 80197060 BECCCCCD */ .float -0.400000006
enddlabel D_80197060_ovl3
.size D_80197060_ovl3, . - D_80197060_ovl3

nonmatching D_80197064_ovl3

dlabel D_80197064_ovl3
    /* F7AA4 80197064 BF7B0CDD */ .float -0.9806650281
enddlabel D_80197064_ovl3
.size D_80197064_ovl3, . - D_80197064_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015B75C_ovl3, 0x488
...
glabel func_8015B75C_ovl3
    ...
    /* BC1B8 8015B778 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* BC1BC 8015B77C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8015B7BC_ovl3:
    ...
    /* BC204 8015B7C4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* BC208 8015B7C8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L8015B7DC_ovl3:
    ...
    /* BC228 8015B7E8 3C068005 */   lui       $a2, %hi(omCurrentObj)
    /* BC22C 8015B7EC 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* BC230 8015B7F0 100000B9 */  b          .L8015BAD8_ovl3
    /* BC234 8015B7F4 8CC6A7C4 */   lw        $a2, %lo(omCurrentObj)($a2)
  .L8015B7F8_ovl3:
    /* BC238 8015B7F8 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* BC2D8 8015B898 3C068005 */   lui       $a2, %hi(omCurrentObj)
    /* BC2DC 8015B89C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8015B9E0_ovl3:
    ...
    /* BC428 8015B9E8 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* BC42C 8015B9EC 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
    ...
    /* BC448 8015BA08 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* BC44C 8015BA0C 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8015BA1C_ovl3:
    ...
    /* BC464 8015BA24 0C05A4F1 */  jal        func_801693C4_ovl3
    ...
    /* BC474 8015BA34 3C068005 */   lui       $a2, %hi(omCurrentObj)
    /* BC478 8015BA38 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8015BAD0_ovl3:
    /* BC510 8015BAD0 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* BC514 8015BAD4 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  .L8015BAD8_ovl3:
    ...
    /* BC534 8015BAF4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* BC538 8015BAF8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* BC554 8015BB14 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* BC558 8015BB18 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L8015BB2C_ovl3:
    ...
    /* BC5A0 8015BB60 3C198005 */  lui        $t9, %hi(omCurrentObj)
    ...
    /* BC5D0 8015BB90 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
