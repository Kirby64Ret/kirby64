.section .late_rodata
nonmatching D_80197344_ovl3

dlabel D_80197344_ovl3
    /* F7D84 80197344 3ECCCCCD */ .float 0.400000006
enddlabel D_80197344_ovl3
.size D_80197344_ovl3, . - D_80197344_ovl3

nonmatching D_80197348_ovl3

dlabel D_80197348_ovl3
    /* F7D88 80197348 477FFF00 */ .float 65535
enddlabel D_80197348_ovl3
.size D_80197348_ovl3, . - D_80197348_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016C558_ovl3, 0x534
...
glabel func_8016C558_ovl3
  ...
  .L8016C5A4_ovl3:
    /* CCFE4 8016C5A4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* CCFE8 8016C5A8 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* CD008 8016C5C8 0C02911F */  jal        utilFuncTableJump
  ...
  .L8016C5EC_ovl3:
    ...
    /* CD030 8016C5F0 51400006 */  beql       $t2, $zero, .L8016C60C_ovl3
  ...
  .L8016C6C0_ovl3:
    /* CD100 8016C6C0 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* CD104 8016C6C4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8016C704_ovl3:
    ...
    /* CD180 8016C740 0C05A4F1 */  jal        func_801693C4_ovl3
    ...
    /* CD198 8016C758 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* CD19C 8016C75C 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8016C7A0_ovl3:
    /* CD1E0 8016C7A0 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* CD1E4 8016C7A4 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
    ...
    /* CD1F8 8016C7B8 14610021 */  bne        $v1, $at, .L8016C840_ovl3
    ...
    /* CD218 8016C7D8 3C028013 */  lui        $v0, %hi(D_8012E944)
    /* CD21C 8016C7DC 2442E944 */  addiu      $v0, $v0, %lo(D_8012E944)
    /* CD220 8016C7E0 8C4F0000 */  lw         $t7, 0x0($v0)
    /* CD224 8016C7E4 C7B20024 */  lwc1       $f18, 0x24($sp)
    /* CD228 8016C7E8 3C088005 */  lui        $t0, %hi(omCurrentObj)
    ...
    /* CD250 8016C810 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* CD254 8016C814 E726000C */  swc1       $f6, 0xC($t9)
    /* CD258 8016C818 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
    ...
    /* CD27C 8016C83C 8C84A7C4 */   lw        $a0, %lo(omCurrentObj)($a0)
  .L8016C840_ovl3:
    /* CD280 8016C840 3C0C800E */  lui        $t4, %hi(gEntityFuncListIDArray)
    /* CD284 8016C844 01826021 */  addu       $t4, $t4, $v0
    /* CD288 8016C848 8D8CDC50 */  lw         $t4, %lo(gEntityFuncListIDArray)($t4)
    /* CD28C 8016C84C 24010050 */  addiu      $at, $zero, 0x50
    /* CD290 8016C850 11810009 */  beq        $t4, $at, .L8016C878_ovl3
    /* CD294 8016C854 3C028013 */   lui       $v0, %hi(D_8012E944)
    /* CD298 8016C858 2442E944 */  addiu      $v0, $v0, %lo(D_8012E944)
    ...
    /* CD2AC 8016C86C 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* CD2B0 8016C870 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L8016CA14_ovl3:
    ...
    /* CD468 8016CA28 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* CD46C 8016CA2C 14400012 */  bnez       $v0, .L8016CA78_ovl3
    /* CD470 8016CA30 2448FFFF */   addiu     $t0, $v0, -0x1
    /* CD474 8016CA34 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* CD4A8 8016CA68 53000005 */  beql       $t8, $zero, .L8016CA80_ovl3
...
endlabel func_8016C558_ovl3
.size func_8016C558_ovl3, . - func_8016C558_ovl3
