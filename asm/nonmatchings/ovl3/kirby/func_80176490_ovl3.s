.section .late_rodata
nonmatching D_801974B8_ovl3

dlabel D_801974B8_ovl3
    /* F7EF8 801974B8 3E4CCCCD */ .float 0.200000003
enddlabel D_801974B8_ovl3
.size D_801974B8_ovl3, . - D_801974B8_ovl3

nonmatching D_801974BC_ovl3

dlabel D_801974BC_ovl3
    /* F7EFC 801974BC 477FFF00 */ .float 65535
enddlabel D_801974BC_ovl3
.size D_801974BC_ovl3, . - D_801974BC_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80176490_ovl3, 0x384
...
glabel func_80176490_ovl3
    ...
    /* D6EEC 801764AC 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* D6EF0 801764B0 AFA40020 */  sw         $a0, 0x20($sp)
    /* D6EF4 801764B4 0C02BB30 */  jal        func_800AECC0
    /* D6EF8 801764B8 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* D6EFC 801764BC 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* D6F00 801764C0 0C02BB48 */  jal        func_800AED20
    /* D6F04 801764C4 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* D6F08 801764C8 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* D6F0C 801764CC 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* D6F34 801764F4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* D6F38 801764F8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* D6F54 80176514 0C02C7DA */  jal        setProcessMain
    ...
    /* D6F68 80176528 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D6F6C 8017652C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* D6FE0 801765A0 3C01800D */  lui        $at, %hi(D_800D6F10)
    /* D6FE4 801765A4 AC206F10 */  sw         $zero, %lo(D_800D6F10)($at)
    ...
    /* D7008 801765C8 3C01800F */  lui        $at, %hi(D_800E8060)
    ...
    /* D7018 801765D8 AC2C8060 */  sw         $t4, %lo(D_800E8060)($at)
  ...
  .L801766AC_ovl3:
    ...
    /* D70F4 801766B4 0C008322 */  jal        auFunc80020C88
  ...
  .L801766E8_ovl3:
    ...
    /* D712C 801766EC 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    ...
    /* D7140 80176700 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80176760_ovl3:
    ...
    /* D71AC 8017676C 0C008266 */  jal        auSetBGMVolume
    ...
    /* D7238 801767F8 0C02BE85 */  jal        curObjSleepForever
