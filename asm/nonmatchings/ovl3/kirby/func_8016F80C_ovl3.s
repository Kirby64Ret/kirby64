.section .late_rodata
nonmatching D_80197390_ovl3

dlabel D_80197390_ovl3
    /* F7DD0 80197390 477FFF00 */ .float 65535
enddlabel D_80197390_ovl3
.size D_80197390_ovl3, . - D_80197390_ovl3

nonmatching D_80197394_ovl3

dlabel D_80197394_ovl3
    /* F7DD4 80197394 BF7B0CDD */ .float -0.9806650281
enddlabel D_80197394_ovl3
.size D_80197394_ovl3, . - D_80197394_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016F80C_ovl3, 0x34C

glabel func_8016F80C_ovl3
    /* D024C 8016F80C 27BDFFE0 */  addiu      $sp, $sp, -0x20
    /* D0250 8016F810 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* D0254 8016F814 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* D0280 8016F840 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D0284 8016F844 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8016F8B4_ovl3:
    ...
    /* D02FC 8016F8BC 0C002DAF */  jal        ohSleep
  ...
  .L8016F904_ovl3:
    /* D0344 8016F904 0C002DAF */  jal        ohSleep
  ...
  .L8016F918_ovl3:
    /* D0358 8016F918 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* D035C 8016F91C 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
    ...
    /* D037C 8016F93C 0C05A4F1 */  jal        func_801693C4_ovl3
  ...
  .L8016F970_ovl3:
    /* D03B0 8016F970 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D03B4 8016F974 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* D0480 8016FA40 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* D0484 8016FA44 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* D04A8 8016FA68 0C002DAF */  jal        ohSleep
    /* D04AC 8016FA6C 24040004 */   addiu     $a0, $zero, 0x4
    /* D04B0 8016FA70 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D04B4 8016FA74 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8016FACC_ovl3:
    /* D050C 8016FACC 0C002DAF */  jal        ohSleep
    /* D0510 8016FAD0 24040006 */   addiu     $a0, $zero, 0x6
    /* D0514 8016FAD4 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D0518 8016FAD8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8016FB24_ovl3:
    ...
    /* D057C 8016FB3C 0C02BE85 */  jal        curObjSleepForever
