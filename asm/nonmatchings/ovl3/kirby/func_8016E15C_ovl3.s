.section .late_rodata
nonmatching D_80197364_ovl3

dlabel D_80197364_ovl3
    /* F7DA4 80197364 477FFF00 */ .float 65535
enddlabel D_80197364_ovl3
.size D_80197364_ovl3, . - D_80197364_ovl3

nonmatching D_80197368_ovl3

dlabel D_80197368_ovl3
    /* F7DA8 80197368 477FFF00 */ .float 65535
enddlabel D_80197368_ovl3
.size D_80197368_ovl3, . - D_80197368_ovl3

nonmatching D_8019736C_ovl3

dlabel D_8019736C_ovl3
    /* F7DAC 8019736C 477FFF00 */ .float 65535
enddlabel D_8019736C_ovl3
.size D_8019736C_ovl3, . - D_8019736C_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016E15C_ovl3, 0x4DC
...
glabel func_8016E15C_ovl3
    ...
    /* CEBC8 8016E188 0C0547A5 */  jal        func_80151E94_ovl3
  ...
  .L8016E1CC_ovl3:
    ...
    /* CEC28 8016E1E8 10400046 */  beqz       $v0, .L8016E304_ovl3
    /* CEC2C 8016E1EC 24E7E7C0 */   addiu     $a3, $a3, %lo(gKirbyState)
    /* CEC30 8016E1F0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* CEC34 8016E1F4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8016E304_ovl3:
    /* CED44 8016E304 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* CED48 8016E308 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8016E370_ovl3:
    /* CEDB0 8016E370 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* CEDB4 8016E374 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* CEE08 8016E3C8 8CEC0030 */  lw         $t4, 0x30($a3)
  .L8016E3CC_ovl3:
    ...
    /* CEE40 8016E400 94ED00D2 */  lhu        $t5, 0xD2($a3)
  .L8016E404_ovl3:
  ...
  .L8016E41C_ovl3:
    /* CEE5C 8016E41C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* CEE60 8016E420 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8016E548_ovl3:
    /* CEF88 8016E548 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* CEF9C 8016E55C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* CEFA0 8016E560 10000017 */  b          .L8016E5C0_ovl3
    /* CEFA4 8016E564 8C42A7C4 */   lw        $v0, %lo(omCurrentObj)($v0)
  .L8016E568_ovl3:
    /* CEFA8 8016E568 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
