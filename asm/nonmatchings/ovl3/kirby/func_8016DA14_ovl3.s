.section .late_rodata
nonmatching D_80197358_ovl3

dlabel D_80197358_ovl3
    /* F7D98 80197358 477FFF00 */ .float 65535
enddlabel D_80197358_ovl3
.size D_80197358_ovl3, . - D_80197358_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016DA14_ovl3, 0x2F8
...
glabel func_8016DA14_ovl3
    ...
    /* CE49C 8016DA5C 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* CE4A0 8016DA60 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8016DB00_ovl3:
    ...
    /* CE558 8016DB18 0C02BE85 */  jal        curObjSleepForever
  ...
  .L8016DB24_ovl3:
    ...
    /* CE57C 8016DB3C 0C02BE85 */  jal        curObjSleepForever
  ...
  .L8016DB48_ovl3:
    ...
    /* CE5A0 8016DB60 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* CE5A4 8016DB64 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8016DC24_ovl3:
    /* CE664 8016DC24 0C002DAF */  jal        ohSleep
    /* CE668 8016DC28 02402025 */   or        $a0, $s2, $zero
    /* CE66C 8016DC2C 8E020034 */  lw         $v0, 0x34($s0)
    /* CE670 8016DC30 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* CE674 8016DC34 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8016DCD0_ovl3:
    /* CE710 8016DCD0 0C02BE85 */  jal        curObjSleepForever
