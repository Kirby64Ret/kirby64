nonmatching func_8017B3C4_ovl3, 0x3C8
...
glabel func_8017B3C4_ovl3
    ...
    /* DBE2C 8017B3EC 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* DBE30 8017B3F0 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
    /* DBE34 8017B3F4 11C00023 */  beqz       $t6, .L8017B484_ovl3
    /* DBE38 8017B3F8 3C048019 */   lui       $a0, %hi(D_801911E0_ovl3)
    /* DBE3C 8017B3FC 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* DBE40 8017B400 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
  ...
  .L8017B6E4_ovl3:
    ...
    /* DC128 8017B6E8 3C0C8013 */  lui        $t4, %hi(D_8012E7FC + 0x8)
    ...
    /* DC144 8017B704 8D8CE804 */  lw         $t4, %lo(D_8012E7FC + 0x8)($t4)
