nonmatching func_8017A390_ovl3, 0xCD8
...
glabel func_8017A390_ovl3
    ...
    /* DADE4 8017A3A4 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* DADE8 8017A3A8 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* DAE08 8017A3C8 55400006 */  bnel       $t2, $zero, .L8017A3E4_ovl3
  ...
  .L8017A3E8_ovl3:
    ...
    /* DAE30 8017A3F0 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* DAE34 8017A3F4 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8017A4A0_ovl3:
    ...
    /* DAEF4 8017A4B4 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* DAEF8 8017A4B8 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8017A4FC_ovl3:
    ...
    /* DAF64 8017A524 3C0F8005 */   lui       $t7, %hi(omCurrentObj)
    /* DAF68 8017A528 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* DAF6C 8017A52C 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L8017A54C_ovl3:
    /* DAF8C 8017A54C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8017A5D4_ovl3:
    ...
    /* DB02C 8017A5EC 3C0D8005 */   lui       $t5, %hi(omCurrentObj)
    /* DB030 8017A5F0 AD0C0044 */  sw         $t4, 0x44($t0)
    /* DB034 8017A5F4 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* DB068 8017A628 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB06C 8017A62C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  jlabel .L8017A6AC_ovl3
    /* DB0EC 8017A6AC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB0F0 8017A6B0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017A708_ovl3:
    ...
    /* DB150 8017A710 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* DB154 8017A714 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* DB178 8017A738 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB17C 8017A73C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017A968_ovl3:
    ...
    /* DB3EC 8017A9AC 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* DB3F0 8017A9B0 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L8017AA00_ovl3:
    /* DB440 8017AA00 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB444 8017AA04 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017AB04_ovl3:
    ...
    /* DB55C 8017AB1C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB560 8017AB20 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017AB88_ovl3:
    ...
    /* DB5E0 8017ABA0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB5E4 8017ABA4 8F2A0004 */  lw         $t2, 0x4($t9)
    /* DB5E8 8017ABA8 E5440030 */  swc1       $f4, 0x30($t2)
    /* DB5EC 8017ABAC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  jlabel .L8017AC80_ovl3
    /* DB6C0 8017AC80 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* DB6C4 8017AC84 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8017ACC0_ovl3:
    ...
    /* DB76C 8017AD2C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB770 8017AD30 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017ADBC_ovl3:
    ...
    /* DB820 8017ADE0 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* DB824 8017ADE4 45000014 */  bc1f       .L8017AE38_ovl3
    /* DB828 8017ADE8 00000000 */   nop
    /* DB82C 8017ADEC 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
    ...
    /* DB848 8017AE08 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB84C 8017AE0C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017AE38_ovl3:
    /* DB878 8017AE38 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* DB87C 8017AE3C 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* DB898 8017AE58 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* DB89C 8017AE5C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8017AE80_ovl3:
    ...
    /* DB8F8 8017AEB8 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* DB8FC 8017AEBC 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  jlabel .L8017AF2C_ovl3
    /* DB96C 8017AF2C 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* DB970 8017AF30 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  jlabel .L8017AF78_ovl3
    ...
    /* DB9D4 8017AF94 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* DB9D8 8017AF98 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8017B014_ovl3:
    ...
    /* DBA58 8017B018 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* DBA5C 8017B01C 5302000F */  beql       $t8, $v0, .L8017B05C_ovl3
    /* DBA60 8017B020 8FBF001C */   lw        $ra, 0x1C($sp)
    /* DBA64 8017B024 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
