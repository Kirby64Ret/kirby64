.section .late_rodata
nonmatching D_80197354_ovl3

dlabel D_80197354_ovl3
    /* F7D94 80197354 477FFF00 */ .float 65535
enddlabel D_80197354_ovl3
.size D_80197354_ovl3, . - D_80197354_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016D3A8_ovl3, 0x474

glabel func_8016D3A8_ovl3
    /* CDDE8 8016D3A8 27BDFFB0 */  addiu      $sp, $sp, -0x50
    /* CDDEC 8016D3AC AFB40044 */  sw         $s4, 0x44($sp)
    /* CDDF0 8016D3B0 3C148005 */  lui        $s4, %hi(omCurrentObj)
    /* CDDF4 8016D3B4 2694A7C4 */  addiu      $s4, $s4, %lo(omCurrentObj)
    ...
    /* CDE68 8016D428 5140000A */  beql       $t2, $zero, .L8016D454_ovl3
  ...
  .L8016D5E0_ovl3:
    /* CE020 8016D5E0 0C002DAF */  jal        ohSleep
  ...
  .L8016D638_ovl3:
    ...
    /* CE090 8016D650 3C040002 */   lui       $a0, (0x200D1 >> 16)
  ...
  .L8016D6B8_ovl3:
    ...
    /* CE140 8016D700 55C0000A */  bnel       $t6, $zero, .L8016D72C_ovl3
  ...
  .L8016D75C_ovl3:
    /* CE19C 8016D75C 0C002DAF */  jal        ohSleep
  ...
  .L8016D7E0_ovl3:
    /* CE220 8016D7E0 0C02BE85 */  jal        curObjSleepForever
