nonmatching func_8017CAF8_ovl3, 0x468

glabel func_8017CAF8_ovl3
    /* DD538 8017CAF8 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* DD53C 8017CAFC 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    /* DD540 8017CB00 27BDFFE8 */  addiu      $sp, $sp, -0x18
    /* DD544 8017CB04 AFBF0014 */  sw         $ra, 0x14($sp)
    /* DD548 8017CB08 AFA40018 */  sw         $a0, 0x18($sp)
    /* DD54C 8017CB0C 8DF80000 */  lw         $t8, 0x0($t7)
  ...
  jlabel .L8017CBB8_ovl3
    ...
    /* DD618 8017CBD8 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* DD61C 8017CBDC 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8017CBEC_ovl3:
    ...
    /* DD634 8017CBF4 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* DD638 8017CBF8 3C038005 */  lui        $v1, %hi(omCurrentObj)
  ...
  jlabel .L8017CC90_ovl3
    /* DD6D0 8017CC90 8CEC0034 */  lw         $t4, 0x34($a3)
    /* DD6D4 8017CC94 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* DD6D8 8017CC98 318D0001 */  andi       $t5, $t4, 0x1
    /* DD6DC 8017CC9C 55A0001F */  bnel       $t5, $zero, .L8017CD1C_ovl3
    /* DD6E0 8017CCA0 8CEA003C */   lw        $t2, 0x3C($a3)
    /* DD6E4 8017CCA4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8017CCE0_ovl3:
    ...
    /* DD738 8017CCF8 ACE40044 */  sw         $a0, 0x44($a3)
  ...
  .L8017CD04_ovl3:
    ...
    /* DD74C 8017CD0C 8CEA003C */   lw        $t2, 0x3C($a3)
    /* DD750 8017CD10 24030007 */  addiu      $v1, $zero, 0x7
    /* DD754 8017CD14 ACE30044 */  sw         $v1, 0x44($a3)
  .L8017CD18_ovl3:
    /* DD758 8017CD18 8CEA003C */  lw         $t2, 0x3C($a3)
  .L8017CD1C_ovl3:
  ...
  jlabel .L8017CD40_ovl3
    /* DD780 8017CD40 8CEB0034 */  lw         $t3, 0x34($a3)
    /* DD784 8017CD44 316C0001 */  andi       $t4, $t3, 0x1
    /* DD788 8017CD48 5580000A */  bnel       $t4, $zero, .L8017CD74_ovl3
    /* DD78C 8017CD4C 8CF800E4 */   lw        $t8, 0xE4($a3)
  ...
  .L8017CD74_ovl3:
    /* DD7B4 8017CD74 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* DD7B8 8017CD78 5300000B */  beql       $t8, $zero, .L8017CDA8_ovl3
    /* DD7BC 8017CD7C 94EA00D2 */   lhu       $t2, 0xD2($a3)
    /* DD7C0 8017CD80 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* DD7E0 8017CDA0 ACE90044 */  sw         $t1, 0x44($a3)
    /* DD7E4 8017CDA4 94EA00D2 */  lhu        $t2, 0xD2($a3)
  .L8017CDA8_ovl3:
  ...
  jlabel .L8017CDD4_ovl3
    /* DD814 8017CDD4 8CEB0034 */  lw         $t3, 0x34($a3)
    /* DD818 8017CDD8 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* DD81C 8017CDDC 316C0001 */  andi       $t4, $t3, 0x1
    /* DD820 8017CDE0 5580000C */  bnel       $t4, $zero, .L8017CE14_ovl3
    /* DD824 8017CDE4 8CE8003C */   lw        $t0, 0x3C($a3)
    /* DD828 8017CDE8 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* DD844 8017CE04 8CE8003C */   lw        $t0, 0x3C($a3)
    /* DD848 8017CE08 24030008 */  addiu      $v1, $zero, 0x8
    /* DD84C 8017CE0C ACE30044 */  sw         $v1, 0x44($a3)
    /* DD850 8017CE10 8CE8003C */  lw         $t0, 0x3C($a3)
  .L8017CE14_ovl3:
  ...
  jlabel .L8017CE38_ovl3
    /* DD878 8017CE38 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* DD87C 8017CE3C 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* DD8B4 8017CE74 ACEC0044 */   sw        $t4, 0x44($a3)
  .L8017CE78_ovl3:
    ...
    /* DD8CC 8017CE8C ACE40044 */   sw        $a0, 0x44($a3)
  .L8017CE90_ovl3:
  ...
  jlabel .L8017CEAC_ovl3
    ...
    /* DD900 8017CEC0 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* DD904 8017CEC4 53200011 */  beql       $t9, $zero, .L8017CF0C_ovl3
    /* DD908 8017CEC8 8CEC003C */   lw        $t4, 0x3C($a3)
    /* DD90C 8017CECC 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
  ...
  .L8017CF0C_ovl3:
    ...
    /* DD950 8017CF10 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* DD954 8017CF14 518D000F */  beql       $t4, $t5, .L8017CF54_ovl3
    /* DD958 8017CF18 8FBF0014 */   lw        $ra, 0x14($sp)
    /* DD95C 8017CF1C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
