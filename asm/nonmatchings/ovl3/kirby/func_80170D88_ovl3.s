.section .late_rodata
nonmatching D_801973B0_ovl3

dlabel D_801973B0_ovl3
    /* F7DF0 801973B0 477FFF00 */ .float 65535
enddlabel D_801973B0_ovl3
.size D_801973B0_ovl3, . - D_801973B0_ovl3

nonmatching D_801973B4_ovl3

dlabel D_801973B4_ovl3
    /* F7DF4 801973B4 477FFF00 */ .float 65535
enddlabel D_801973B4_ovl3
.size D_801973B4_ovl3, . - D_801973B4_ovl3

nonmatching D_801973B8_ovl3

dlabel D_801973B8_ovl3
    /* F7DF8 801973B8 3E666666 */ .float 0.224999994
enddlabel D_801973B8_ovl3
.size D_801973B8_ovl3, . - D_801973B8_ovl3

nonmatching D_801973BC_ovl3

dlabel D_801973BC_ovl3
    /* F7DFC 801973BC 3E333333 */ .float 0.174999997
enddlabel D_801973BC_ovl3
.size D_801973BC_ovl3, . - D_801973BC_ovl3

nonmatching D_801973C0_ovl3

dlabel D_801973C0_ovl3
    /* F7E00 801973C0 477FFF00 */ .float 65535
enddlabel D_801973C0_ovl3
.size D_801973C0_ovl3, . - D_801973C0_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80170D88_ovl3, 0x570
...
glabel func_80170D88_ovl3
    ...
    /* D17E4 80170DA4 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* D17E8 80170DA8 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L80170DE0_ovl3:
    /* D1820 80170DE0 0C0547A5 */  jal        func_80151E94_ovl3
  ...
  .L80170E18_ovl3:
    ...
    /* D186C 80170E2C 1041012E */  beq        $v0, $at, .L801712E8_ovl3
  ...
  .L80170E40_ovl3:
    ...
    /* D18B0 80170E70 3C0B8005 */   lui       $t3, %hi(omCurrentObj)
    /* D18B4 80170E74 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L80170EB4_ovl3:
    ...
    /* D1900 80170EC0 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* D1904 80170EC4 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L80170F00_ovl3:
    ...
    /* D1958 80170F18 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* D1988 80170F48 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* D198C 80170F4C 1321000F */  beq        $t9, $at, .L80170F8C_ovl3
    /* D1990 80170F50 00000000 */   nop
    /* D1994 80170F54 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L80170F8C_ovl3:
    /* D19CC 80170F8C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80171090_ovl3:
    ...
    /* D1AF8 801710B8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D1AFC 801710BC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801711F8_ovl3:
    /* D1C38 801711F8 1440003B */  bnez       $v0, .L801712E8_ovl3
    /* D1C3C 801711FC 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* D1C40 80171200 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* D1CA4 80171264 10000020 */  b          .L801712E8_ovl3
  ...
  .L8017126C_ovl3:
    ...
    /* D1CDC 8017129C 10000012 */  b          .L801712E8_ovl3
