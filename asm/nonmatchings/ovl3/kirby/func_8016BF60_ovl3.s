.section .rodata
.align 2
nonmatching D_801972D0_ovl3

dlabel D_801972D0_ovl3
    /* F7D10 801972D0 */ .asciz "No MapIn Action Number[kirby.cc]:%d\n"
    /* 4E6F204D6170496E20416374696F6E204E756D6265725B6B697262792E63635D3A25640A00000000 */
.align 2
enddlabel D_801972D0_ovl3
.size D_801972D0_ovl3, . - D_801972D0_ovl3

.section .late_rodata
nonmatching jtbl_80197314_ovl3

dlabel jtbl_80197314_ovl3
    /* F7D54 80197314 8016C1EC */ .word .L8016C1EC_ovl3
    /* F7D58 80197318 8016C1CC */ .word .L8016C1CC_ovl3
    /* F7D5C 8019731C 8016C2DC */ .word .L8016C2DC_ovl3
    /* F7D60 80197320 8016C2DC */ .word .L8016C2DC_ovl3
    /* F7D64 80197324 8016C268 */ .word .L8016C268_ovl3
    /* F7D68 80197328 8016C354 */ .word .L8016C354_ovl3
    /* F7D6C 8019732C 8016C354 */ .word .L8016C354_ovl3
    /* F7D70 80197330 8016C3FC */ .word .L8016C3FC_ovl3
    /* F7D74 80197334 8016C3FC */ .word .L8016C3FC_ovl3
    /* F7D78 80197338 8016C1EC */ .word .L8016C1EC_ovl3
    /* F7D7C 8019733C 8016C2DC */ .word .L8016C2DC_ovl3
    /* F7D80 80197340 8016C268 */ .word .L8016C268_ovl3
enddlabel jtbl_80197314_ovl3
.size jtbl_80197314_ovl3, . - jtbl_80197314_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016BF60_ovl3, 0x5B0
...
glabel func_8016BF60_ovl3
    ...
    /* CC9C4 8016BF84 0C076C78 */  jal        func_801DB1E0_ovl10
    /* CC9C8 8016BF88 A0F80006 */   sb        $t8, 0x6($a3)
    /* CC9CC 8016BF8C 0C02BE85 */  jal        curObjSleepForever
    /* CC9D0 8016BF90 00000000 */   nop
  .L8016BF94_ovl3:
    /* CC9D4 8016BF94 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CC9D8 8016BF98 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
    ...
    /* CCA64 8016C024 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CCA68 8016C028 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
  ...
  .L8016C05C_ovl3:
    ...
    /* CCAA8 8016C068 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CCAAC 8016C06C 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
  ...
  .L8016C0D0_ovl3:
    ...
    /* CCB30 8016C0F0 3C038013 */  lui        $v1, %hi(D_8012E944)
    /* CCB34 8016C0F4 2463E944 */  addiu      $v1, $v1, %lo(D_8012E944)
    /* CCB38 8016C0F8 3C078013 */  lui        $a3, %hi(gKirbyState)
    /* CCB3C 8016C0FC 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CCB40 8016C100 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
  ...
  .L8016C144_ovl3:
    ...
    /* CCB9C 8016C15C 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CCBA0 8016C160 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
  ...
  .L8016C1CC_ovl3:
    ...
    /* CCC10 8016C1D0 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
    /* CCC14 8016C1D4 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C1EC_ovl3:
    ...
    /* CCC34 8016C1F4 3C03800E */   lui       $v1, %hi(gEntityFuncListIDArray)
  ...
  .L8016C24C_ovl3:
    ...
    /* CCC90 8016C250 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C268_ovl3:
    ...
    /* CCCB0 8016C270 3C03800E */   lui       $v1, %hi(gEntityFuncListIDArray)
  ...
  .L8016C2B8_ovl3:
    ...
    /* CCD04 8016C2C4 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C32C_ovl3:
    ...
    /* CCD78 8016C338 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
    /* CCD7C 8016C33C 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C354_ovl3:
    ...
    /* CCD9C 8016C35C 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
  ...
  .L8016C3E0_ovl3:
    ...
    /* CCE24 8016C3E4 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C3FC_ovl3:
    ...
    /* CCE44 8016C404 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
  ...
  .L8016C474_ovl3:
    ...
    /* CCEB8 8016C478 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C490_ovl3:
    ...
    /* CCED4 8016C494 0C02909C */  jal        utilPrintf
    /* CCED8 8016C498 248472D0 */   addiu     $a0, $a0, %lo(D_801972D0_ovl3)
    /* CCEDC 8016C49C 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* CCEE0 8016C4A0 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
    /* CCEE4 8016C4A4 8D020000 */  lw         $v0, 0x0($t0)
    /* CCEE8 8016C4A8 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
    /* CCEEC 8016C4AC 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C4C8_ovl3:
    /* CCF08 8016C4C8 3C03800E */  lui        $v1, %hi(gEntityFuncListIDArray)
    /* CCF0C 8016C4CC 2463DC50 */  addiu      $v1, $v1, %lo(gEntityFuncListIDArray)
  ...
  .L8016C4E0_ovl3:
    ...
    /* CCF38 8016C4F8 0C02911F */  jal        utilFuncTableJump
