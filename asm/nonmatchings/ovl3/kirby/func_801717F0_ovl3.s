.section .late_rodata
nonmatching D_801973E4_ovl3

dlabel D_801973E4_ovl3
    /* F7E24 801973E4 477FFF00 */ .float 65535
enddlabel D_801973E4_ovl3
.size D_801973E4_ovl3, . - D_801973E4_ovl3

nonmatching D_801973E8_ovl3

dlabel D_801973E8_ovl3
    /* F7E28 801973E8 3E4CCCCD */ .float 0.200000003
enddlabel D_801973E8_ovl3
.size D_801973E8_ovl3, . - D_801973E8_ovl3

nonmatching D_801973EC_ovl3

dlabel D_801973EC_ovl3
    /* F7E2C 801973EC 477FFF00 */ .float 65535
enddlabel D_801973EC_ovl3
.size D_801973EC_ovl3, . - D_801973EC_ovl3

nonmatching D_801973F0_ovl3

dlabel D_801973F0_ovl3
    /* F7E30 801973F0 477FFF00 */ .float 65535
enddlabel D_801973F0_ovl3
.size D_801973F0_ovl3, . - D_801973F0_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801717F0_ovl3, 0x610
...
glabel func_801717F0_ovl3
    ...
    /* D2270 80171830 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* D2274 80171834 558000D7 */  bnel       $t4, $zero, .L80171B94_ovl3
    /* D2278 80171838 90C2000B */   lbu       $v0, 0xB($a2)
    /* D227C 8017183C 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L80171878_ovl3:
    /* D22B8 80171878 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* D22BC 8017187C 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L801718B8_ovl3:
    ...
    /* D2328 801718E8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* D232C 801718EC 316C4000 */  andi       $t4, $t3, 0x4000
    /* D2330 801718F0 11800017 */  beqz       $t4, .L80171950_ovl3
    /* D2334 801718F4 00000000 */   nop
    /* D2338 801718F8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80171950_ovl3:
    ...
    /* D239C 8017195C 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* D23A0 80171960 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80171A68_ovl3:
    ...
    /* D24BC 80171A7C 1000001F */  b          .L80171AFC_ovl3
    /* D24C0 80171A80 AC4C0034 */   sw        $t4, 0x34($v0)
  .L80171A84_ovl3:
    /* D24C4 80171A84 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* D24C8 80171A88 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80171B18_ovl3:
    ...
    /* D2578 80171B38 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* D257C 80171B3C 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L80171BB4_ovl3:
    ...
    /* D25F8 80171BB8 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* D25FC 80171BBC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* D2600 80171BC0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80171C04_ovl3:
    /* D2644 80171C04 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80171CB8_ovl3:
    ...
    /* D2750 80171D10 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* D2754 80171D14 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
