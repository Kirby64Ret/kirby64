.section .late_rodata
nonmatching D_8019752C_ovl3

dlabel D_8019752C_ovl3
    /* F7F6C 8019752C 477FFF00 */ .float 65535
enddlabel D_8019752C_ovl3
.size D_8019752C_ovl3, . - D_8019752C_ovl3

nonmatching D_80197530_ovl3

dlabel D_80197530_ovl3
    /* F7F70 80197530 BC75C28F */ .float -0.01499999966
enddlabel D_80197530_ovl3
.size D_80197530_ovl3, . - D_80197530_ovl3

nonmatching D_80197534_ovl3

dlabel D_80197534_ovl3
    /* F7F74 80197534 477FFF00 */ .float 65535
enddlabel D_80197534_ovl3
.size D_80197534_ovl3, . - D_80197534_ovl3

nonmatching D_80197538_ovl3

dlabel D_80197538_ovl3
    /* F7F78 80197538 3C75C28F */ .float 0.01499999966
enddlabel D_80197538_ovl3
.size D_80197538_ovl3, . - D_80197538_ovl3

nonmatching D_8019753C_ovl3

dlabel D_8019753C_ovl3
    /* F7F7C 8019753C BC0B4396 */ .float -0.008500000462
enddlabel D_8019753C_ovl3
.size D_8019753C_ovl3, . - D_8019753C_ovl3

nonmatching D_80197540_ovl3

dlabel D_80197540_ovl3
    /* F7F80 80197540 3C0B4396 */ .float 0.008500000462
enddlabel D_80197540_ovl3
.size D_80197540_ovl3, . - D_80197540_ovl3

nonmatching D_80197544_ovl3

dlabel D_80197544_ovl3
    /* F7F84 80197544 BC0B4396 */ .float -0.008500000462
enddlabel D_80197544_ovl3
.size D_80197544_ovl3, . - D_80197544_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80178B18_ovl3, 0x548
...
glabel func_80178B18_ovl3
    ...
    /* D9564 80178B24 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* D9568 80178B28 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* D9590 80178B50 0C0547A5 */  jal        func_80151E94_ovl3
  ...
  .L80178B8C_ovl3:
    ...
    /* D95D0 80178B90 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
  ...
  .L80178BAC_ovl3:
    /* D95EC 80178BAC 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* D962C 80178BEC 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* D9630 80178BF0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L80178C4C_ovl3:
    ...
    /* D9694 80178C54 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* D96B8 80178C78 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D96BC 80178C7C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80178CA0_ovl3:
    /* D96E0 80178CA0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D96E4 80178CA4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80178DA4_ovl3:
    /* D97E4 80178DA4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80178EF8_ovl3:
    ...
    /* D9944 80178F04 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* D9964 80178F24 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* D9968 80178F28 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* D996C 80178F2C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80178F84_ovl3:
    /* D99C4 80178F84 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80178FDC_ovl3:
    /* D9A1C 80178FDC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
