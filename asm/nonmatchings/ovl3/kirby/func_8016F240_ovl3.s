.section .late_rodata
nonmatching D_80197384_ovl3

dlabel D_80197384_ovl3
    /* F7DC4 80197384 477FFF00 */ .float 65535
enddlabel D_80197384_ovl3
.size D_80197384_ovl3, . - D_80197384_ovl3

nonmatching D_80197388_ovl3

dlabel D_80197388_ovl3
    /* F7DC8 80197388 BECCCCCD */ .float -0.400000006
enddlabel D_80197388_ovl3
.size D_80197388_ovl3, . - D_80197388_ovl3

nonmatching D_8019738C_ovl3

dlabel D_8019738C_ovl3
    /* F7DCC 8019738C 477FFF00 */ .float 65535
enddlabel D_8019738C_ovl3
.size D_8019738C_ovl3, . - D_8019738C_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8016F240_ovl3, 0x49C

glabel func_8016F240_ovl3
    /* CFC80 8016F240 27BDFFC8 */  addiu      $sp, $sp, -0x38
    /* CFC84 8016F244 3C0F8019 */  lui        $t7, %hi(D_80196C6C_ovl3)
    /* CFC88 8016F248 AFBF0014 */  sw         $ra, 0x14($sp)
    /* CFC8C 8016F24C AFA40038 */  sw         $a0, 0x38($sp)
    /* CFC90 8016F250 25EF6C6C */  addiu      $t7, $t7, %lo(D_80196C6C_ovl3)
    ...
    /* CFCB4 8016F274 0C0547A5 */  jal        func_80151E94_ovl3
  ...
  .L8016F2F4_ovl3:
    /* CFD34 8016F2F4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* CFD38 8016F2F8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8016F3D0_ovl3:
    ...
    /* CFE24 8016F3E4 51600009 */  beql       $t3, $zero, .L8016F40C_ovl3
  ...
  .L8016F488_ovl3:
    ...
    /* CFEEC 8016F4AC 10000005 */  b          .L8016F4C4_ovl3
  ...
  .L8016F4D4_ovl3:
    ...
    /* CFF5C 8016F51C 55A00008 */  bnel       $t5, $zero, .L8016F540_ovl3
  ...
  .L8016F588_ovl3:
    ...
    /* CFFD4 8016F594 3C038005 */   lui       $v1, %hi(omCurrentObj)
  ...
  .L8016F5AC_ovl3:
    /* CFFEC 8016F5AC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* D0014 8016F5D4 1180000C */  beqz       $t4, .L8016F608_ovl3
  ...
  .L8016F658_ovl3:
    /* D0098 8016F658 3C038005 */  lui        $v1, %hi(omCurrentObj)
  ...
  .L8016F674_ovl3:
    /* D00B4 8016F674 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
