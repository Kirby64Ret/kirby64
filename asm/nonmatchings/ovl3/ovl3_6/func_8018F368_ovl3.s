nonmatching func_8018F368_ovl3, 0xFA8

glabel func_8018F368_ovl3
    /* EFDA8 8018F368 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* EFDAC 8018F36C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8018F550_ovl3:
    ...
    /* EFF9C 8018F55C 3C068005 */  lui        $a2, %hi(omCurrentObj)
  ...
  .L8018F574_ovl3:
    /* EFFB4 8018F574 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8018F5A4_ovl3:
    ...
    /* F0024 8018F5E4 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* F0028 8018F5E8 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  jlabel .L8018F6B0_ovl3
    /* F00F0 8018F6B0 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* F00F4 8018F6B4 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8018F900_ovl3:
    /* F0340 8018F900 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* F0344 8018F904 51E00027 */  beql       $t7, $zero, .L8018F9A4_ovl3
    /* F0348 8018F908 950B00D2 */   lhu       $t3, 0xD2($t0)
    /* F034C 8018F90C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* F03AC 8018F96C 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* F03B0 8018F970 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L8018F9BC_ovl3:
    /* F03FC 8018F9BC 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* F0400 8018F9C0 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  jlabel .L8018FAD8_ovl3
    /* F0518 8018FAD8 8D190034 */  lw         $t9, 0x34($t0)
    /* F051C 8018FADC 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    ...
    /* F052C 8018FAEC 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  jlabel .L8018FB40_ovl3
    /* F0580 8018FB40 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* F0584 8018FB44 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8018FBFC_ovl3:
    /* F063C 8018FBFC 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* F0640 8018FC00 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8018FCB0_ovl3:
    /* F06F0 8018FCB0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* F06F4 8018FCB4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L8018FDAC_ovl3:
    ...
    /* F07F0 8018FDB0 3C068005 */   lui       $a2, %hi(omCurrentObj)
    /* F07F4 8018FDB4 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  jlabel .L8018FE54_ovl3
    /* F0894 8018FE54 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* F0898 8018FE58 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L8018FEF0_ovl3:
    ...
    /* F095C 8018FF1C 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* F0960 8018FF20 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
    ...
    /* F0988 8018FF48 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* F098C 8018FF4C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L8019011C_ovl3:
    ...
    /* F0B60 80190120 3C0A8005 */   lui       $t2, %hi(omCurrentObj)
    /* F0B64 80190124 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
    ...
    /* F0B90 80190150 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* F0B94 80190154 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801901A0_ovl3:
    ...
    /* F0BF8 801901B8 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
  ...
  .L801901D4_ovl3:
    /* F0C14 801901D4 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L801902C4_ovl3:
    ...
    /* F0D08 801902C8 3C188005 */   lui       $t8, %hi(omCurrentObj)
    /* F0D0C 801902CC 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
