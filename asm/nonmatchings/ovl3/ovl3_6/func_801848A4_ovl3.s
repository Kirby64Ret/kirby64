nonmatching func_801848A4_ovl3, 0x280
...
glabel func_801848A4_ovl3
    ...
    /* E5324 801848E4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* E5328 801848E8 11E10009 */  beq        $t7, $at, .L80184910_ovl3
    /* E532C 801848EC 00000000 */   nop
    /* E5330 801848F0 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L80184928_ovl3:
    ...
    /* E536C 8018492C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* E5380 80184940 3C028005 */   lui       $v0, %hi(omCurrentObj)
    /* E5384 80184944 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* E5388 80184948 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80184988_ovl3:
    /* E53C8 80184988 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801849C8_ovl3:
    /* E5408 801849C8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
