nonmatching func_80183FF4_ovl3, 0x544

glabel func_80183FF4_ovl3
    /* E4A34 80183FF4 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* E4A38 80183FF8 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* E4A70 80184030 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* E4A74 80184034 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L80184218_ovl3:
    ...
    /* E4C74 80184234 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* E4C78 80184238 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L801842B0_ovl3:
    ...
    /* E4D1C 801842DC 10000092 */  b          .L80184528_ovl3
  ...
  .L801842E4_ovl3:
    ...
    /* E4D38 801842F8 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* E4D3C 801842FC 8CE7A7C4 */  lw         $a3, %lo(omCurrentObj)($a3)
  ...
  .L80184384_ovl3:
    ...
    /* E4DC8 80184388 51600005 */  beql       $t3, $zero, .L801843A0_ovl3
  ...
  .L80184444_ovl3:
    ...
    /* E4EB0 80184470 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    ...
    /* E4EC4 80184484 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80184494_ovl3:
    ...
    /* E4ED8 80184498 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    ...
    /* E4EEC 801844AC 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801844B8_ovl3:
    ...
    /* E4F2C 801844EC 0C054849 */  jal        func_80152124_ovl3
