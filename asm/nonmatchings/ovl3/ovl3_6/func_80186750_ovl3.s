nonmatching func_80186750_ovl3, 0x2D0
...
glabel func_80186750_ovl3
    ...
    /* E71D4 80186794 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* E71D8 80186798 3C01800E */  lui        $at, %hi(D_800DDFD0)
    /* E71DC 8018679C AE0F00A0 */  sw         $t7, 0xA0($s0)
    /* E71E0 801867A0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* E7264 80186824 0C05A4F1 */  jal        func_801693C4_ovl3
    ...
    /* E727C 8018683C 0C05A4F1 */  jal        func_801693C4_ovl3
    ...
    /* E72BC 8018687C 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* E72C0 80186880 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L801868C8_ovl3:
    ...
    /* E7314 801868D4 10410006 */  beq        $v0, $at, .L801868F0_ovl3
  ...
  .L801868F0_ovl3:
    ...
    /* E7344 80186904 0C02BE85 */  jal        curObjSleepForever
  ...
  .L8018690C_ovl3:
    ...
    /* E7360 80186920 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* E7364 80186924 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L80186964_ovl3:
    /* E73A4 80186964 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* E73A8 80186968 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801869A4_ovl3:
    ...
    /* E73F8 801869B8 0C02BE85 */  jal        curObjSleepForever
    /* E73FC 801869BC 00000000 */   nop
  .L801869C0_ovl3:
    /* E7400 801869C0 AE0000A0 */  sw         $zero, 0xA0($s0)
    /* E7404 801869C4 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* E7408 801869C8 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L80186A00_ovl3:
    ...
    /* E7444 80186A04 0C02BE85 */  jal        curObjSleepForever
