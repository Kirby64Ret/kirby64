.section .late_rodata
nonmatching D_80196F04_ovl3

dlabel D_80196F04_ovl3
    /* F7944 80196F04 BECCCCCD */ .float -0.400000006
enddlabel D_80196F04_ovl3
.size D_80196F04_ovl3, . - D_80196F04_ovl3

nonmatching D_80196F08_ovl3

dlabel D_80196F08_ovl3
    /* F7948 80196F08 BF7B0CDD */ .float -0.9806650281
enddlabel D_80196F08_ovl3
.size D_80196F08_ovl3, . - D_80196F08_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80156050_ovl3, 0x544
...
glabel func_80156050_ovl3
    ...
    /* B6AA0 80156060 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* B6AA4 80156064 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    ...
    /* B6ACC 8015608C 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* B6AD0 80156090 14440007 */  bne        $v0, $a0, .L801560B0_ovl3
    /* B6AD4 80156094 24C6A7C4 */   addiu     $a2, $a2, %lo(omCurrentObj)
  ...
  .L8015627C_ovl3:
    ...
    /* B6CE0 801562A0 45020019 */  bc1fl      .L80156308_ovl3
  ...
  .L801562C0_ovl3:
    ...
    /* B6D28 801562E8 45020007 */  bc1fl      .L80156308_ovl3
  ...
  .L80156308_ovl3:
    ...
    /* B6D60 80156320 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* B6D64 80156324 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    /* B6D68 80156328 24A5E7C0 */  addiu      $a1, $a1, %lo(gKirbyState)
    /* B6D6C 8015632C 1440000D */  bnez       $v0, .L80156364_ovl3
    ...
    /* B6D94 80156354 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* B6D98 80156358 24070002 */  addiu      $a3, $zero, 0x2
    /* B6D9C 8015635C 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
  ...
  .L801563CC_ovl3:
    ...
    /* B6E30 801563F0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* B6E34 801563F4 1000001C */  b          .L80156468_ovl3
    /* B6E38 801563F8 8C42A7C4 */   lw        $v0, %lo(omCurrentObj)($v0)
  .L801563FC_ovl3:
    ...
    /* B6E68 80156428 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* B6E6C 8015642C 1000000E */  b          .L80156468_ovl3
    /* B6E70 80156430 8C42A7C4 */   lw        $v0, %lo(omCurrentObj)($v0)
  .L80156434_ovl3:
    ...
    /* B6EA0 80156460 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* B6EA4 80156464 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  .L80156468_ovl3:
  ...
  .L8015648C_ovl3:
    ...
    /* B6EEC 801564AC 3C040002 */   lui       $a0, (0x200CD >> 16)
  ...
  .L8015657C_ovl3:
    /* B6FBC 8015657C 0C02BE85 */  jal        curObjSleepForever
