.section .late_rodata
nonmatching D_80196F84_ovl3

dlabel D_80196F84_ovl3
    /* F79C4 80196F84 477FFF00 */ .float 65535
enddlabel D_80196F84_ovl3
.size D_80196F84_ovl3, . - D_80196F84_ovl3

nonmatching D_80196F88_ovl3

dlabel D_80196F88_ovl3
    /* F79C8 80196F88 477FFF00 */ .float 65535
enddlabel D_80196F88_ovl3
.size D_80196F88_ovl3, . - D_80196F88_ovl3

nonmatching D_80196F8C_ovl3

dlabel D_80196F8C_ovl3
    /* F79CC 80196F8C 3F0A3D71 */ .float 0.5400000215
enddlabel D_80196F8C_ovl3
.size D_80196F8C_ovl3, . - D_80196F8C_ovl3

nonmatching D_80196F90_ovl3

dlabel D_80196F90_ovl3
    /* F79D0 80196F90 3F0A3D71 */ .float 0.5400000215
enddlabel D_80196F90_ovl3
.size D_80196F90_ovl3, . - D_80196F90_ovl3

nonmatching D_80196F94_ovl3

dlabel D_80196F94_ovl3
    /* F79D4 80196F94 BF7B0CDD */ .float -0.9806650281
enddlabel D_80196F94_ovl3
.size D_80196F94_ovl3, . - D_80196F94_ovl3

nonmatching D_80196F98_ovl3

dlabel D_80196F98_ovl3
    /* F79D8 80196F98 477FFF00 */ .float 65535
enddlabel D_80196F98_ovl3
.size D_80196F98_ovl3, . - D_80196F98_ovl3

nonmatching D_80196F9C_ovl3

dlabel D_80196F9C_ovl3
    /* F79DC 80196F9C 477FFF00 */ .float 65535
enddlabel D_80196F9C_ovl3
.size D_80196F9C_ovl3, . - D_80196F9C_ovl3


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80159164_ovl3, 0x978
...
glabel func_80159164_ovl3
    ...
    /* B9BC4 80159184 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9BC8 80159188 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* B9C0C 801591CC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9C10 801591D0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015933C_ovl3:
    /* B9D7C 8015933C 0C002DAF */  jal        ohSleep
    /* B9D80 80159340 2404001E */   addiu     $a0, $zero, 0x1E
    /* B9D84 80159344 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9D88 80159348 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801593B0_ovl3:
    ...
    /* B9E08 801593C8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9E0C 801593CC 10000010 */  b          .L80159410_ovl3
    /* B9E10 801593D0 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
  .L801593D4_ovl3:
    ...
    /* B9E28 801593E8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9E2C 801593EC 10000008 */  b          .L80159410_ovl3
    /* B9E30 801593F0 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
  .L801593F4_ovl3:
    ...
    /* B9E48 80159408 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9E4C 8015940C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  .L80159410_ovl3:
  ...
  .L80159418_ovl3:
    ...
    /* B9E80 80159440 0C002DAF */  jal        ohSleep
    /* B9E84 80159444 24040001 */   addiu     $a0, $zero, 0x1
    /* B9E88 80159448 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* B9E8C 8015944C 3C018019 */  lui        $at, %hi(D_80196F90_ovl3)
    /* B9E90 80159450 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80159544_ovl3:
    ...
    /* B9F9C 8015955C 0C002DAF */  jal        ohSleep
  ...
  .L8015959C_ovl3:
    ...
    /* B9FF0 801595B0 0C002DAF */  jal        ohSleep
  ...
  .L801595F0_ovl3:
    ...
    /* BA044 80159604 0C002DAF */  jal        ohSleep
  ...
  .L8015963C_ovl3:
    /* BA07C 8015963C 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* BA080 80159640 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L8015968C_ovl3:
    /* BA0CC 8015968C 0C002DAF */  jal        ohSleep
  ...
  .L8015969C_ovl3:
    ...
    /* BA0E4 801596A4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA0E8 801596A8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801597B4_ovl3:
    ...
    /* BA20C 801597CC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA210 801597D0 10000010 */  b          .L80159814_ovl3
    /* BA214 801597D4 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
  .L801597D8_ovl3:
    ...
    /* BA22C 801597EC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA230 801597F0 10000008 */  b          .L80159814_ovl3
    /* BA234 801597F4 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
  .L801597F8_ovl3:
    ...
    /* BA24C 8015980C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA250 80159810 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  .L80159814_ovl3:
  ...
  .L80159818_ovl3:
    ...
    /* BA26C 8015982C 3C0D8013 */  lui        $t5, %hi(D_8012E7FC)
    /* BA270 80159830 8DADE7FC */  lw         $t5, %lo(D_8012E7FC)($t5)
    /* BA274 80159834 3C01800F */  lui        $at, %hi(D_800E8060)
    ...
    /* BA288 80159848 AC388060 */   sw        $t8, %lo(D_800E8060)($at)
  .L8015984C_ovl3:
    /* BA28C 8015984C 0C002DAF */  jal        ohSleep
    /* BA290 80159850 24040001 */   addiu     $a0, $zero, 0x1
    /* BA294 80159854 3C0C8013 */  lui        $t4, %hi(D_8012E7FC)
    /* BA298 80159858 8D8CE7FC */  lw         $t4, %lo(D_8012E7FC)($t4)
    /* BA29C 8015985C 1180FFFB */  beqz       $t4, .L8015984C_ovl3
    /* BA2A0 80159860 00000000 */   nop
    /* BA2A4 80159864 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA2A8 80159868 3C07800E */  lui        $a3, %hi(D_800E0D50)
    /* BA2AC 8015986C 24E70D50 */  addiu      $a3, $a3, %lo(D_800E0D50)
    /* BA2B0 80159870 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  .L80159874_ovl3:
    ...
    /* BA33C 801598FC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA340 80159900 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BA3D8 80159998 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* BA3DC 8015999C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* BA46C 80159A2C 3C050002 */  lui        $a1, (0x200A0 >> 16)
  ...
  .L80159A7C_ovl3:
    ...
    /* BA4C4 80159A84 34A5016E */  ori        $a1, $a1, (0x2016E & 0xFFFF)
  ...
  .L80159A98_ovl3:
    ...
    /* BA4E0 80159AA0 34A500C8 */  ori        $a1, $a1, (0x200C8 & 0xFFFF)
    /* BA4E4 80159AA4 0C048C3A */  jal        func_801230E8
    /* BA4E8 80159AA8 00003025 */   or        $a2, $zero, $zero
  .L80159AAC_ovl3:
    /* BA4EC 80159AAC 0C002DAF */  jal        ohSleep
    ...
    /* BA504 80159AC4 0C02BE85 */  jal        curObjSleepForever
