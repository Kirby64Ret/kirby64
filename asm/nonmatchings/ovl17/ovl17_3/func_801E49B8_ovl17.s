.section .late_rodata
nonmatching D_801E56C8_ovl17

dlabel D_801E56C8_ovl17
    /* 2308B8 801E56C8 3E4CCCCD */ .float 0.200000003
enddlabel D_801E56C8_ovl17
.size D_801E56C8_ovl17, . - D_801E56C8_ovl17

nonmatching D_801E56CC_ovl17

dlabel D_801E56CC_ovl17
    /* 2308BC 801E56CC 3ECCCCCD */ .float 0.400000006
enddlabel D_801E56CC_ovl17
.size D_801E56CC_ovl17, . - D_801E56CC_ovl17


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801E49B8_ovl17, 0x41C

glabel func_801E49B8_ovl17
    /* 22FBA8 801E49B8 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 22FBAC 801E49BC AFB00018 */  sw         $s0, 0x18($sp)
    /* 22FBB0 801E49C0 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 22FBB4 801E49C4 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* 22FC48 801E4A58 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 22FC4C 801E4A5C 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    /* 22FC50 801E4A60 3C01801E */  lui        $at, %hi(D_801E56C8_ovl17)
    /* 22FC54 801E4A64 C42056C8 */  lwc1       $f0, %lo(D_801E56C8_ovl17)($at)
    ...
    /* 22FD5C 801E4B6C 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 22FD60 801E4B70 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
    ...
    /* 22FE14 801E4C24 3C01801E */  lui        $at, %hi(D_801E56CC_ovl17)
    /* 22FE18 801E4C28 C42C56CC */  lwc1       $f12, %lo(D_801E56CC_ovl17)($at)
    ...
    /* 22FE28 801E4C38 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 22FE2C 801E4C3C 460C9102 */  mul.s      $f4, $f18, $f12
    /* 22FE30 801E4C40 44817000 */  mtc1       $at, $f14
    /* 22FE34 801E4C44 8E10A7C4 */  lw         $s0, %lo(omCurrentObj)($s0)
  ...
  .L801E4DB0_ovl17:
    /* 22FFA0 801E4DB0 0C002DAF */  jal        ohSleep
