.section .late_rodata
nonmatching D_801E564C_ovl17

dlabel D_801E564C_ovl17
    /* 23083C 801E564C 3FC90FDB */ .float 1.570796371
enddlabel D_801E564C_ovl17
.size D_801E564C_ovl17, . - D_801E564C_ovl17

nonmatching D_801E5650_ovl17

dlabel D_801E5650_ovl17
    /* 230840 801E5650 BFC90FDB */ .float -1.570796371
enddlabel D_801E5650_ovl17
.size D_801E5650_ovl17, . - D_801E5650_ovl17


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DF768_ovl17, 0x354
...
glabel func_801DF768_ovl17
    ...
    /* 22A96C 801DF77C 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 22A970 801DF780 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 22A9B8 801DF7C8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 22A9BC 801DF7CC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 22AB60 801DF970 3C01801E */  lui        $at, %hi(D_801E5650_ovl17)
    ...
    /* 22AB74 801DF984 C42A5650 */  lwc1       $f10, %lo(D_801E5650_ovl17)($at)
  ...
  .L801DF9F8_ovl17:
    /* 22ABE8 801DF9F8 0C029166 */  jal        utilWrapRotation
    /* 22ABEC 801DF9FC 27A40110 */   addiu     $a0, $sp, 0x110
    /* 22ABF0 801DFA00 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 22ABF4 801DFA04 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
