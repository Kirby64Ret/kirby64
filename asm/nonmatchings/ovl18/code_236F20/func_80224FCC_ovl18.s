nonmatching func_80224FCC_ovl18, 0x120

glabel func_80224FCC_ovl18
    /* 23796C 80224FCC 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 237970 80224FD0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 2379A4 80225004 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 2379A8 80225008 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8022508C_ovl18:
    /* 237A2C 8022508C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 237A30 80225090 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    /* 237A34 80225094 3C0A800F */  lui        $t2, %hi(D_800E9E20)
    /* 237A38 80225098 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 237A5C 802250BC AC20DC50 */  sw         $zero, %lo(gEntityFuncListIDArray)($at)
