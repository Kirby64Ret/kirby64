.section .late_rodata
nonmatching D_8018DC6C_ovl5

dlabel D_8018DC6C_ovl5
    /* 1350DC 8018DC6C 3F333333 */ .float 0.6999999881
enddlabel D_8018DC6C_ovl5
.size D_8018DC6C_ovl5, . - D_8018DC6C_ovl5


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8017559C_ovl5, 0x26C

glabel func_8017559C_ovl5
    /* 11CA0C 8017559C 27BDFFE8 */  addiu      $sp, $sp, -0x18
    /* 11CA10 801755A0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 11CA14 801755A4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L8017565C_ovl5:
    /* 11CACC 8017565C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 11CAD0 80175660 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 11CB38 801756C8 3C038019 */  lui        $v1, %hi(D_8018E478_ovl5)
    ...
    /* 11CB5C 801756EC 8C63E478 */  lw         $v1, %lo(D_8018E478_ovl5)($v1)
  ...
  .L80175750_ovl5:
    ...
    /* 11CBC8 80175758 3C038019 */  lui        $v1, %hi(D_8018E478_ovl5)
    ...
    /* 11CBEC 8017577C 8C63E478 */  lw         $v1, %lo(D_8018E478_ovl5)($v1)
  ...
  .L801757D8_ovl5:
    ...
    /* 11CC58 801757E8 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 11CC5C 801757EC 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
...
endlabel func_8017559C_ovl5
.size func_8017559C_ovl5, . - func_8017559C_ovl5
