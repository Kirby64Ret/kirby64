.section .late_rodata
nonmatching jtbl_8018D4F8_ovl5

dlabel jtbl_8018D4F8_ovl5
    /* 134968 8018D4F8 8015F07C */ .word .L8015F07C_ovl5
    /* 13496C 8018D4FC 8015F004 */ .word .L8015F004_ovl5
    /* 134970 8018D500 8015F2EC */ .word .L8015F2EC_ovl5
    /* 134974 8018D504 8015F0F4 */ .word .L8015F0F4_ovl5
    /* 134978 8018D508 8015F2EC */ .word .L8015F2EC_ovl5
    /* 13497C 8018D50C 8015F19C */ .word .L8015F19C_ovl5
    /* 134980 8018D510 8015F168 */ .word .L8015F168_ovl5
    /* 134984 8018D514 8015F214 */ .word .L8015F214_ovl5
enddlabel jtbl_8018D4F8_ovl5
.size jtbl_8018D4F8_ovl5, . - jtbl_8018D4F8_ovl5


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8015ED9C_ovl5, 0x564
...
glabel func_8015ED9C_ovl5
    ...
    /* 106218 8015EDA8 3C188019 */  lui        $t8, %hi(D_8018E228_ovl5)
    /* 10621C 8015EDAC AFB10018 */  sw         $s1, 0x18($sp)
    /* 106220 8015EDB0 2718E228 */  addiu      $t8, $t8, %lo(D_8018E228_ovl5)
    /* 106224 8015EDB4 000F7880 */  sll        $t7, $t7, 2
    /* 106228 8015EDB8 3C0E8019 */  lui        $t6, %hi(D_8018E224_ovl5)
    /* 10622C 8015EDBC 01F88821 */  addu       $s1, $t7, $t8
    /* 106230 8015EDC0 8E220000 */  lw         $v0, 0x0($s1)
    /* 106234 8015EDC4 01C47021 */  addu       $t6, $t6, $a0
    /* 106238 8015EDC8 91CEE224 */  lbu        $t6, %lo(D_8018E224_ovl5)($t6)
  ...
  .L8015EE08_ovl5:
    ...
    /* 106298 8015EE28 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 10629C 8015EE2C 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L8015EE78_ovl5:
    ...
    /* 1062F8 8015EE88 3C028019 */  lui        $v0, %hi(D_8018E1E0_ovl5)
    /* 1062FC 8015EE8C 00501021 */  addu       $v0, $v0, $s0
    /* 106300 8015EE90 9042E1E0 */  lbu        $v0, %lo(D_8018E1E0_ovl5)($v0)
  ...
  .L8015F004_ovl5:
    /* 106474 8015F004 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 106478 8015F008 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015F07C_ovl5:
    /* 1064EC 8015F07C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1064F0 8015F080 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L8015F0F4_ovl5:
    /* 106564 8015F0F4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 106568 8015F0F8 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* 106590 8015F120 3C0D8005 */   lui       $t5, %hi(omCurrentObj)
    /* 106594 8015F124 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* 106598 8015F128 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L8015F148_ovl5:
    /* 1065B8 8015F148 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L8015F280_ovl5:
    /* 1066F0 8015F280 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* 1066F4 8015F284 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
...
endlabel func_8015ED9C_ovl5
.size func_8015ED9C_ovl5, . - func_8015ED9C_ovl5
