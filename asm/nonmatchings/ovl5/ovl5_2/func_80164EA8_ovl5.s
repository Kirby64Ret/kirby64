nonmatching func_80164EA8_ovl5, 0x218
...
glabel func_80164EA8_ovl5
    ...
    /* 10C3B4 80164F44 3C02800D */  lui        $v0, %hi(D_800D7178 + 0x40)
    /* 10C3B8 80164F48 AC6D0000 */  sw         $t5, 0x0($v1)
    /* 10C3BC 80164F4C 8F190004 */  lw         $t9, 0x4($t8)
    /* 10C3C0 80164F50 240E0001 */  addiu      $t6, $zero, 0x1
    /* 10C3C4 80164F54 3C058019 */  lui        $a1, %hi(D_8018E208_ovl5)
    /* 10C3C8 80164F58 AC790004 */  sw         $t9, 0x4($v1)
    /* 10C3CC 80164F5C 8F0D0008 */  lw         $t5, 0x8($t8)
    /* 10C3D0 80164F60 3C048019 */  lui        $a0, %hi(D_8018E21C_ovl5)
    /* 10C3D4 80164F64 2484E21C */  addiu      $a0, $a0, %lo(D_8018E21C_ovl5)
    /* 10C3D8 80164F68 AC6D0008 */  sw         $t5, 0x8($v1)
    /* 10C3DC 80164F6C 8F19000C */  lw         $t9, 0xC($t8)
    /* 10C3E0 80164F70 24A5E208 */  addiu      $a1, $a1, %lo(D_8018E208_ovl5)
    /* 10C3E4 80164F74 3C068019 */  lui        $a2, %hi(D_8018E1E8_ovl5)
    ...
    /* 10C3F8 80164F88 8C4271B8 */  lw         $v0, %lo(D_800D7178 + 0x40)($v0)
    /* 10C3FC 80164F8C 3C018019 */  lui        $at, %hi(D_8018E025_ovl5)
    /* 10C400 80164F90 A02EE025 */  sb         $t6, %lo(D_8018E025_ovl5)($at)
    /* 10C404 80164F94 3C018019 */  lui        $at, %hi(D_8018E258_ovl5)
    /* 10C408 80164F98 A022E258 */  sb         $v0, %lo(D_8018E258_ovl5)($at)
    /* 10C40C 80164F9C 3C018019 */  lui        $at, %hi(D_8018E220_ovl5)
    /* 10C410 80164FA0 A020E220 */  sb         $zero, %lo(D_8018E220_ovl5)($at)
  .L80164FA4_ovl5:
    ...
    /* 10C42C 80164FBC 3C058019 */  lui        $a1, %hi(D_8018E1E0_ovl5)
    /* 10C430 80164FC0 3C0A8019 */  lui        $t2, %hi(D_8018E224_ovl5)
    /* 10C434 80164FC4 3C0C8019 */  lui        $t4, %hi(D_8018E228_ovl5)
    /* 10C438 80164FC8 258CE228 */  addiu      $t4, $t4, %lo(D_8018E228_ovl5)
    /* 10C43C 80164FCC 254AE224 */  addiu      $t2, $t2, %lo(D_8018E224_ovl5)
    /* 10C440 80164FD0 24A5E1E0 */  addiu      $a1, $a1, %lo(D_8018E1E0_ovl5)
    /* 10C444 80164FD4 24C6E1E8 */  addiu      $a2, $a2, %lo(D_8018E1E8_ovl5)
  ...
  .L80165080_ovl5:
    ...
    /* 10C500 80165090 3C048019 */  lui        $a0, %hi(D_8018E1E0_ovl5)
    /* 10C504 80165094 2484E1E0 */  addiu      $a0, $a0, %lo(D_8018E1E0_ovl5)
...
endlabel func_80164EA8_ovl5
.size func_80164EA8_ovl5, . - func_80164EA8_ovl5
