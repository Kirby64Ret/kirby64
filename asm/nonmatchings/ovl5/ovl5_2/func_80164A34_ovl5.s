.section .late_rodata
nonmatching D_8018D5E0_ovl5

dlabel D_8018D5E0_ovl5
    /* 134A50 8018D5E0 3FAA3D71 */ .float 1.330000043
    /* 134A54 8018D5E4 00000000 */ .float 0
    /* 134A58 8018D5E8 00000000 */ .float 0
    /* 134A5C 8018D5EC 00000000 */ .float 0
enddlabel D_8018D5E0_ovl5
.size D_8018D5E0_ovl5, . - D_8018D5E0_ovl5


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80164A34_ovl5, 0x37C

glabel func_80164A34_ovl5
    /* 10BEA4 80164A34 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 10BEA8 80164A38 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 10BEAC 80164A3C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 10BEF8 80164A88 3C05800B */  lui        $a1, %hi(procMainStub)
    /* 10BEFC 80164A8C 24A51434 */  addiu      $a1, $a1, %lo(procMainStub)
    /* 10BF00 80164A90 0018C880 */  sll        $t9, $t8, 2
    /* 10BF04 80164A94 00992021 */  addu       $a0, $a0, $t9
    /* 10BF08 80164A98 0C02C7DA */  jal        setProcessMain
    /* 10BF0C 80164A9C 8C84EC10 */   lw        $a0, %lo(gEntityGObjProcessArray5)($a0)
    /* 10BF10 80164AA0 3C118019 */  lui        $s1, %hi(D_8018E259_ovl5)
    /* 10BF14 80164AA4 2631E259 */  addiu      $s1, $s1, %lo(D_8018E259_ovl5)
    ...
    /* 10BF34 80164AC4 0C00297F */  jal        omLinkGObjDL
    ...
    /* 10C010 80164BA0 0C002DAF */  jal        ohSleep
    /* 10C014 80164BA4 E44A0024 */   swc1      $f10, 0x24($v0)
    /* 10C018 80164BA8 3C16800D */  lui        $s6, %hi(D_800D7178)
    ...
    /* 10C030 80164BC0 26D67178 */  addiu      $s6, $s6, %lo(D_800D7178)
  ...
  .L80164C34_ovl5:
    ...
    /* 10C0B4 80164C44 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 10C0B8 80164C48 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L80164CAC_ovl5:
    ...
    /* 10C124 80164CB4 0C02BE85 */  jal        curObjSleepForever
  ...
  .L80164D60_ovl5:
    /* 10C1D0 80164D60 0C002DAF */  jal        ohSleep
...
endlabel func_80164A34_ovl5
.size func_80164A34_ovl5, . - func_80164A34_ovl5
