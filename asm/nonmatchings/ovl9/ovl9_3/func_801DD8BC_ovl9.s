.section .late_rodata
nonmatching D_8021CF68_ovl9

dlabel D_8021CF68_ovl9
    /* 1CAFB8 8021CF68 40490FDB */ .float 3.141592741
enddlabel D_8021CF68_ovl9
.size D_8021CF68_ovl9, . - D_8021CF68_ovl9

nonmatching D_8021CF6C_ovl9

dlabel D_8021CF6C_ovl9
    /* 1CAFBC 8021CF6C 40C90FDB */ .float 6.283185482
enddlabel D_8021CF6C_ovl9
.size D_8021CF6C_ovl9, . - D_8021CF6C_ovl9

nonmatching D_8021CF70_ovl9

dlabel D_8021CF70_ovl9
    /* 1CAFC0 8021CF70 40C90FDB */ .float 6.283185482
enddlabel D_8021CF70_ovl9
.size D_8021CF70_ovl9, . - D_8021CF70_ovl9

nonmatching D_8021CF74_ovl9

dlabel D_8021CF74_ovl9
    /* 1CAFC4 8021CF74 C0490FDB */ .float -3.141592741
enddlabel D_8021CF74_ovl9
.size D_8021CF74_ovl9, . - D_8021CF74_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DD8BC_ovl9, 0x458

glabel func_801DD8BC_ovl9
    /* 18B90C 801DD8BC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 18B910 801DD8C0 2442A7C4 */  addiu      $v0, $v0, %lo(omCurrentObj)
    ...
    /* 18B968 801DD918 3C0A801D */  lui        $t2, %hi(D_801C8080_ovl7)
    /* 18B96C 801DD91C 254A8080 */  addiu      $t2, $t2, %lo(D_801C8080_ovl7)
    ...
    /* 18B9A4 801DD954 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 18B9A8 801DD958 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* 18B9D4 801DD984 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 18B9D8 801DD988 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* 18BA18 801DD9C8 3C038005 */  lui        $v1, %hi(omCurrentObj)
  ...
  .L801DDA24_ovl9:
    ...
    /* 18BA80 801DDA30 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDA58_ovl9:
    ...
    /* 18BAB0 801DDA60 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* 18BAB4 801DDA64 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDA88_ovl9:
    /* 18BAD8 801DDA88 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 18BADC 801DDA8C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDAB0_ovl9:
    ...
    /* 18BB3C 801DDAEC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 18BB40 801DDAF0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDB90_ovl9:
    ...
    /* 18BBE4 801DDB94 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 18BBF8 801DDBA8 AC2EDC50 */   sw        $t6, %lo(gEntityFuncListIDArray)($at)
  .L801DDBAC_ovl9:
  ...
  .L801DDCDC_ovl9:
    ...
    /* 18BD40 801DDCF0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 18BD44 801DDCF4 240E0004 */  addiu      $t6, $zero, 0x4
    /* 18BD48 801DDCF8 00195880 */  sll        $t3, $t9, 2
    /* 18BD4C 801DDCFC 002B0821 */  addu       $at, $at, $t3
    /* 18BD50 801DDD00 AC2EDC50 */  sw         $t6, %lo(gEntityFuncListIDArray)($at)
  .L801DDD04_ovl9:
