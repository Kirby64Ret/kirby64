.section .late_rodata
nonmatching D_8021CF64_ovl9

dlabel D_8021CF64_ovl9
    /* 1CAFB4 8021CF64 BF266666 */ .float -0.6499999762
enddlabel D_8021CF64_ovl9
.size D_8021CF64_ovl9, . - D_8021CF64_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DD598_ovl9, 0x280

glabel func_801DD598_ovl9
    /* 18B5E8 801DD598 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 18B5EC 801DD59C AFB00030 */  sw         $s0, 0x30($sp)
    /* 18B5F0 801DD5A0 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 18B5F4 801DD5A4 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801DD7C8_ovl9:
    /* 18B818 801DD7C8 0C002DAF */  jal        ohSleep
    /* 18B81C 801DD7CC 24040001 */   addiu     $a0, $zero, 0x1
    /* 18B820 801DD7D0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 18B824 801DD7D4 1000FFE2 */  b          .L801DD760_ovl9
    /* 18B828 801DD7D8 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
    /* 18B82C 801DD7DC 8FBF0044 */  lw         $ra, 0x44($sp)
  .L801DD7E0_ovl9:
    /* 18B830 801DD7E0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 18B85C 801DD80C AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
    /* 18B860 801DD810 03E00008 */  jr         $ra
    /* 18B864 801DD814 27BD0048 */   addiu     $sp, $sp, 0x48
endlabel func_801DD598_ovl9
