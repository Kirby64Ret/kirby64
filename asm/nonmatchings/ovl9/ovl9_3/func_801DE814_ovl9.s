.section .late_rodata
nonmatching D_8021CF7C_ovl9

dlabel D_8021CF7C_ovl9
    /* 1CAFCC 8021CF7C 477FFF00 */ .float 65535
enddlabel D_8021CF7C_ovl9
.size D_8021CF7C_ovl9, . - D_8021CF7C_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DE814_ovl9, 0x3B0

glabel func_801DE814_ovl9
    /* 18C864 801DE814 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 18C868 801DE818 AFB60040 */  sw         $s6, 0x40($sp)
    /* 18C86C 801DE81C 3C168005 */  lui        $s6, %hi(omCurrentObj)
    /* 18C870 801DE820 26D6A7C4 */  addiu      $s6, $s6, %lo(omCurrentObj)
    ...
    /* 18C8E4 801DE894 3C09801D */  lui        $t1, %hi(D_801C8080_ovl7)
    /* 18C8E8 801DE898 25298080 */  addiu      $t1, $t1, %lo(D_801C8080_ovl7)
  ...
  .L801DEA94_ovl9:
    ...
    /* 18CB34 801DEAE4 0C002DAF */  jal        ohSleep
    /* 18CB38 801DEAE8 E5120000 */   swc1      $f18, 0x0($t0)
    /* 18CB3C 801DEAEC 2610FFFF */  addiu      $s0, $s0, -0x1
    /* 18CB40 801DEAF0 5600FFE8 */  bnel       $s0, $zero, .L801DEA94_ovl9
  ...
  .L801DEB0C_ovl9:
    ...
    /* 18CBAC 801DEB5C 0C002DAF */  jal        ohSleep
  ...
  .L801DEB84_ovl9:
    ...
    /* 18CBDC 801DEB8C 0C02BE85 */  jal        curObjSleepForever
