.section .late_rodata
nonmatching D_8021D900_ovl9

dlabel D_8021D900_ovl9
    /* 1CB950 8021D900 3ECCCCCD */ .float 0.400000006
enddlabel D_8021D900_ovl9
.size D_8021D900_ovl9, . - D_8021D900_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801F3E60_ovl9, 0x268

glabel func_801F3E60_ovl9
    /* 1A1EB0 801F3E60 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1A1EB4 801F3E64 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1A1F0C 801F3EBC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1A1F10 801F3EC0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1A1F74 801F3F24 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1A1F78 801F3F28 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801F3F64_ovl9:
    /* 1A1FB4 801F3F64 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1A1FB8 801F3F68 00220821 */  addu       $at, $at, $v0
    /* 1A1FBC 801F3F6C 24180002 */  addiu      $t8, $zero, 0x2
    /* 1A1FC0 801F3F70 AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801F3F9C_ovl9:
    /* 1A1FEC 801F3F9C 0C066C51 */  jal        eneGetPlayerHeight
    /* 1A1FF0 801F3FA0 E7A40038 */   swc1      $f4, 0x38($sp)
    /* 1A1FF4 801F3FA4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1A1FF8 801F3FA8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1A2044 801F3FF4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1A2048 801F3FF8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
