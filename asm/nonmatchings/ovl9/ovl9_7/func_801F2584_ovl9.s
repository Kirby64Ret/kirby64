.section .late_rodata
nonmatching D_8021D8E8_ovl9

dlabel D_8021D8E8_ovl9
    /* 1CB938 8021D8E8 3727C5AC */ .float 9.999999747e-06
    /* 1CB93C 8021D8EC 00000000 */ .float 0
enddlabel D_8021D8E8_ovl9
.size D_8021D8E8_ovl9, . - D_8021D8E8_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801F2584_ovl9, 0x38C

glabel func_801F2584_ovl9
    /* 1A05D4 801F2584 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 1A05D8 801F2588 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
    ...
    /* 1A0674 801F2624 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1A0678 801F2628 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801F26B8_ovl9:
    ...
    /* 1A0720 801F26D0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1A0724 801F26D4 3C01800E */  lui        $at, %hi(D_800DEF90)
    /* 1A0728 801F26D8 E5460010 */  swc1       $f6, 0x10($t2)
    /* 1A072C 801F26DC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1A0770 801F2720 0C0291E5 */  jal        utilGetTransformSRT
    /* 1A0774 801F2724 8F250014 */   lw        $a1, 0x14($t9)
    /* 1A0778 801F2728 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1A077C 801F272C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801F2804_ovl9:
    ...
    /* 1A08B8 801F2868 0C002DAF */  jal        ohSleep
    ...
    /* 1A08E8 801F2898 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1A08EC 801F289C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1A0940 801F28F0 0C002DAF */  jal        ohSleep
