.section .late_rodata
nonmatching D_8021D8CC_ovl9

dlabel D_8021D8CC_ovl9
    /* 1CB91C 8021D8CC 3F860A92 */ .float 1.04719758
enddlabel D_8021D8CC_ovl9
.size D_8021D8CC_ovl9, . - D_8021D8CC_ovl9

nonmatching D_8021D8D0_ovl9

dlabel D_8021D8D0_ovl9
    /* 1CB920 8021D8D0 40060A92 */ .float 2.094395161
enddlabel D_8021D8D0_ovl9
.size D_8021D8D0_ovl9, . - D_8021D8D0_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801F1784_ovl9, 0x4E4

glabel func_801F1784_ovl9
    /* 19F7D4 801F1784 27BDFFD0 */  addiu      $sp, $sp, -0x30
    /* 19F7D8 801F1788 AFB00020 */  sw         $s0, 0x20($sp)
    /* 19F7DC 801F178C 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 19F7E0 801F1790 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
    ...
    /* 19F86C 801F181C 3C18801D */  lui        $t8, %hi(D_801C9A4C_ovl7)
    /* 19F870 801F1820 27189A4C */  addiu      $t8, $t8, %lo(D_801C9A4C_ovl7)
  ...
  .L801F1A5C_ovl9:
    ...
    /* 19FB14 801F1AC4 0C002DAF */  jal        ohSleep
    ...
    /* 19FBEC 801F1B9C 0C002DAF */  jal        ohSleep
    ...
    /* 19FC30 801F1BE0 0C002DAF */  jal        ohSleep
    /* 19FC34 801F1BE4 E4326690 */   swc1      $f18, %lo(D_800E6690)($at)
    /* 19FC38 801F1BE8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 19FC3C 801F1BEC 0C02BB30 */  jal        func_800AECC0
    /* 19FC40 801F1BF0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 19FC44 801F1BF4 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 19FC48 801F1BF8 0C02BB48 */  jal        func_800AED20
    /* 19FC4C 801F1BFC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 19FC50 801F1C00 0C002DAF */  jal        ohSleep
