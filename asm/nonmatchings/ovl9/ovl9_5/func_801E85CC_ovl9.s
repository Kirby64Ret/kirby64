.section .late_rodata
nonmatching D_8021D090_ovl9

dlabel D_8021D090_ovl9
    /* 1CB0E0 8021D090 BF9C61AA */ .float -1.221730471
enddlabel D_8021D090_ovl9
.size D_8021D090_ovl9, . - D_8021D090_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801E85CC_ovl9, 0x1F4

glabel func_801E85CC_ovl9
    /* 19661C 801E85CC 27BDFFD8 */  addiu      $sp, $sp, -0x28
    /* 196620 801E85D0 AFB20020 */  sw         $s2, 0x20($sp)
    /* 196624 801E85D4 3C128005 */  lui        $s2, %hi(omCurrentObj)
    /* 196628 801E85D8 2652A7C4 */  addiu      $s2, $s2, %lo(omCurrentObj)
    ...
    /* 196670 801E8620 3C11800D */  lui        $s1, %hi(gameTicksPerDraw)
    /* 196674 801E8624 2739BBC0 */  addiu      $t9, $t9, %lo(D_801CBBC0)
    /* 196678 801E8628 26316B10 */  addiu      $s1, $s1, %lo(gameTicksPerDraw)
  ...
  .L801E8758_ovl9:
    ...
    /* 1967E8 801E8798 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 196804 801E87B4 AC20DC50 */  sw         $zero, %lo(gEntityFuncListIDArray)($at)
    /* 196808 801E87B8 03E00008 */  jr         $ra
    /* 19680C 801E87BC 27BD0028 */   addiu     $sp, $sp, 0x28
endlabel func_801E85CC_ovl9
