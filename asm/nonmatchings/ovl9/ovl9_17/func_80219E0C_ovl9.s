nonmatching func_80219E0C_ovl9, 0x164
...
glabel func_80219E0C_ovl9
  ...
  .L80219E6C_ovl9:
    /* 1C7EBC 80219E6C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L80219EA8_ovl9:
    ...
    /* 1C7F08 80219EB8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1C7F0C 80219EBC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1C7F44 80219EF4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1C7F48 80219EF8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L80219F18_ovl9:
    /* 1C7F68 80219F18 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80219F38_ovl9:
    /* 1C7F88 80219F38 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
