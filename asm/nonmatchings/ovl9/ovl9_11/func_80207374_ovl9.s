nonmatching func_80207374_ovl9, 0x13C

glabel func_80207374_ovl9
    /* 1B53C4 80207374 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1B53C8 80207378 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1B5404 802073B4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B5408 802073B8 ACD80098 */  sw         $t8, 0x98($a2)
    /* 1B540C 802073BC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1B5474 80207424 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1B5478 80207428 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L80207434_ovl9:
    ...
    /* 1B54A0 80207450 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1B54A4 80207454 00220821 */  addu       $at, $at, $v0
    /* 1B54A8 80207458 10000004 */  b          .L8020746C_ovl9
    /* 1B54AC 8020745C AC20DC50 */   sw        $zero, %lo(gEntityFuncListIDArray)($at)
  .L80207460_ovl9:
    /* 1B54B0 80207460 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1B54B4 80207464 00220821 */  addu       $at, $at, $v0
    /* 1B54B8 80207468 AC39DC50 */  sw         $t9, %lo(gEntityFuncListIDArray)($at)
  .L8020746C_ovl9:
    /* 1B54BC 8020746C 0C068354 */  jal        func_801A0D50_ovl7
    /* 1B54C0 80207470 24847304 */   addiu     $a0, $a0, %lo(func_80207304_ovl9)
    /* 1B54C4 80207474 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 1B54C8 80207478 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
    /* 1B54CC 8020747C 3C04800E */  lui        $a0, %hi(gEntityFuncListIDArray)
    ...
    /* 1B54E8 80207498 0C02911F */  jal        utilFuncTableJump
    /* 1B54EC 8020749C 8C84DC50 */   lw        $a0, %lo(gEntityFuncListIDArray)($a0)
