.section .late_rodata
nonmatching D_8021D994_ovl9

dlabel D_8021D994_ovl9
    /* 1CB9E4 8021D994 477FFF00 */ .float 65535
enddlabel D_8021D994_ovl9
.size D_8021D994_ovl9, . - D_8021D994_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801FBF50_ovl9, 0x244

glabel func_801FBF50_ovl9
    /* 1A9FA0 801FBF50 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* 1A9FA4 801FBF54 24E7A7C4 */  addiu      $a3, $a3, %lo(omCurrentObj)
    ...
    /* 1AA078 801FC028 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1AA088 801FC038 AC29DC50 */  sw         $t1, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801FC05C_ovl9:
    ...
    /* 1AA0CC 801FC07C 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* 1AA0D0 801FC080 24080003 */  addiu      $t0, $zero, 0x3
    /* 1AA0D4 801FC084 24E7A7C4 */  addiu      $a3, $a3, %lo(omCurrentObj)
    ...
    /* 1AA12C 801FC0DC 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1AA13C 801FC0EC AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801FC114_ovl9:
    ...
    /* 1AA19C 801FC14C 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1AA1B0 801FC160 AC29DC50 */  sw         $t1, %lo(gEntityFuncListIDArray)($at)
