.section .late_rodata
nonmatching D_8021D9E0_ovl9

dlabel D_8021D9E0_ovl9
    /* 1CBA30 8021D9E0 477FFF00 */ .float 65535
enddlabel D_8021D9E0_ovl9
.size D_8021D9E0_ovl9, . - D_8021D9E0_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801FFAD0_ovl9, 0x190

glabel func_801FFAD0_ovl9
    /* 1ADB20 801FFAD0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1ADB24 801FFAD4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801FFBBC_ovl9:
    /* 1ADC0C 801FFBBC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1ADC10 801FFBC0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1ADC78 801FFC28 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1ADC88 801FFC38 AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
