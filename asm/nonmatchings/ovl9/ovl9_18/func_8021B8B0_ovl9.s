.section .late_rodata
nonmatching D_8021DEF0_ovl9

dlabel D_8021DEF0_ovl9
    /* 1CBF40 8021DEF0 3F490FDB */ .float 0.7853981853
    /* 1CBF44 8021DEF4 00000000 */ .float 0
    /* 1CBF48 8021DEF8 00000000 */ .float 0
    /* 1CBF4C 8021DEFC 00000000 */ .float 0
enddlabel D_8021DEF0_ovl9
.size D_8021DEF0_ovl9, . - D_8021DEF0_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8021B8B0_ovl9, 0x1D0

glabel func_8021B8B0_ovl9
    /* 1C9900 8021B8B0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1C9904 8021B8B4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1C9940 8021B8F0 3C0B8005 */   lui       $t3, %hi(omCurrentObj)
    /* 1C9944 8021B8F4 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 1C9948 8021B8F8 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
  ...
  .L8021B918_ovl9:
    /* 1C9968 8021B918 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L8021B968_ovl9:
    ...
    /* 1C99FC 8021B9AC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1C9A00 8021B9B0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
