nonmatching func_801D5850_ovl9, 0x568

glabel func_801D5850_ovl9
    /* 1838A0 801D5850 27BDFFC0 */  addiu      $sp, $sp, -0x40
    /* 1838A4 801D5854 AFB1001C */  sw         $s1, 0x1C($sp)
    /* 1838A8 801D5858 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 1838AC 801D585C 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
    ...
    /* 183940 801D58F0 3C1E800E */  lui        $fp, %hi(gEntityFuncListIDArray)
    ...
    /* 183974 801D5924 27DEDC50 */   addiu     $fp, $fp, %lo(gEntityFuncListIDArray)
    ...
    /* 18398C 801D593C 3C18800E */   lui       $t8, %hi(gEntityFuncListIDArray)
    /* 183990 801D5940 2718DC50 */  addiu      $t8, $t8, %lo(gEntityFuncListIDArray)
  ...
  .L801D5B6C_ovl9:
    /* 183BBC 801D5B6C 3C1E800E */  lui        $fp, %hi(gEntityFuncListIDArray)
    ...
    /* 183BF0 801D5BA0 27DEDC50 */  addiu      $fp, $fp, %lo(gEntityFuncListIDArray)
