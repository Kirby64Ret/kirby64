nonmatching func_801D3EA4_ovl9, 0x470
...
glabel func_801D3EA4_ovl9
    ...
    /* 181F2C 801D3EDC 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 181F30 801D3EE0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 181F54 801D3F04 3C038005 */  lui        $v1, %hi(omCurrentObj)
    ...
    /* 181F94 801D3F44 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801D40FC_ovl9:
    /* 18214C 801D40FC 0C002DAF */  jal        ohSleep
    /* 182150 801D4100 2404003B */   addiu     $a0, $zero, 0x3B
    /* 182154 801D4104 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 182158 801D4108 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801D4238_ovl9:
    /* 182288 801D4238 0C002DAF */  jal        ohSleep
    /* 18228C 801D423C 2404003B */   addiu     $a0, $zero, 0x3B
    /* 182290 801D4240 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 182294 801D4244 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
