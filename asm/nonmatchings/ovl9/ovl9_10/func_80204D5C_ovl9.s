.section .late_rodata
nonmatching D_8021DA7C_ovl9

dlabel D_8021DA7C_ovl9
    /* 1CBACC 8021DA7C 3ECCCCCD */ .float 0.400000006
enddlabel D_8021DA7C_ovl9
.size D_8021DA7C_ovl9, . - D_8021DA7C_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80204D5C_ovl9, 0x224

glabel func_80204D5C_ovl9
    /* 1B2DAC 80204D5C 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1B2DB0 80204D60 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1B2DE8 80204D98 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* 1B2DEC 80204D9C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B2DF0 80204DA0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    /* 1B2DF4 80204DA4 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1B2E10 80204DC0 AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
  ...
  .L80204DE4_ovl9:
    /* 1B2E34 80204DE4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1B2E48 80204DF8 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1B2E70 80204E20 AC2EDC50 */  sw         $t6, %lo(gEntityFuncListIDArray)($at)
  ...
  .L80204E48_ovl9:
    ...
    /* 1B2EA4 80204E54 0C066C51 */  jal        eneGetPlayerHeight
    /* 1B2EA8 80204E58 E7A80038 */   swc1      $f8, 0x38($sp)
    /* 1B2EAC 80204E5C 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 1B2EB0 80204E60 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
    ...
    /* 1B2EFC 80204EAC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B2F00 80204EB0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
