.section .late_rodata
nonmatching D_8021DA60_ovl9

dlabel D_8021DA60_ovl9
    /* 1CBAB0 8021DA60 3ECCCCCD */ .float 0.400000006
enddlabel D_8021DA60_ovl9
.size D_8021DA60_ovl9, . - D_8021DA60_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_80203BA8_ovl9, 0x254

glabel func_80203BA8_ovl9
    /* 1B1BF8 80203BA8 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1B1BFC 80203BAC 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1B1C44 80203BF4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1B1C48 80203BF8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1B1C84 80203C34 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 1B1C88 80203C38 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80203C58_ovl9:
    /* 1B1CA8 80203C58 0C066C51 */  jal        eneGetPlayerHeight
    /* 1B1CAC 80203C5C E7A40038 */   swc1      $f4, 0x38($sp)
    /* 1B1CB0 80203C60 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1B1CB4 80203C64 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 1B1D00 80203CB0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B1D04 80203CB4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80203D60_ovl9:
    ...
    /* 1B1DC8 80203D78 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B1DCC 80203D7C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L80203D84_ovl9:
    ...
    /* 1B1E00 80203DB0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1B1E1C 80203DCC AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
