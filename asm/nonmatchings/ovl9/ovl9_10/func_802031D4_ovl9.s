.section .late_rodata
nonmatching D_8021DA54_ovl9

dlabel D_8021DA54_ovl9
    /* 1CBAA4 8021DA54 3ECCCCCD */ .float 0.400000006
enddlabel D_8021DA54_ovl9
.size D_8021DA54_ovl9, . - D_8021DA54_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_802031D4_ovl9, 0x1DC

glabel func_802031D4_ovl9
    /* 1B1224 802031D4 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1B1228 802031D8 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1B1270 80203220 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1B1274 80203224 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1B12B0 80203260 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 1B12B4 80203264 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L80203284_ovl9:
    /* 1B12D4 80203284 0C066C51 */  jal        eneGetPlayerHeight
    /* 1B12D8 80203288 E7A40038 */   swc1      $f4, 0x38($sp)
    /* 1B12DC 8020328C 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1B12E0 80203290 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 1B132C 802032DC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1B1330 802032E0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
