.section .rodata
.align 2
nonmatching D_8021D940_ovl9

dlabel D_8021D940_ovl9
    /* 1CB990 8021D940 */ .asciz "Error: FOURNINE!!/n"
    /* 4572726F723A20464F55524E494E4521212F6E00 */
.align 2
enddlabel D_8021D940_ovl9
.size D_8021D940_ovl9, . - D_8021D940_ovl9

.section .late_rodata
nonmatching D_8021D98C_ovl9

dlabel D_8021D98C_ovl9
    /* 1CB9DC 8021D98C 461C3C00 */ .float 9999
enddlabel D_8021D98C_ovl9
.size D_8021D98C_ovl9, . - D_8021D98C_ovl9


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801FB744_ovl9, 0x174

glabel func_801FB744_ovl9
    /* 1A9794 801FB744 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1A9798 801FB748 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1A97FC 801FB7AC 3C188005 */  lui        $t8, %hi(omCurrentObj)
    ...
    /* 1A9810 801FB7C0 0C02909C */  jal        utilPrintf
  ...
  .L801FB7D0_ovl9:
    /* 1A9820 801FB7D0 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L801FB858_ovl9:
    ...
    /* 1A98B8 801FB868 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* 1A98BC 801FB86C 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
