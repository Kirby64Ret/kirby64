nonmatching func_801DB684_ovl11, 0x14C

glabel func_801DB684_ovl11
    /* 1E5F44 801DB684 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1E5F48 801DB688 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DB6D0_ovl11:
    ...
    /* 1E5F94 801DB6D4 3C01801E */  lui        $at, %hi(D_801E0C14_ovl11)
    ...
    /* 1E5FAC 801DB6EC 3C01801E */  lui        $at, %hi(D_801E0C10_ovl11)
  ...
  .L801DB708_ovl11:
    /* 1E5FC8 801DB708 C4240C10 */  lwc1       $f4, %lo(D_801E0C10_ovl11)($at)
  ...
  .L801DB78C_ovl11:
    /* 1E604C 801DB78C C4260C14 */  lwc1       $f6, %lo(D_801E0C14_ovl11)($at)
