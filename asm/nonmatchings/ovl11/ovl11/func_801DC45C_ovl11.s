nonmatching func_801DC45C_ovl11, 0x154

glabel func_801DC45C_ovl11
    /* 1E6D1C 801DC45C 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 1E6D20 801DC460 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
    /* 1E6D24 801DC464 27BDFFE8 */  addiu      $sp, $sp, -0x18
    /* 1E6D28 801DC468 AFBF0014 */  sw         $ra, 0x14($sp)
    /* 1E6D2C 801DC46C 8C830000 */  lw         $v1, 0x0($a0)
    /* 1E6D30 801DC470 3C0E800E */  lui        $t6, %hi(gEntityFuncListIDArray)
    /* 1E6D34 801DC474 3C02800F */  lui        $v0, %hi(D_800EA520)
    /* 1E6D38 801DC478 00031880 */  sll        $v1, $v1, 2
    /* 1E6D3C 801DC47C 25CEDC50 */  addiu      $t6, $t6, %lo(gEntityFuncListIDArray)
  ...
  .L801DC4BC_ovl11:
    ...
    /* 1E6D8C 801DC4CC 3C06800E */  lui        $a2, %hi(gEntityFuncListIDArray)
    /* 1E6D90 801DC4D0 00031880 */  sll        $v1, $v1, 2
    /* 1E6D94 801DC4D4 00C33021 */  addu       $a2, $a2, $v1
    /* 1E6D98 801DC4D8 1000002A */  b          .L801DC584_ovl11
    /* 1E6D9C 801DC4DC 8CC6DC50 */   lw        $a2, %lo(gEntityFuncListIDArray)($a2)
  .L801DC4E0_ovl11:
    ...
    /* 1E6DB0 801DC4F0 3C06800E */  lui        $a2, %hi(gEntityFuncListIDArray)
    /* 1E6DB4 801DC4F4 00031880 */  sll        $v1, $v1, 2
    /* 1E6DB8 801DC4F8 00C33021 */  addu       $a2, $a2, $v1
    /* 1E6DBC 801DC4FC 10000021 */  b          .L801DC584_ovl11
    /* 1E6DC0 801DC500 8CC6DC50 */   lw        $a2, %lo(gEntityFuncListIDArray)($a2)
  .L801DC504_ovl11:
  ...
  .L801DC584_ovl11:
    ...
    /* 1E6E50 801DC590 3C05801E */  lui        $a1, %hi(func_801DC258_ovl11)
    /* 1E6E54 801DC594 24A5C258 */  addiu      $a1, $a1, %lo(func_801DC258_ovl11)
