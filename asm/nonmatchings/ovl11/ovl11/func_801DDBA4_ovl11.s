nonmatching func_801DDBA4_ovl11, 0x1DC

glabel func_801DDBA4_ovl11
    /* 1E8464 801DDBA4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1E8468 801DDBA8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDBF8_ovl11:
    ...
    /* 1E84C0 801DDC00 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1E84C4 801DDC04 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 1E84E8 801DDC28 3C198005 */   lui       $t9, %hi(omCurrentObj)
    /* 1E84EC 801DDC2C 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L801DDC58_ovl11:
    ...
    /* 1E8524 801DDC64 3C0D8005 */   lui       $t5, %hi(omCurrentObj)
    /* 1E8528 801DDC68 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801DDC94_ovl11:
    ...
    /* 1E8560 801DDCA0 3C188005 */   lui       $t8, %hi(omCurrentObj)
    /* 1E8564 801DDCA4 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L801DDCD0_ovl11:
    /* 1E8590 801DDCD0 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1E8594 801DDCD4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L801DDCF4_ovl11:
    /* 1E85B4 801DDCF4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 1E85B8 801DDCF8 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
