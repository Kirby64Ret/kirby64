.section .late_rodata
nonmatching D_801F4CA4_ovl10

dlabel D_801F4CA4_ovl10
    /* 1E5A14 801F4CA4 3E4CCCCD */ .float 0.200000003
enddlabel D_801F4CA4_ovl10
.size D_801F4CA4_ovl10, . - D_801F4CA4_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801F1A24_ovl10, 0x27C
...
glabel func_801F1A24_ovl10
    ...
    /* 1E27B8 801F1A48 3C0E8005 */   lui       $t6, %hi(omCurrentObj)
    /* 1E27BC 801F1A4C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801F1A84_ovl10:
    /* 1E27F4 801F1A84 3C04801F */  lui        $a0, %hi(D_801F48F4_ovl10)
    /* 1E27F8 801F1A88 008F2021 */  addu       $a0, $a0, $t7
    /* 1E27FC 801F1A8C 8C8448F4 */  lw         $a0, %lo(D_801F48F4_ovl10)($a0)
    ...
    /* 1E280C 801F1A9C 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 1E2810 801F1AA0 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
    /* 1E2814 801F1AA4 3C18801F */  lui        $t8, %hi(D_801F4884_ovl10)
    /* 1E2818 801F1AA8 3C01800E */  lui        $at, %hi(D_800E0490)
    /* 1E281C 801F1AAC 8F280000 */  lw         $t0, 0x0($t9)
    /* 1E2820 801F1AB0 27184884 */  addiu      $t8, $t8, %lo(D_801F4884_ovl10)
  ...
  .L801F1AE8_ovl10:
    /* 1E2858 801F1AE8 3C04801F */  lui        $a0, %hi(D_801F48F4_ovl10)
    /* 1E285C 801F1AEC 008C2021 */  addu       $a0, $a0, $t4
    /* 1E2860 801F1AF0 8C8448F4 */  lw         $a0, %lo(D_801F48F4_ovl10)($a0)
    ...
    /* 1E2870 801F1B00 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1E2874 801F1B04 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    /* 1E2878 801F1B08 3C0D801F */  lui        $t5, %hi(D_801F48D8_ovl10)
    /* 1E287C 801F1B0C 3C01800E */  lui        $at, %hi(D_800E0490)
    /* 1E2880 801F1B10 8DCF0000 */  lw         $t7, 0x0($t6)
    /* 1E2884 801F1B14 25AD48D8 */  addiu      $t5, $t5, %lo(D_801F48D8_ovl10)
  ...
  .L801F1B4C_ovl10:
    /* 1E28BC 801F1B4C 3C04801F */  lui        $a0, %hi(D_801F48F4_ovl10)
    /* 1E28C0 801F1B50 00892021 */  addu       $a0, $a0, $t1
    /* 1E28C4 801F1B54 8C8448F4 */  lw         $a0, %lo(D_801F48F4_ovl10)($a0)
    ...
    /* 1E28D4 801F1B64 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 1E28D8 801F1B68 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    /* 1E28DC 801F1B6C 3C0A801F */  lui        $t2, %hi(D_801F48BC_ovl10)
    /* 1E28E0 801F1B70 3C01800E */  lui        $at, %hi(D_800E0490)
    /* 1E28E4 801F1B74 8D6C0000 */  lw         $t4, 0x0($t3)
    /* 1E28E8 801F1B78 254A48BC */  addiu      $t2, $t2, %lo(D_801F48BC_ovl10)
  ...
  .L801F1C00_ovl10:
    /* 1E2970 801F1C00 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E2974 801F1C04 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E29D0 801F1C60 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1E29D4 801F1C64 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1E29F4 801F1C84 0C02BE85 */  jal        curObjSleepForever
