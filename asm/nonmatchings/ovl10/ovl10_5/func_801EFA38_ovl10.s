.section .late_rodata
nonmatching D_801F4C4C_ovl10

dlabel D_801F4C4C_ovl10
    /* 1E59BC 801F4C4C 412CCCCD */ .float 10.80000019
enddlabel D_801F4C4C_ovl10
.size D_801F4C4C_ovl10, . - D_801F4C4C_ovl10

nonmatching D_801F4C50_ovl10

dlabel D_801F4C50_ovl10
    /* 1E59C0 801F4C50 BE99999A */ .float -0.3000000119
enddlabel D_801F4C50_ovl10
.size D_801F4C50_ovl10, . - D_801F4C50_ovl10

nonmatching D_801F4C54_ovl10

dlabel D_801F4C54_ovl10
    /* 1E59C4 801F4C54 477FFF00 */ .float 65535
enddlabel D_801F4C54_ovl10
.size D_801F4C54_ovl10, . - D_801F4C54_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EFA38_ovl10, 0x220

glabel func_801EFA38_ovl10
    /* 1E07A8 801EFA38 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1E07AC 801EFA3C 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    ...
    /* 1E0820 801EFAB0 3C09801D */  lui        $t1, %hi(D_801CA04C_ovl7)
    /* 1E0824 801EFAB4 2529A04C */  addiu      $t1, $t1, %lo(D_801CA04C_ovl7)
    ...
    /* 1E086C 801EFAFC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E0870 801EFB00 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E08F0 801EFB80 0C002DAF */  jal        ohSleep
    /* 1E08F4 801EFB84 E4263050 */   swc1      $f6, %lo(D_800E3050)($at)
    /* 1E08F8 801EFB88 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E08FC 801EFB8C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E09B0 801EFC40 0C02BE85 */  jal        curObjSleepForever
