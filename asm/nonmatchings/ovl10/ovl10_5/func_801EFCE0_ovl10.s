.section .late_rodata
nonmatching D_801F4C58_ovl10

dlabel D_801F4C58_ovl10
    /* 1E59C8 801F4C58 413CCCCD */ .float 11.80000019
enddlabel D_801F4C58_ovl10
.size D_801F4C58_ovl10, . - D_801F4C58_ovl10

nonmatching D_801F4C5C_ovl10

dlabel D_801F4C5C_ovl10
    /* 1E59CC 801F4C5C 477FFF00 */ .float 65535
enddlabel D_801F4C5C_ovl10
.size D_801F4C5C_ovl10, . - D_801F4C5C_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EFCE0_ovl10, 0x230

glabel func_801EFCE0_ovl10
    /* 1E0A50 801EFCE0 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1E0A54 801EFCE4 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    ...
    /* 1E0AD4 801EFD64 3C0C801D */  lui        $t4, %hi(D_801CA04C_ovl7)
    /* 1E0AD8 801EFD68 258CA04C */  addiu      $t4, $t4, %lo(D_801CA04C_ovl7)
    ...
    /* 1E0AEC 801EFD7C 3C0D801F */  lui        $t5, %hi(func_801EF9B0_ovl10)
    /* 1E0AF0 801EFD80 8DD80000 */  lw         $t8, 0x0($t6)
    /* 1E0AF4 801EFD84 25ADF9B0 */  addiu      $t5, $t5, %lo(func_801EF9B0_ovl10)
    ...
    /* 1E0B1C 801EFDAC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E0B20 801EFDB0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E0BA8 801EFE38 0C002DAF */  jal        ohSleep
    /* 1E0BAC 801EFE3C E4263050 */   swc1      $f6, %lo(D_800E3050)($at)
    /* 1E0BB0 801EFE40 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E0BB4 801EFE44 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E0C68 801EFEF8 0C02BE85 */  jal        curObjSleepForever
