.section .late_rodata
nonmatching D_801F4C40_ovl10

dlabel D_801F4C40_ovl10
    /* 1E59B0 801F4C40 412CCCCD */ .float 10.80000019
enddlabel D_801F4C40_ovl10
.size D_801F4C40_ovl10, . - D_801F4C40_ovl10

nonmatching D_801F4C44_ovl10

dlabel D_801F4C44_ovl10
    /* 1E59B4 801F4C44 BE99999A */ .float -0.3000000119
enddlabel D_801F4C44_ovl10
.size D_801F4C44_ovl10, . - D_801F4C44_ovl10

nonmatching D_801F4C48_ovl10

dlabel D_801F4C48_ovl10
    /* 1E59B8 801F4C48 477FFF00 */ .float 65535
enddlabel D_801F4C48_ovl10
.size D_801F4C48_ovl10, . - D_801F4C48_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EF790_ovl10, 0x220

glabel func_801EF790_ovl10
    /* 1E0500 801EF790 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1E0504 801EF794 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    ...
    /* 1E0578 801EF808 3C09801D */  lui        $t1, %hi(D_801CA04C_ovl7)
    /* 1E057C 801EF80C 2529A04C */  addiu      $t1, $t1, %lo(D_801CA04C_ovl7)
    /* 1E0580 801EF810 468021A0 */  cvt.s.w    $f6, $f4
    /* 1E0584 801EF814 3C0A801F */  lui        $t2, %hi(func_801EF9B0_ovl10)
    /* 1E0588 801EF818 254AF9B0 */  addiu      $t2, $t2, %lo(func_801EF9B0_ovl10)
    ...
    /* 1E05C4 801EF854 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E05C8 801EF858 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E0648 801EF8D8 0C002DAF */  jal        ohSleep
    /* 1E064C 801EF8DC E4263050 */   swc1      $f6, %lo(D_800E3050)($at)
    /* 1E0650 801EF8E0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1E0654 801EF8E4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1E0708 801EF998 0C02BE85 */  jal        curObjSleepForever
