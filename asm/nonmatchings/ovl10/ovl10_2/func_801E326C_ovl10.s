nonmatching func_801E326C_ovl10, 0x1E4

glabel func_801E326C_ovl10
    /* 1D3FDC 801E326C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D3FE0 801E3270 2463A7C4 */  addiu      $v1, $v1, %lo(omCurrentObj)
  ...
  .L801E3320_ovl10:
    ...
    /* 1D4098 801E3328 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1D409C 801E332C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L801E337C_ovl10:
    ...
    /* 1D40FC 801E338C 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1D4100 801E3390 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1D4150 801E33E0 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1D4154 801E33E4 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1D4180 801E3410 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 1D4184 801E3414 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 1D41A0 801E3430 0C002DAF */  jal        ohSleep
