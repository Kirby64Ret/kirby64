.section .late_rodata
nonmatching D_801F4BD0_ovl10

dlabel D_801F4BD0_ovl10
    /* 1E5940 801F4BD0 477FFF00 */ .float 65535
enddlabel D_801F4BD0_ovl10
.size D_801F4BD0_ovl10, . - D_801F4BD0_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EDAA0_ovl10, 0x27C

glabel func_801EDAA0_ovl10
    /* 1DE810 801EDAA0 27BDFFC0 */  addiu      $sp, $sp, -0x40
    /* 1DE814 801EDAA4 AFB00034 */  sw         $s0, 0x34($sp)
    /* 1DE818 801EDAA8 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 1DE81C 801EDAAC 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
    ...
    /* 1DE87C 801EDB0C 3C08801F */  lui        $t0, %hi(D_801F4148_ovl10)
    /* 1DE880 801EDB10 AC2FDFD0 */  sw         $t7, %lo(D_800DDFD0)($at)
    /* 1DE884 801EDB14 25084148 */  addiu      $t0, $t0, %lo(D_801F4148_ovl10)
    ...
    /* 1DE984 801EDC14 3C01801F */  lui        $at, %hi(D_801F4BD0_ovl10)
  ...
  .L801EDCD4_ovl10:
    /* 1DEA44 801EDCD4 0C002DAF */  jal        ohSleep
    /* 1DEA48 801EDCD8 24040001 */   addiu     $a0, $zero, 0x1
    /* 1DEA4C 801EDCDC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1DEA50 801EDCE0 1000FFE5 */  b          .L801EDC78_ovl10
    /* 1DEA54 801EDCE4 8C42A7C4 */   lw        $v0, %lo(omCurrentObj)($v0)
    /* 1DEA58 801EDCE8 8FBF003C */  lw         $ra, 0x3C($sp)
  .L801EDCEC_ovl10:
    /* 1DEA5C 801EDCEC 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1DEA80 801EDD10 AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
    /* 1DEA84 801EDD14 03E00008 */  jr         $ra
    /* 1DEA88 801EDD18 27BD0040 */   addiu     $sp, $sp, 0x40
endlabel func_801EDAA0_ovl10
