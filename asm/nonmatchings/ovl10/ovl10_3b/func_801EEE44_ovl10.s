nonmatching func_801EEE44_ovl10, 0x90

glabel func_801EEE44_ovl10
    /* 1DFBB4 801EEE44 27BDFFC8 */  addiu      $sp, $sp, -0x38
    /* 1DFBB8 801EEE48 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1DFBBC 801EEE4C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1DFBD0 801EEE60 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 1DFBD4 801EEE64 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    /* 1DFBD8 801EEE68 3C04801F */  lui        $a0, %hi(D_801F3EE0_ovl10)
    /* 1DFBDC 801EEE6C 24843EE0 */  addiu      $a0, $a0, %lo(D_801F3EE0_ovl10)
