.section .late_rodata
nonmatching D_801F4A28_ovl10

dlabel D_801F4A28_ovl10
    /* 1E5798 801F4A28 461C3C00 */ .float 9999
enddlabel D_801F4A28_ovl10
.size D_801F4A28_ovl10, . - D_801F4A28_ovl10

nonmatching D_801F4A2C_ovl10

dlabel D_801F4A2C_ovl10
    /* 1E579C 801F4A2C 3EA0D97C */ .float 0.3141592741
enddlabel D_801F4A2C_ovl10
.size D_801F4A2C_ovl10, . - D_801F4A2C_ovl10

nonmatching D_801F4A30_ovl10

dlabel D_801F4A30_ovl10
    /* 1E57A0 801F4A30 BEA0D97C */ .float -0.3141592741
    /* 1E57A4 801F4A34 00000000 */ .float 0
    /* 1E57A8 801F4A38 00000000 */ .float 0
    /* 1E57AC 801F4A3C 00000000 */ .float 0
enddlabel D_801F4A30_ovl10
.size D_801F4A30_ovl10, . - D_801F4A30_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801E18A8_ovl10, 0x494

glabel func_801E18A8_ovl10
    /* 1D2618 801E18A8 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 1D261C 801E18AC AFBF0044 */  sw         $ra, 0x44($sp)
    /* 1D2620 801E18B0 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    ...
    /* 1D2648 801E18D8 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1D264C 801E18DC 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1D2650 801E18E0 0C02BB48 */  jal        func_800AED20
    /* 1D2654 801E18E4 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1D2658 801E18E8 3C128005 */  lui        $s2, %hi(omCurrentObj)
    /* 1D265C 801E18EC 2652A7C4 */  addiu      $s2, $s2, %lo(omCurrentObj)
  ...
  .L801E19C4_ovl10:
    /* 1D2734 801E19C4 0C002DAF */  jal        ohSleep
  ...
  .L801E19FC_ovl10:
    ...
    /* 1D27A4 801E1A34 3C01801F */  lui        $at, %hi(D_801F4A28_ovl10)
  ...
  .L801E1AAC_ovl10:
    ...
    /* 1D2874 801E1B04 3C01801F */  lui        $at, %hi(D_801F4A2C_ovl10)
    ...
    /* 1D2888 801E1B18 3C01801F */  lui        $at, %hi(D_801F4A30_ovl10)
  ...
  .L801E1B58_ovl10:
    ...
    /* 1D28D4 801E1B64 0C002DAF */  jal        ohSleep
  ...
  .L801E1BE4_ovl10:
    ...
    /* 1D2994 801E1C24 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1D2998 801E1C28 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1D299C 801E1C2C 0C02BB48 */  jal        func_800AED20
    /* 1D29A0 801E1C30 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
  ...
  .L801E1C38_ovl10:
    ...
    /* 1D29BC 801E1C4C 0C002DAF */  jal        ohSleep
  ...
  .L801E1C98_ovl10:
    ...
    /* 1D2A70 801E1D00 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1D2AA0 801E1D30 AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
    /* 1D2AA4 801E1D34 03E00008 */  jr         $ra
    /* 1D2AA8 801E1D38 27BD0048 */   addiu     $sp, $sp, 0x48
endlabel func_801E18A8_ovl10
