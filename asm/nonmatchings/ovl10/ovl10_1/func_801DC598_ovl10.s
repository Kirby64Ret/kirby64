nonmatching func_801DC598_ovl10, 0x488

glabel func_801DC598_ovl10
    /* 1CD308 801DC598 27BDFFC0 */  addiu      $sp, $sp, -0x40
    /* 1CD30C 801DC59C AFB10018 */  sw         $s1, 0x18($sp)
    /* 1CD310 801DC5A0 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 1CD314 801DC5A4 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
  ...
  .L801DC668_ovl10:
    /* 1CD3D8 801DC668 3C0F800E */  lui        $t7, %hi(gEntityFuncListIDArray)
    /* 1CD3DC 801DC66C 25EFDC50 */  addiu      $t7, $t7, %lo(gEntityFuncListIDArray)
  ...
  .L801DC6AC_ovl10:
    ...
    /* 1CD5A4 801DC834 3C0D801F */  lui        $t5, %hi(D_801F39F4_ovl10)
    ...
    /* 1CD5B4 801DC844 25AD39F4 */  addiu      $t5, $t5, %lo(D_801F39F4_ovl10)
  ...
  .L801DC870_ovl10:
    ...
    /* 1CD638 801DC8C8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CD63C 801DC8CC 0C02BB30 */  jal        func_800AECC0
    /* 1CD640 801DC8D0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1CD644 801DC8D4 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CD648 801DC8D8 0C02BB48 */  jal        func_800AED20
    /* 1CD64C 801DC8DC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
