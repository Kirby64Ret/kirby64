nonmatching func_801E1550_ovl10, 0x330

glabel func_801E1550_ovl10
    /* 1D22C0 801E1550 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D22C4 801E1554 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E16B8_ovl10:
    /* 1D2428 801E16B8 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 1D242C 801E16BC 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801E16F4_ovl10:
    ...
    /* 1D246C 801E16FC 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 1D2470 801E1700 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* 1D249C 801E172C 3C078005 */  lui        $a3, %hi(omCurrentObj)
    /* 1D24A0 801E1730 24E7A7C4 */  addiu      $a3, $a3, %lo(omCurrentObj)
    ...
    /* 1D24F0 801E1780 3C0A801F */  lui        $t2, %hi(D_801F3E98_ovl10)
    /* 1D24F4 801E1784 254A3E98 */  addiu      $t2, $t2, %lo(D_801F3E98_ovl10)
    ...
    /* 1D2538 801E17C8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D253C 801E17CC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    /* 1D2540 801E17D0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1D255C 801E17EC AC39DC50 */  sw         $t9, %lo(gEntityFuncListIDArray)($at)
    ...
    /* 1D2578 801E1808 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D257C 801E180C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E183C_ovl10:
    ...
    /* 1D25B4 801E1844 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1D25B8 801E1848 00260821 */  addu       $at, $at, $a2
    /* 1D25BC 801E184C AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
