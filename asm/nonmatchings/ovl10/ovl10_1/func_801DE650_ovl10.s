.section .late_rodata
nonmatching D_801F49D4_ovl10

dlabel D_801F49D4_ovl10
    /* 1E5744 801F49D4 477FFF00 */ .float 65535
enddlabel D_801F49D4_ovl10
.size D_801F49D4_ovl10, . - D_801F49D4_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DE650_ovl10, 0x448

glabel func_801DE650_ovl10
    /* 1CF3C0 801DE650 27BDFFD0 */  addiu      $sp, $sp, -0x30
    /* 1CF3C4 801DE654 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CF3C8 801DE658 C4206B10 */  lwc1       $f0, %lo(gameTicksPerDraw)($at)
    ...
    /* 1CF3EC 801DE67C 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CF3F0 801DE680 C4206B10 */  lwc1       $f0, %lo(gameTicksPerDraw)($at)
    /* 1CF3F4 801DE684 0C02BB48 */  jal        func_800AED20
    /* 1CF3F8 801DE688 46000300 */   add.s     $f12, $f0, $f0
    /* 1CF3FC 801DE68C 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 1CF400 801DE690 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
    ...
    /* 1CF42C 801DE6BC 3C19801F */  lui        $t9, %hi(D_801F3A18_ovl10)
    /* 1CF430 801DE6C0 27393A18 */  addiu      $t9, $t9, %lo(D_801F3A18_ovl10)
  ...
  .L801DE854_ovl10:
    /* 1CF5C4 801DE854 0C002DAF */  jal        ohSleep
  ...
  .L801DE880_ovl10:
    ...
    /* 1CF610 801DE8A0 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CF614 801DE8A4 0C02BB30 */  jal        func_800AECC0
    /* 1CF618 801DE8A8 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1CF61C 801DE8AC 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1CF620 801DE8B0 0C02BB48 */  jal        func_800AED20
    /* 1CF624 801DE8B4 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    ...
    /* 1CF654 801DE8E4 55E0000B */  bnel       $t7, $zero, .L801DE914_ovl10
    /* 1CF658 801DE8E8 4405A000 */   mfc1      $a1, $f20
  .L801DE8EC_ovl10:
    /* 1CF65C 801DE8EC 0C002DAF */  jal        ohSleep
  ...
  .L801DE914_ovl10:
    ...
    /* 1CF734 801DE9C4 3C01801F */  lui        $at, %hi(D_801F49D4_ovl10)
  ...
  .L801DEA40_ovl10:
    /* 1CF7B0 801DEA40 0C06B328 */  jal        func_801ACCA0_ovl7
    ...
    /* 1CF7D8 801DEA68 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1CF7FC 801DEA8C AC2BDC50 */  sw         $t3, %lo(gEntityFuncListIDArray)($at)
    /* 1CF800 801DEA90 03E00008 */  jr         $ra
    /* 1CF804 801DEA94 27BD0030 */   addiu     $sp, $sp, 0x30
endlabel func_801DE650_ovl10
