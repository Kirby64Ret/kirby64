nonmatching func_801DDAC8_ovl10, 0xC0
...
glabel func_801DDAC8_ovl10
    ...
    /* 1CE858 801DDAE8 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 1CE85C 801DDAEC 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
    /* 1CE860 801DDAF0 8E230000 */  lw         $v1, 0x0($s1)
    /* 1CE864 801DDAF4 3C10800F */  lui        $s0, %hi(D_800E9AA0)
    /* 1CE868 801DDAF8 3C12801F */  lui        $s2, %hi(D_801F42F0_ovl10)
    /* 1CE86C 801DDAFC 8C6E0000 */  lw         $t6, 0x0($v1)
    /* 1CE870 801DDB00 265242F0 */  addiu      $s2, $s2, %lo(D_801F42F0_ovl10)
  ...
  .L801DDB5C_ovl10:
    ...
    /* 1CE8D4 801DDB64 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1CE8EC 801DDB7C AC25DC50 */  sw         $a1, %lo(gEntityFuncListIDArray)($at)
    /* 1CE8F0 801DDB80 03E00008 */  jr         $ra
    /* 1CE8F4 801DDB84 27BD0028 */   addiu     $sp, $sp, 0x28
endlabel func_801DDAC8_ovl10
