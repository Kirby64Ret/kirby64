nonmatching func_801DDEB8_ovl10, 0x26C
...
glabel func_801DDEB8_ovl10
    ...
    /* 1CEC3C 801DDECC 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 1CEC40 801DDED0 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801DDFA8_ovl10:
    ...
    /* 1CED28 801DDFB8 3C18801F */  lui        $t8, %hi(D_801F3A18_ovl10)
    /* 1CED2C 801DDFBC 8F280000 */  lw         $t0, 0x0($t9)
    /* 1CED30 801DDFC0 27183A18 */  addiu      $t8, $t8, %lo(D_801F3A18_ovl10)
    ...
    /* 1CED98 801DE028 3C0B801F */  lui        $t3, %hi(D_801F3E2C_ovl10)
    /* 1CED9C 801DE02C 256B3E2C */  addiu      $t3, $t3, %lo(D_801F3E2C_ovl10)
    ...
    /* 1CEDE4 801DE074 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1CEE00 801DE090 AC28DC50 */  sw         $t0, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801DE0DC_ovl10:
    ...
    /* 1CEE54 801DE0E4 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1CEE58 801DE0E8 00260821 */  addu       $at, $at, $a2
    /* 1CEE5C 801DE0EC AC39DC50 */  sw         $t9, %lo(gEntityFuncListIDArray)($at)
