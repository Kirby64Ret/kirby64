nonmatching func_801E28C8_ovl10, 0x310

glabel func_801E28C8_ovl10
    /* 1D3638 801E28C8 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1D363C 801E28CC 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801E2908_ovl10:
    ...
    /* 1D3680 801E2910 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 1D3684 801E2914 8FA60030 */  lw         $a2, 0x30($sp)
    /* 1D3688 801E2918 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L801E2954_ovl10:
    ...
    /* 1D36D8 801E2968 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1D36DC 801E296C 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L801E2994_ovl10:
    ...
    /* 1D3718 801E29A8 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1D371C 801E29AC 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801E29D4_ovl10:
    ...
    /* 1D3760 801E29F0 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1D3764 801E29F4 14410009 */  bne        $v0, $at, .L801E2A1C_ovl10
    /* 1D3768 801E29F8 3C0B8005 */   lui       $t3, %hi(omCurrentObj)
    /* 1D376C 801E29FC 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L801E2A1C_ovl10:
    /* 1D378C 801E2A1C 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L801E2A40_ovl10:
    /* 1D37B0 801E2A40 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 1D37B4 801E2A44 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801E2A60_ovl10:
    /* 1D37D0 801E2A60 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D37D4 801E2A64 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1D3838 801E2AC8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D383C 801E2ACC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E2AE8_ovl10:
    ...
    /* 1D3868 801E2AF8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D386C 801E2AFC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1D3894 801E2B24 3C0F800E */  lui        $t7, %hi(gEntityFuncListIDArray)
    /* 1D3898 801E2B28 44804000 */  mtc1       $zero, $f8
    /* 1D389C 801E2B2C 00042080 */  sll        $a0, $a0, 2
    /* 1D38A0 801E2B30 01E47821 */  addu       $t7, $t7, $a0
    /* 1D38A4 801E2B34 8DEFDC50 */  lw         $t7, %lo(gEntityFuncListIDArray)($t7)
  ...
  .L801E2B7C_ovl10:
    ...
    /* 1D391C 801E2BAC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1D3920 801E2BB0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  .L801E2BB4_ovl10:
