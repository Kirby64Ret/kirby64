.section .late_rodata
nonmatching D_801F49C4_ovl10

dlabel D_801F49C4_ovl10
    /* 1E5734 801F49C4 477FFF00 */ .float 65535
enddlabel D_801F49C4_ovl10
.size D_801F49C4_ovl10, . - D_801F49C4_ovl10


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DDB88_ovl10, 0x330

glabel func_801DDB88_ovl10
    /* 1CE8F8 801DDB88 27BDFFD8 */  addiu      $sp, $sp, -0x28
    /* 1CE8FC 801DDB8C AFB00014 */  sw         $s0, 0x14($sp)
    /* 1CE900 801DDB90 3C10800D */  lui        $s0, %hi(gameTicksPerDraw)
    /* 1CE904 801DDB94 26106B10 */  addiu      $s0, $s0, %lo(gameTicksPerDraw)
    ...
    /* 1CE92C 801DDBBC 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 1CE930 801DDBC0 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
    ...
    /* 1CE95C 801DDBEC 3C19801F */  lui        $t9, %hi(D_801F3A18_ovl10)
    /* 1CE960 801DDBF0 27393A18 */  addiu      $t9, $t9, %lo(D_801F3A18_ovl10)
  ...
  .L801DDDC0_ovl10:
    ...
    /* 1CEB78 801DDE08 3C01801F */  lui        $at, %hi(D_801F49C4_ovl10)
  ...
  .L801DDE60_ovl10:
    ...
    /* 1CEBF8 801DDE88 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1CEC1C 801DDEAC AC2CDC50 */  sw         $t4, %lo(gEntityFuncListIDArray)($at)
    /* 1CEC20 801DDEB0 03E00008 */  jr         $ra
    /* 1CEC24 801DDEB4 27BD0028 */   addiu     $sp, $sp, 0x28
endlabel func_801DDB88_ovl10
