nonmatching func_801E206C_ovl10, 0x6B8

glabel func_801E206C_ovl10
    /* 1D2DDC 801E206C 27BDFFA8 */  addiu      $sp, $sp, -0x58
    /* 1D2DE0 801E2070 AFB60048 */  sw         $s6, 0x48($sp)
    /* 1D2DE4 801E2074 3C168005 */  lui        $s6, %hi(omCurrentObj)
    /* 1D2DE8 801E2078 26D6A7C4 */  addiu      $s6, $s6, %lo(omCurrentObj)
    ...
    /* 1D2E2C 801E20BC 3C12800D */  lui        $s2, %hi(gameTicksPerDraw)
    /* 1D2E30 801E20C0 000FC080 */  sll        $t8, $t7, 2
    /* 1D2E34 801E20C4 26526B10 */  addiu      $s2, $s2, %lo(gameTicksPerDraw)
    ...
    /* 1D2E60 801E20F0 3C0B801F */  lui        $t3, %hi(D_801F3ACC_ovl10)
    /* 1D2E64 801E20F4 256B3ACC */  addiu      $t3, $t3, %lo(D_801F3ACC_ovl10)
  ...
  .L801E21D4_ovl10:
    ...
    /* 1D2FB0 801E2240 3C12801F */  lui        $s2, %hi(D_801F4364_ovl10)
    /* 1D2FB4 801E2244 26524364 */  addiu      $s2, $s2, %lo(D_801F4364_ovl10)
  ...
  .L801E2294_ovl10:
    /* 1D3004 801E2294 3C03801F */  lui        $v1, %hi(D_801F4338_ovl10)
    /* 1D3008 801E2298 24634338 */  addiu      $v1, $v1, %lo(D_801F4338_ovl10)
  ...
  .L801E2550_ovl10:
    /* 1D32C0 801E2550 0C002DAF */  jal        ohSleep
  ...
  .L801E2660_ovl10:
    /* 1D33D0 801E2660 0C002DAF */  jal        ohSleep
  ...
  .L801E2684_ovl10:
    ...
    /* 1D3454 801E26E4 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1D3488 801E2718 AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
    /* 1D348C 801E271C 03E00008 */  jr         $ra
    /* 1D3490 801E2720 27BD0058 */   addiu     $sp, $sp, 0x58
endlabel func_801E206C_ovl10
