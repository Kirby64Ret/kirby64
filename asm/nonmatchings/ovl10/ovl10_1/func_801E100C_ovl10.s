nonmatching func_801E100C_ovl10, 0x394

glabel func_801E100C_ovl10
    /* 1D1D7C 801E100C 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 1D1D80 801E1010 AFB00028 */  sw         $s0, 0x28($sp)
    /* 1D1D84 801E1014 3C10800D */  lui        $s0, %hi(gameTicksPerDraw)
    /* 1D1D88 801E1018 26106B10 */  addiu      $s0, $s0, %lo(gameTicksPerDraw)
    ...
    /* 1D1DC4 801E1054 3C168005 */  lui        $s6, %hi(omCurrentObj)
    /* 1D1DC8 801E1058 26D6A7C4 */  addiu      $s6, $s6, %lo(omCurrentObj)
    ...
    /* 1D1E08 801E1098 3C0C801F */  lui        $t4, %hi(D_801F40DC_ovl10)
    /* 1D1E0C 801E109C 258C40DC */  addiu      $t4, $t4, %lo(D_801F40DC_ovl10)
  ...
  .L801E1280_ovl10:
    /* 1D1FF0 801E1280 0C002DAF */  jal        ohSleep
  ...
  .L801E1334_ovl10:
    ...
    /* 1D20CC 801E135C 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1D2104 801E1394 AC38DC50 */  sw         $t8, %lo(gEntityFuncListIDArray)($at)
    /* 1D2108 801E1398 03E00008 */  jr         $ra
    /* 1D210C 801E139C 27BD0048 */   addiu     $sp, $sp, 0x48
endlabel func_801E100C_ovl10
