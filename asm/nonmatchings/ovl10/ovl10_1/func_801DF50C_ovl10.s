nonmatching func_801DF50C_ovl10, 0x6F0

glabel func_801DF50C_ovl10
    /* 1D027C 801DF50C 27BDFFA8 */  addiu      $sp, $sp, -0x58
    /* 1D0280 801DF510 AFB60040 */  sw         $s6, 0x40($sp)
    /* 1D0284 801DF514 3C168005 */  lui        $s6, %hi(omCurrentObj)
    /* 1D0288 801DF518 26D6A7C4 */  addiu      $s6, $s6, %lo(omCurrentObj)
    ...
    /* 1D02E0 801DF570 3C10800D */  lui        $s0, %hi(gameTicksPerDraw)
    /* 1D02E4 801DF574 26106B10 */  addiu      $s0, $s0, %lo(gameTicksPerDraw)
  ...
  .L801DF6A8_ovl10:
    ...
    /* 1D041C 801DF6AC 3C04801F */  lui        $a0, %hi(D_801F344C_ovl10)
    /* 1D0420 801DF6B0 8CB80000 */  lw         $t8, 0x0($a1)
    /* 1D0424 801DF6B4 2484344C */  addiu      $a0, $a0, %lo(D_801F344C_ovl10)
    ...
    /* 1D04A0 801DF730 3C12801F */  lui        $s2, %hi(D_801F4364_ovl10)
    ...
    /* 1D04E0 801DF770 26524364 */  addiu      $s2, $s2, %lo(D_801F4364_ovl10)
  ...
  .L801DF7A0_ovl10:
    /* 1D0510 801DF7A0 3C03801F */  lui        $v1, %hi(D_801F4338_ovl10)
    /* 1D0514 801DF7A4 24634338 */  addiu      $v1, $v1, %lo(D_801F4338_ovl10)
  ...
  .L801DFA5C_ovl10:
    /* 1D07CC 801DFA5C 0C002DAF */  jal        ohSleep
  ...
  .L801DFAEC_ovl10:
    ...
    /* 1D092C 801DFBBC 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1D0960 801DFBF0 AC2DDC50 */  sw         $t5, %lo(gEntityFuncListIDArray)($at)
    /* 1D0964 801DFBF4 03E00008 */  jr         $ra
    /* 1D0968 801DFBF8 27BD0058 */   addiu     $sp, $sp, 0x58
endlabel func_801DF50C_ovl10
