.section .late_rodata
nonmatching D_801E30C4_ovl14

dlabel D_801E30C4_ovl14
    /* 205CB4 801E30C4 3FC90FDB */ .float 1.570796371
enddlabel D_801E30C4_ovl14
.size D_801E30C4_ovl14, . - D_801E30C4_ovl14

nonmatching D_801E30C8_ovl14

dlabel D_801E30C8_ovl14
    /* 205CB8 801E30C8 3FC90FDB */ .float 1.570796371
enddlabel D_801E30C8_ovl14
.size D_801E30C8_ovl14, . - D_801E30C8_ovl14

nonmatching D_801E30CC_ovl14

dlabel D_801E30CC_ovl14
    /* 205CBC 801E30CC 477FFF00 */ .float 65535
enddlabel D_801E30CC_ovl14
.size D_801E30CC_ovl14, . - D_801E30CC_ovl14

nonmatching D_801E30D0_ovl14

dlabel D_801E30D0_ovl14
    /* 205CC0 801E30D0 410AAAAB */ .float 8.666666985
enddlabel D_801E30D0_ovl14
.size D_801E30D0_ovl14, . - D_801E30D0_ovl14


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801E03E8_ovl14, 0x228

glabel func_801E03E8_ovl14
    /* 202FD8 801E03E8 27BDFFE0 */  addiu      $sp, $sp, -0x20
    /* 202FDC 801E03EC AFB00018 */  sw         $s0, 0x18($sp)
    /* 202FE0 801E03F0 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 202FE4 801E03F4 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801E0488_ovl14:
    ...
    /* 2030A0 801E04B0 0C002DAF */  jal        ohSleep
  ...
  .L801E04BC_ovl14:
    ...
    /* 2031B4 801E05C4 0C002DAF */  jal        ohSleep
    /* 2031B8 801E05C8 AC2D9C60 */   sw        $t5, %lo(D_800E9C60)($at)
    /* 2031BC 801E05CC 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 2031C0 801E05D0 0C02BB30 */  jal        func_800AECC0
    /* 2031C4 801E05D4 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 2031C8 801E05D8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 2031CC 801E05DC 0C02BB48 */  jal        func_800AED20
    /* 2031D0 801E05E0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 2031D4 801E05E4 8E080000 */  lw         $t0, 0x0($s0)
    /* 2031D8 801E05E8 8FBF001C */  lw         $ra, 0x1C($sp)
    /* 2031DC 801E05EC 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 2031F4 801E0604 AC39DC50 */  sw         $t9, %lo(gEntityFuncListIDArray)($at)
    /* 2031F8 801E0608 03E00008 */  jr         $ra
    /* 2031FC 801E060C 27BD0020 */   addiu     $sp, $sp, 0x20
endlabel func_801E03E8_ovl14
