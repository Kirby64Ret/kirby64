nonmatching func_801DBA00_ovl14, 0x22C

glabel func_801DBA00_ovl14
    /* 1FE5F0 801DBA00 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1FE5F4 801DBA04 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1FE68C 801DBA9C 0C002DAF */  jal        ohSleep
  ...
  .L801DBAD8_ovl14:
    ...
    /* 1FE6E4 801DBAF4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1FE6E8 801DBAF8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 1FE760 801DBB70 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 1FE764 801DBB74 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DBBE4_ovl14:
    /* 1FE7D4 801DBBE4 0C002DAF */  jal        ohSleep
    ...
    /* 1FE7E8 801DBBF8 0C002DAF */  jal        ohSleep
    /* 1FE7EC 801DBBFC 24040032 */   addiu     $a0, $zero, 0x32
    /* 1FE7F0 801DBC00 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 1FE7F4 801DBC04 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    /* 1FE7F8 801DBC08 8FBF001C */  lw         $ra, 0x1C($sp)
    /* 1FE7FC 801DBC0C 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1FE818 801DBC28 AC39DC50 */   sw        $t9, %lo(gEntityFuncListIDArray)($at)
endlabel func_801DBA00_ovl14
