nonmatching func_801DD590_ovl14, 0x640

glabel func_801DD590_ovl14
    /* 200180 801DD590 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 200184 801DD594 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L801DD6E4_ovl14:
    ...
    /* 2002F4 801DD704 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 2002F8 801DD708 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 200330 801DD740 0C002DAF */  jal        ohSleep
    ...
    /* 200340 801DD750 0C002DAF */  jal        ohSleep
    ...
    /* 200358 801DD768 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 20035C 801DD76C 2508A7C4 */  addiu      $t0, $t0, %lo(omCurrentObj)
  ...
  .L801DDAD0_ovl14:
    ...
    /* 2006E0 801DDAF0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 2006E4 801DDAF4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 20075C 801DDB6C 0C002DAF */  jal        ohSleep
    /* 200760 801DDB70 24040005 */   addiu     $a0, $zero, 0x5
    /* 200764 801DDB74 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 200768 801DDB78 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* 200794 801DDBA4 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 200798 801DDBA8 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
    /* 20079C 801DDBAC 8FBF0014 */  lw         $ra, 0x14($sp)
    /* 2007A0 801DDBB0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 2007BC 801DDBCC AC2BDC50 */   sw        $t3, %lo(gEntityFuncListIDArray)($at)
endlabel func_801DD590_ovl14
