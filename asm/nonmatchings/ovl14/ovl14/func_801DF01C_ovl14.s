.section .rodata
.align 2
nonmatching D_801E3030_ovl14

dlabel D_801E3030_ovl14
    /* 205C20 801E3030 */ .asciz "eneshot req over 18. Track Num:%d\n"
    /* 656E6573686F7420726571206F7665722031382E20547261636B204E756D3A25640A0000 */
.align 2
enddlabel D_801E3030_ovl14
.size D_801E3030_ovl14, . - D_801E3030_ovl14


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DF01C_ovl14, 0x274
...
glabel func_801DF01C_ovl14
  ...
  .L801DF054_ovl14:
    ...
    /* 201C4C 801DF05C 0C02909C */  jal        utilPrintf
  ...
  .L801DF074_ovl14:
    ...
    /* 201C98 801DF0A8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 201C9C 801DF0AC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DF204_ovl14:
    /* 201DF4 801DF204 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 201DF8 801DF208 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
