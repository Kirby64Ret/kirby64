nonmatching func_801DCBCC_ovl14, 0x250

glabel func_801DCBCC_ovl14
    /* 1FF7BC 801DCBCC 27BDFFC8 */  addiu      $sp, $sp, -0x38
    /* 1FF7C0 801DCBD0 AFB10018 */  sw         $s1, 0x18($sp)
    /* 1FF7C4 801DCBD4 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 1FF7C8 801DCBD8 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
  ...
  .L801DCD30_ovl14:
    ...
    /* 1FF9D4 801DCDE4 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FF9D8 801DCDE8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  .L801DCDEC_ovl14:
    /* 1FF9DC 801DCDEC 8C4B0000 */  lw         $t3, 0x0($v0)
    /* 1FF9E0 801DCDF0 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1FF9F4 801DCE04 AC20DC50 */   sw        $zero, %lo(gEntityFuncListIDArray)($at)
