nonmatching func_801DB460_ovl14, 0x224

glabel func_801DB460_ovl14
    /* 1FE050 801DB460 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FE054 801DB464 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1FE0AC 801DB4BC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FE0B0 801DB4C0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DB564_ovl14:
    ...
    /* 1FE15C 801DB56C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FE160 801DB570 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DB5D4_ovl14:
    ...
    /* 1FE1CC 801DB5DC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FE1D0 801DB5E0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DB5F0_ovl14:
    ...
    /* 1FE1E8 801DB5F8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FE1EC 801DB5FC 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DB608_ovl14:
    ...
    /* 1FE228 801DB638 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 1FE22C 801DB63C 00230821 */  addu       $at, $at, $v1
    /* 1FE230 801DB640 AC2BDC50 */  sw         $t3, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801DB66C_ovl14:
    /* 1FE25C 801DB66C 0C02911F */  jal        utilFuncTableJump
