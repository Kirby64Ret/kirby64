.section .rodata
.align 2
nonmatching D_801E2FA0_ovl14

dlabel D_801E2FA0_ovl14
    /* 205B90 801E2FA0 */ .asciz "enemy req over 18. Track Num:%d\n"
    /* 656E656D7920726571206F7665722031382E20547261636B204E756D3A25640A00000000 */
.align 2
enddlabel D_801E2FA0_ovl14
.size D_801E2FA0_ovl14, . - D_801E2FA0_ovl14

.section .late_rodata
nonmatching jtbl_801E3078_ovl14

dlabel jtbl_801E3078_ovl14
    /* 205C68 801E3078 801DC440 */ .word .L801DC440_ovl14
    /* 205C6C 801E307C 801DC46C */ .word .L801DC46C_ovl14
    /* 205C70 801E3080 801DC498 */ .word .L801DC498_ovl14
    /* 205C74 801E3084 801DC4C0 */ .word .L801DC4C0_ovl14
    /* 205C78 801E3088 801DC4EC */ .word .L801DC4EC_ovl14
enddlabel jtbl_801E3078_ovl14
.size jtbl_801E3078_ovl14, . - jtbl_801E3078_ovl14


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DC38C_ovl14, 0x2E8
...
glabel func_801DC38C_ovl14
  ...
  .L801DC3C0_ovl14:
    ...
    /* 1FEFB8 801DC3C8 0C02909C */  jal        utilPrintf
  ...
  .L801DC3E0_ovl14:
    ...
    /* 1FF01C 801DC42C 3C01801E */  lui        $at, %hi(jtbl_801E3078_ovl14)
    /* 1FF020 801DC430 00290821 */  addu       $at, $at, $t1
    /* 1FF024 801DC434 8C293078 */  lw         $t1, %lo(jtbl_801E3078_ovl14)($at)
  ...
  .L801DC520_ovl14:
    ...
    /* 1FF13C 801DC54C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FF140 801DC550 E4202E90 */  swc1       $f0, %lo(gEntitiesPosZArray)($at)
    /* 1FF144 801DC554 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DC610_ovl14:
    /* 1FF200 801DC610 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1FF204 801DC614 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
