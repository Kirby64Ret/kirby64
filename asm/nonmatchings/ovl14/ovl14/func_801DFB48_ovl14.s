nonmatching func_801DFB48_ovl14, 0xE0

glabel func_801DFB48_ovl14
    /* 202738 801DFB48 27BDFFD8 */  addiu      $sp, $sp, -0x28
    /* 20273C 801DFB4C AFB00018 */  sw         $s0, 0x18($sp)
    /* 202740 801DFB50 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 202744 801DFB54 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801DFBCC_ovl14:
    ...
    /* 2027E0 801DFBF0 0C002DAF */  jal        ohSleep
    /* 2027E4 801DFBF4 02002025 */   or        $a0, $s0, $zero
    /* 2027E8 801DFBF8 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 2027EC 801DFBFC 1000FFF3 */  b          .L801DFBCC_ovl14
    /* 2027F0 801DFC00 8C42A7C4 */   lw        $v0, %lo(omCurrentObj)($v0)
  .L801DFC04_ovl14:
    /* 2027F4 801DFC04 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 2027F8 801DFC08 8FBF0024 */  lw         $ra, 0x24($sp)
    /* 2027FC 801DFC0C 00230821 */  addu       $at, $at, $v1
    /* 202800 801DFC10 AC30DC50 */  sw         $s0, %lo(gEntityFuncListIDArray)($at)
