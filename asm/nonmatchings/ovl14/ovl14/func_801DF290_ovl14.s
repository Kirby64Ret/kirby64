.section .rodata
.align 2
nonmatching D_801E3054_ovl14

dlabel D_801E3054_ovl14
    /* 205C44 801E3054 */ .asciz "eneshot req over 18. Track Num:%d\n"
    /* 656E6573686F7420726571206F7665722031382E20547261636B204E756D3A25640A0000 */
.align 2
enddlabel D_801E3054_ovl14
.size D_801E3054_ovl14, . - D_801E3054_ovl14


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DF290_ovl14, 0x284
...
glabel func_801DF290_ovl14
  ...
  .L801DF2C4_ovl14:
    ...
    /* 201EBC 801DF2CC 0C02909C */  jal        utilPrintf
  ...
  .L801DF2E4_ovl14:
    ...
    /* 201F08 801DF318 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 201F0C 801DF31C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 202004 801DF414 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 202008 801DF418 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
  ...
  .L801DF498_ovl14:
    /* 202088 801DF498 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 20208C 801DF49C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
