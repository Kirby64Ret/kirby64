.section .rodata
.align 2
nonmatching D_801E300C_ovl14

dlabel D_801E300C_ovl14
    /* 205BFC 801E300C */ .asciz "enemy req over 18. Track Num:%d\n"
    /* 656E656D7920726571206F7665722031382E20547261636B204E756D3A25640A00000000 */
.align 2
enddlabel D_801E300C_ovl14
.size D_801E300C_ovl14, . - D_801E300C_ovl14


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DEDE8_ovl14, 0x234

glabel func_801DEDE8_ovl14
  ...
  .L801DEE1C_ovl14:
    ...
    /* 201A14 801DEE24 0C02909C */  jal        utilPrintf
  ...
  .L801DEE3C_ovl14:
    ...
    /* 201A5C 801DEE6C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 201A60 801DEE70 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DEFBC_ovl14:
    /* 201BAC 801DEFBC 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 201BB0 801DEFC0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
