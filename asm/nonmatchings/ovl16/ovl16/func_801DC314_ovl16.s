nonmatching func_801DC314_ovl16, 0x3D0

glabel func_801DC314_ovl16
    /* 2125C4 801DC314 27BDFFA8 */  addiu      $sp, $sp, -0x58
    /* 2125C8 801DC318 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 2125CC 801DC31C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 2125FC 801DC34C 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 212600 801DC350 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
  ...
  .L801DC424_ovl16:
    /* 2126D4 801DC424 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 2126D8 801DC428 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801DC454_ovl16:
    /* 212704 801DC454 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 212708 801DC458 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L801DC474_ovl16:
    ...
    /* 21273C 801DC48C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 212740 801DC490 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DC574_ovl16:
    /* 212824 801DC574 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 212828 801DC578 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L801DC594_ovl16:
    ...
    /* 212864 801DC5B4 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 212868 801DC5B8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801DC644_ovl16:
    /* 2128F4 801DC644 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 2128F8 801DC648 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801DC680_ovl16:
    /* 212930 801DC680 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 212934 801DC684 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
    ...
    /* 212948 801DC698 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    ...
    /* 21296C 801DC6BC 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
