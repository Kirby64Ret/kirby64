nonmatching func_801DBBCC_ovl16, 0x748

glabel func_801DBBCC_ovl16
    /* 211E7C 801DBBCC 27BDFFA0 */  addiu      $sp, $sp, -0x60
    /* 211E80 801DBBD0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 211E84 801DBBD4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 211EB4 801DBC04 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 211EB8 801DBC08 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L801DBC68_ovl16:
    ...
    /* 211F38 801DBC88 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 211F3C 801DBC8C 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L801DBE20_ovl16:
    /* 2120D0 801DBE20 3C048005 */   lui       $a0, %hi(omCurrentObj)
    /* 2120D4 801DBE24 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L801DBF44_ovl16:
    /* 2121F4 801DBF44 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 2121F8 801DBF48 100000EA */  b          .L801DC2F4_ovl16
    /* 2121FC 801DBF4C 8C84A7C4 */   lw        $a0, %lo(omCurrentObj)($a0)
  .L801DBF50_ovl16:
  ...
  .L801DBFB4_ovl16:
    /* 212264 801DBFB4 3C048005 */   lui       $a0, %hi(omCurrentObj)
    /* 212268 801DBFB8 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L801DC0D8_ovl16:
    /* 212388 801DC0D8 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 21238C 801DC0DC 10000085 */  b          .L801DC2F4_ovl16
    /* 212390 801DC0E0 8C84A7C4 */   lw        $a0, %lo(omCurrentObj)($a0)
  .L801DC0E4_ovl16:
    ...
    /* 2123B0 801DC100 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 2123B4 801DC104 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L801DC174_ovl16:
    /* 212424 801DC174 3C048005 */   lui       $a0, %hi(omCurrentObj)
    /* 212428 801DC178 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  ...
  .L801DC298_ovl16:
    /* 212548 801DC298 3C048005 */  lui        $a0, %hi(omCurrentObj)
    /* 21254C 801DC29C 10000015 */  b          .L801DC2F4_ovl16
    /* 212550 801DC2A0 8C84A7C4 */   lw        $a0, %lo(omCurrentObj)($a0)
  .L801DC2A4_ovl16:
    /* 212554 801DC2A4 10000013 */  b          .L801DC2F4_ovl16
    /* 212558 801DC2A8 AD000028 */   sw        $zero, 0x28($t0)
  .L801DC2AC_ovl16:
    /* 21255C 801DC2AC 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 212560 801DC2B0 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 21258C 801DC2DC 3C048005 */  lui        $a0, %hi(omCurrentObj)
    ...
    /* 2125A0 801DC2F0 8C84A7C4 */  lw         $a0, %lo(omCurrentObj)($a0)
  .L801DC2F4_ovl16:
