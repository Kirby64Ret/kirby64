nonmatching func_801DCBF8_ovl16, 0x1D0

glabel func_801DCBF8_ovl16
    /* 212EA8 801DCBF8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 212EAC 801DCBFC 2463A7C4 */  addiu      $v1, $v1, %lo(omCurrentObj)
    ...
    /* 212F64 801DCCB4 3C01801F */  lui        $at, %hi(D_801F0140_ovl16)
    /* 212F68 801DCCB8 AC200140 */  sw         $zero, %lo(D_801F0140_ovl16)($at)
    ...
    /* 212F78 801DCCC8 3C01801F */  lui        $at, %hi(D_801F0144_ovl16)
    /* 212F7C 801DCCCC 240F0001 */  addiu      $t7, $zero, 0x1
    /* 212F80 801DCCD0 AC2F0144 */  sw         $t7, %lo(D_801F0144_ovl16)($at)
    /* 212F84 801DCCD4 3C01801F */  lui        $at, %hi(D_801F0124_ovl16)
    /* 212F88 801DCCD8 24180003 */  addiu      $t8, $zero, 0x3
    /* 212F8C 801DCCDC AC380124 */  sw         $t8, %lo(D_801F0124_ovl16)($at)
    ...
    /* 212F9C 801DCCEC 3C01801F */  lui        $at, %hi(D_801F0128_ovl16)
    /* 212FA0 801DCCF0 24090003 */  addiu      $t1, $zero, 0x3
    /* 212FA4 801DCCF4 24030003 */  addiu      $v1, $zero, 0x3
    /* 212FA8 801DCCF8 3C0A801F */  lui        $t2, %hi(D_801F0140_ovl16)
    /* 212FAC 801DCCFC AC290128 */  sw         $t1, %lo(D_801F0128_ovl16)($at)
    /* 212FB0 801DCD00 254A0140 */  addiu      $t2, $t2, %lo(D_801F0140_ovl16)
  ...
  .L801DCDA0_ovl16:
    /* 213050 801DCDA0 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 213054 801DCDA4 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    /* 213058 801DCDA8 8FBF0014 */  lw         $ra, 0x14($sp)
    /* 21305C 801DCDAC 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 213074 801DCDC4 AC20DC50 */   sw        $zero, %lo(gEntityFuncListIDArray)($at)
endlabel func_801DCBF8_ovl16
