.section .late_rodata
nonmatching D_801EFF08_ovl16

dlabel D_801EFF08_ovl16
    /* 2261B8 801EFF08 477FFF00 */ .float 65535
enddlabel D_801EFF08_ovl16
.size D_801EFF08_ovl16, . - D_801EFF08_ovl16


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801E18BC_ovl16, 0x360

glabel func_801E18BC_ovl16
    /* 217B6C 801E18BC 27BDFFE0 */  addiu      $sp, $sp, -0x20
    /* 217B70 801E18C0 AFB10018 */  sw         $s1, 0x18($sp)
    /* 217B74 801E18C4 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 217B78 801E18C8 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
  ...
  .L801E1B08_ovl16:
    /* 217DB8 801E1B08 0C002DAF */  jal        ohSleep
  ...
  .L801E1B5C_ovl16:
    ...
    /* 217E20 801E1B70 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 217E24 801E1B74 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E1B84_ovl16:
    ...
    /* 217E4C 801E1B9C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 217E50 801E1BA0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E1BB4_ovl16:
    ...
    /* 217E78 801E1BC8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 217E7C 801E1BCC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801E1BF0_ovl16:
    ...
    /* 217EA8 801E1BF8 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 217EC0 801E1C10 AC29DC50 */  sw         $t1, %lo(gEntityFuncListIDArray)($at)
    /* 217EC4 801E1C14 03E00008 */  jr         $ra
    /* 217EC8 801E1C18 27BD0020 */   addiu     $sp, $sp, 0x20
endlabel func_801E18BC_ovl16
