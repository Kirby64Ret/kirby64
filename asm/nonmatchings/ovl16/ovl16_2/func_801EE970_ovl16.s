.section .late_rodata
nonmatching D_801F0110_ovl16

dlabel D_801F0110_ovl16
    /* 2263C0 801F0110 40C90FDB */ .float 6.283185482
enddlabel D_801F0110_ovl16
.size D_801F0110_ovl16, . - D_801F0110_ovl16

nonmatching D_801F0114_ovl16

dlabel D_801F0114_ovl16
    /* 2263C4 801F0114 C0C90FDB */ .float -6.283185482
    /* 2263C8 801F0118 00000000 */ .float 0
    /* 2263CC 801F011C 00000000 */ .float 0
enddlabel D_801F0114_ovl16
.size D_801F0114_ovl16, . - D_801F0114_ovl16


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EE970_ovl16, 0x5C4

glabel func_801EE970_ovl16
    /* 224C20 801EE970 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 224C24 801EE974 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 224CB0 801EEA00 0C0291E5 */  jal        utilGetTransformSRT
    /* 224CB4 801EEA04 8F050000 */   lw        $a1, 0x0($t8)
    /* 224CB8 801EEA08 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224CBC 801EEA0C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EEA58_ovl16:
    ...
    /* 224D10 801EEA60 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 224D14 801EEA64 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 224D44 801EEA94 3C18801E */   lui       $t8, %hi(D_801DA514)
    /* 224D48 801EEA98 8F391B50 */  lw         $t9, %lo(D_800E1B50)($t9)
    /* 224D4C 801EEA9C 2718A514 */  addiu      $t8, $t8, %lo(D_801DA514)
  ...
  .L801EEAA8_ovl16:
    ...
    /* 224D5C 801EEAAC 3C09801E */  lui        $t1, %hi(D_801DA4F0)
    /* 224D60 801EEAB0 2529A4F0 */  addiu      $t1, $t1, %lo(D_801DA4F0)
    /* 224D64 801EEAB4 AD49008C */  sw         $t1, 0x8C($t2)
  .L801EEAB8_ovl16:
    /* 224D68 801EEAB8 0C0680ED */  jal        func_801A03B4_ovl7
    /* 224D6C 801EEABC 00000000 */   nop
    /* 224D70 801EEAC0 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 224D74 801EEAC4 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L801EEBC8_ovl16:
    /* 224E78 801EEBC8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224E7C 801EEBCC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 224EEC 801EEC3C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224EF0 801EEC40 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 224F70 801EECC0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224F74 801EECC4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EED70_ovl16:
    ...
    /* 225030 801EED80 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 225034 801EED84 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 225074 801EEDC4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 225078 801EEDC8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EEE10_ovl16:
    ...
    /* 225108 801EEE58 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 22510C 801EEE5C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801EEE68_ovl16:
    ...
    /* 225154 801EEEA4 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 225158 801EEEA8 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 2251A8 801EEEF8 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 2251AC 801EEEFC A30F0040 */  sb         $t7, 0x40($t8)
    /* 2251B0 801EEF00 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
