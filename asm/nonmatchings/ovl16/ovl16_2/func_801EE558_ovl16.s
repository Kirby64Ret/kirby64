.section .late_rodata
nonmatching D_801F0108_ovl16

dlabel D_801F0108_ovl16
    /* 2263B8 801F0108 40C90FDB */ .float 6.283185482
enddlabel D_801F0108_ovl16
.size D_801F0108_ovl16, . - D_801F0108_ovl16

nonmatching D_801F010C_ovl16

dlabel D_801F010C_ovl16
    /* 2263BC 801F010C C0C90FDB */ .float -6.283185482
enddlabel D_801F010C_ovl16
.size D_801F010C_ovl16, . - D_801F010C_ovl16


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EE558_ovl16, 0x418

glabel func_801EE558_ovl16
    /* 224808 801EE558 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 22480C 801EE55C 3C058005 */  lui        $a1, %hi(omCurrentObj)
    /* 224810 801EE560 8CA5A7C4 */  lw         $a1, %lo(omCurrentObj)($a1)
    ...
    /* 22492C 801EE67C 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 224930 801EE680 0C02BB30 */  jal        func_800AECC0
    /* 224934 801EE684 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 224938 801EE688 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 22493C 801EE68C 0C02BB48 */  jal        func_800AED20
    /* 224940 801EE690 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    ...
    /* 22498C 801EE6DC 3C058005 */  lui        $a1, %hi(omCurrentObj)
    /* 224990 801EE6E0 8CA5A7C4 */  lw         $a1, %lo(omCurrentObj)($a1)
  ...
  .L801EE784_ovl16:
    ...
    /* 224A68 801EE7B8 3C058005 */  lui        $a1, %hi(omCurrentObj)
    /* 224A6C 801EE7BC 8CA5A7C4 */  lw         $a1, %lo(omCurrentObj)($a1)
    ...
    /* 224AAC 801EE7FC 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 224AB0 801EE800 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 224ADC 801EE82C 3C09801F */  lui        $t1, %hi(D_801EFDD8_ovl16)
    /* 224AE0 801EE830 2529FDD8 */  addiu      $t1, $t1, %lo(D_801EFDD8_ovl16)
  ...
  .L801EE85C_ovl16:
    /* 224B0C 801EE85C 0C002DAF */  jal        ohSleep
  ...
  .L801EE874_ovl16:
    ...
    /* 224B30 801EE880 3C0E801F */  lui        $t6, %hi(D_801EFDD8_ovl16)
    /* 224B34 801EE884 25CEFDD8 */  addiu      $t6, $t6, %lo(D_801EFDD8_ovl16)
    /* 224B38 801EE888 118E000A */  beq        $t4, $t6, .L801EE8B4_ovl16
    /* 224B3C 801EE88C 3C10800E */   lui       $s0, %hi(gEntitiesNextPosXArray)
    /* 224B40 801EE890 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 224B44 801EE894 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    /* 224B48 801EE898 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 224B60 801EE8B0 AC2DDC50 */   sw        $t5, %lo(gEntityFuncListIDArray)($at)
  .L801EE8B4_ovl16:
    /* 224B64 801EE8B4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 224B68 801EE8B8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 224BB0 801EE900 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 224BB4 801EE904 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
