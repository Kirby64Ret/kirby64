.section .late_rodata
nonmatching D_801F0100_ovl16

dlabel D_801F0100_ovl16
    /* 2263B0 801F0100 40C90FDB */ .float 6.283185482
enddlabel D_801F0100_ovl16
.size D_801F0100_ovl16, . - D_801F0100_ovl16

nonmatching D_801F0104_ovl16

dlabel D_801F0104_ovl16
    /* 2263B4 801F0104 C0C90FDB */ .float -6.283185482
enddlabel D_801F0104_ovl16
.size D_801F0104_ovl16, . - D_801F0104_ovl16


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801EDE50_ovl16, 0x708

glabel func_801EDE50_ovl16
    /* 224100 801EDE50 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 224104 801EDE54 2529A7C4 */  addiu      $t1, $t1, %lo(omCurrentObj)
  ...
  .L801EDF08_ovl16:
    ...
    /* 22426C 801EDFBC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224270 801EDFC0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EE014_ovl16:
    ...
    /* 2242CC 801EE01C 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 2242D0 801EE020 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* 22431C 801EE06C 3C18801E */  lui        $t8, %hi(D_801DA4A8)
    /* 224320 801EE070 2718A4A8 */  addiu      $t8, $t8, %lo(D_801DA4A8)
  ...
  .L801EE0A4_ovl16:
    ...
    /* 224360 801EE0B0 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    ...
    /* 224370 801EE0C0 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801EE1D8_ovl16:
    /* 224488 801EE1D8 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 22448C 801EE1DC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 2244FC 801EE24C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224500 801EE250 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 224580 801EE2D0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224584 801EE2D4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EE380_ovl16:
    ...
    /* 224640 801EE390 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224644 801EE394 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 224684 801EE3D4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 224688 801EE3D8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801EE424_ovl16:
    ...
    /* 224728 801EE478 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 22472C 801EE47C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 224774 801EE4C4 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 224778 801EE4C8 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
    ...
    /* 2247C0 801EE510 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 2247C4 801EE514 2529A7C4 */  addiu      $t1, $t1, %lo(omCurrentObj)
  .L801EE518_ovl16:
