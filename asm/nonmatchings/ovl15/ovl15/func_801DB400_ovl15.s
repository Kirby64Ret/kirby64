.section .late_rodata
nonmatching jtbl_801E6790_ovl15

dlabel jtbl_801E6790_ovl15
    /* 2112F0 801E6790 801DB528 */ .word .L801DB528_ovl15
    /* 2112F4 801E6794 801DB5D8 */ .word .L801DB5D8_ovl15
    /* 2112F8 801E6798 801DB604 */ .word .L801DB604_ovl15
    /* 2112FC 801E679C 801DB628 */ .word .L801DB628_ovl15
    /* 211300 801E67A0 801DB64C */ .word .L801DB64C_ovl15
    /* 211304 801E67A4 801DB670 */ .word .L801DB670_ovl15
    /* 211308 801E67A8 801DB694 */ .word .L801DB694_ovl15
    /* 21130C 801E67AC 801DB6B8 */ .word .L801DB6B8_ovl15
    /* 211310 801E67B0 801DB6DC */ .word .L801DB6DC_ovl15
    /* 211314 801E67B4 801DB700 */ .word .L801DB700_ovl15
enddlabel jtbl_801E6790_ovl15
.size jtbl_801E6790_ovl15, . - jtbl_801E6790_ovl15


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DB400_ovl15, 0x370

glabel func_801DB400_ovl15
    /* 205F60 801DB400 27BDFFC0 */  addiu      $sp, $sp, -0x40
    /* 205F64 801DB404 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 205F68 801DB408 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 205FA4 801DB444 3C058005 */  lui        $a1, %hi(omCurrentObj)
    /* 205FA8 801DB448 8CA5A7C4 */  lw         $a1, %lo(omCurrentObj)($a1)
    /* 205FAC 801DB44C 0C02BEED */  jal        func_800AFBB4
    /* 205FB0 801DB450 00002025 */   or        $a0, $zero, $zero
    /* 205FB4 801DB454 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 205FB8 801DB458 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* 205FE0 801DB480 3C05800B */  lui        $a1, %hi(procMainStub)
    /* 205FE4 801DB484 24A51434 */  addiu      $a1, $a1, %lo(procMainStub)
    /* 205FE8 801DB488 00084880 */  sll        $t1, $t0, 2
    /* 205FEC 801DB48C 00892021 */  addu       $a0, $a0, $t1
    /* 205FF0 801DB490 0C02C7DA */  jal        setProcessMain
    /* 205FF4 801DB494 8C84EC10 */   lw        $a0, %lo(gEntityGObjProcessArray5)($a0)
    /* 205FF8 801DB498 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* 205FFC 801DB49C 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
    ...
    /* 206024 801DB4C4 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 206028 801DB4C8 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801DB514_ovl15:
    /* 206074 801DB514 3C01801E */  lui        $at, %hi(jtbl_801E6790_ovl15)
    /* 206078 801DB518 00380821 */  addu       $at, $at, $t8
    /* 20607C 801DB51C 8C386790 */  lw         $t8, %lo(jtbl_801E6790_ovl15)($at)
  ...
  .L801DB528_ovl15:
    ...
    /* 206094 801DB534 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 206098 801DB538 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 2060C0 801DB560 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 2060C4 801DB564 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801DB5BC_ovl15:
    /* 20611C 801DB5BC 0C002DAF */  jal        ohSleep
  ...
  .L801DB5E4_ovl15:
    /* 206144 801DB5E4 0C002DAF */  jal        ohSleep
  ...
  .L801DB60C_ovl15:
    /* 20616C 801DB60C 0C002DAF */  jal        ohSleep
  ...
  .L801DB630_ovl15:
    /* 206190 801DB630 0C002DAF */  jal        ohSleep
  ...
  .L801DB654_ovl15:
    /* 2061B4 801DB654 0C002DAF */  jal        ohSleep
  ...
  .L801DB678_ovl15:
    /* 2061D8 801DB678 0C002DAF */  jal        ohSleep
  ...
  .L801DB69C_ovl15:
    /* 2061FC 801DB69C 0C002DAF */  jal        ohSleep
  ...
  .L801DB6C0_ovl15:
    /* 206220 801DB6C0 0C002DAF */  jal        ohSleep
  ...
  .L801DB6E4_ovl15:
    /* 206244 801DB6E4 0C002DAF */  jal        ohSleep
  ...
  .L801DB708_ovl15:
    /* 206268 801DB708 0C002DAF */  jal        ohSleep
  ...
  .L801DB728_ovl15:
    /* 206288 801DB728 0C02BE85 */  jal        curObjSleepForever
