.section .late_rodata
nonmatching D_801E6838_ovl15

dlabel D_801E6838_ovl15
    /* 211398 801E6838 3F4CCCCD */ .float 0.8000000119
enddlabel D_801E6838_ovl15
.size D_801E6838_ovl15, . - D_801E6838_ovl15


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DDE90_ovl15, 0x3A4

glabel func_801DDE90_ovl15
    /* 2089F0 801DDE90 27BDFFA0 */  addiu      $sp, $sp, -0x60
    /* 2089F4 801DDE94 AFBE0058 */  sw         $fp, 0x58($sp)
    /* 2089F8 801DDE98 3C1E8005 */  lui        $fp, %hi(omCurrentObj)
    /* 2089FC 801DDE9C 27DEA7C4 */  addiu      $fp, $fp, %lo(omCurrentObj)
    ...
    /* 208A58 801DDEF8 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 208A5C 801DDEFC 24190001 */  addiu      $t9, $zero, 0x1
    /* 208A60 801DDF00 00084880 */  sll        $t1, $t0, 2
    /* 208A64 801DDF04 00290821 */  addu       $at, $at, $t1
    /* 208A68 801DDF08 AC39DC50 */  sw         $t9, %lo(gEntityFuncListIDArray)($at)
    ...
    /* 208AD0 801DDF70 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 208AD4 801DDF74 C4246B10 */  lwc1       $f4, %lo(gameTicksPerDraw)($at)
  ...
  .L801DE02C_ovl15:
    /* 208B8C 801DE02C 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 208B90 801DE030 45000003 */  bc1f       .L801DE040_ovl15
    /* 208B94 801DE034 00000000 */   nop
    /* 208B98 801DE038 0C02BB30 */  jal        func_800AECC0
    /* 208B9C 801DE03C C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
  .L801DE040_ovl15:
    /* 208BA0 801DE040 0C002DAF */  jal        ohSleep
  ...
  .L801DE070_ovl15:
    ...
    /* 208C00 801DE0A0 0C002DAF */  jal        ohSleep
  ...
  .L801DE1D4_ovl15:
    ...
    /* 208D48 801DE1E8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 208D4C 801DE1EC 0C02BB30 */  jal        func_800AECC0
    /* 208D50 801DE1F0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
