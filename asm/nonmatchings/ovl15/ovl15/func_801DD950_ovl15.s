.section .late_rodata
nonmatching D_801E6834_ovl15

dlabel D_801E6834_ovl15
    /* 211394 801E6834 3F333333 */ .float 0.6999999881
enddlabel D_801E6834_ovl15
.size D_801E6834_ovl15, . - D_801E6834_ovl15


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801DD950_ovl15, 0x258

glabel func_801DD950_ovl15
    /* 2084B0 801DD950 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 2084B4 801DD954 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 2084E0 801DD980 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 2084E4 801DD984 44802000 */  mtc1       $zero, $f4
    /* 2084E8 801DD988 0018C880 */  sll        $t9, $t8, 2
    /* 2084EC 801DD98C 00390821 */  addu       $at, $at, $t9
    /* 2084F0 801DD990 AC24DC50 */  sw         $a0, %lo(gEntityFuncListIDArray)($at)
  ...
  .L801DD9D4_ovl15:
    ...
    /* 20853C 801DD9DC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 208540 801DD9E0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDA28_ovl15:
    ...
    /* 20859C 801DDA3C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 2085A0 801DDA40 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDA64_ovl15:
    /* 2085C4 801DDA64 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 2085C8 801DDA68 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801DDAF0_ovl15:
    ...
    /* 208654 801DDAF4 3C05801E */  lui        $a1, %hi(D_801E654C_ovl15)
    ...
    /* 208674 801DDB14 8CA5654C */   lw        $a1, %lo(D_801E654C_ovl15)($a1)
    /* 208678 801DDB18 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 20867C 801DDB1C C4266B10 */  lwc1       $f6, %lo(gameTicksPerDraw)($at)
    /* 208680 801DDB20 3C01801E */  lui        $at, %hi(D_801E6834_ovl15)
    /* 208684 801DDB24 C4286834 */  lwc1       $f8, %lo(D_801E6834_ovl15)($at)
    /* 208688 801DDB28 46083302 */  mul.s      $f12, $f6, $f8
    /* 20868C 801DDB2C 0C02BB30 */  jal        func_800AECC0
    /* 208690 801DDB30 00000000 */   nop
    /* 208694 801DDB34 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 208698 801DDB38 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 2086C8 801DDB68 0C002DAF */  jal        ohSleep
    ...
    /* 2086EC 801DDB8C 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 2086F0 801DDB90 0C02BB30 */  jal        func_800AECC0
    /* 2086F4 801DDB94 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
