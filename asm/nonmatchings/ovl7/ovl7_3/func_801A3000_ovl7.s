.section .late_rodata
nonmatching D_801CDF9C_ovl7

dlabel D_801CDF9C_ovl7
    /* 17400C 801CDF9C 3DCCCCCD */ .float 0.1000000015
enddlabel D_801CDF9C_ovl7
.size D_801CDF9C_ovl7, . - D_801CDF9C_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801A3000_ovl7, 0x198

glabel func_801A3000_ovl7
    /* 149070 801A3000 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 149074 801A3004 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 1490A8 801A3038 3C038005 */   lui       $v1, %hi(omCurrentObj)
    /* 1490AC 801A303C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
