.section .late_rodata
nonmatching D_801CE368_ovl7

dlabel D_801CE368_ovl7
    /* 1743D8 801CE368 477FFF00 */ .float 65535
enddlabel D_801CE368_ovl7
.size D_801CE368_ovl7, . - D_801CE368_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801B7C30_ovl7, 0x250

glabel func_801B7C30_ovl7
    /* 15DCA0 801B7C30 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 15DCA4 801B7C34 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 15DCFC 801B7C8C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 15DD00 801B7C90 2442A7C4 */  addiu      $v0, $v0, %lo(omCurrentObj)
    ...
    /* 15DD58 801B7CE8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 15DD5C 801B7CEC 0C02BB30 */  jal        func_800AECC0
    /* 15DD60 801B7CF0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 15DD64 801B7CF4 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 15DD68 801B7CF8 0C02BB48 */  jal        func_800AED20
    /* 15DD6C 801B7CFC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    ...
    /* 15DD84 801B7D14 3C038005 */  lui        $v1, %hi(omCurrentObj)
    ...
    /* 15DDA4 801B7D34 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801B7E10_ovl7:
    ...
    /* 15DED0 801B7E60 0C002DAF */  jal        ohSleep
