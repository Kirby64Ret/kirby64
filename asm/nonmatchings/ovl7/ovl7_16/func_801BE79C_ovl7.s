.section .late_rodata
nonmatching jtbl_801CE5B0_ovl7

dlabel jtbl_801CE5B0_ovl7
    /* 174620 801CE5B0 801BEE2C */ .word .L801BEE2C_ovl7
    /* 174624 801CE5B4 801BEE2C */ .word .L801BEE2C_ovl7
    /* 174628 801CE5B8 801BEE2C */ .word .L801BEE2C_ovl7
    /* 17462C 801CE5BC 801BEE2C */ .word .L801BEE2C_ovl7
    /* 174630 801CE5C0 801BEE2C */ .word .L801BEE2C_ovl7
    /* 174634 801CE5C4 801BEE2C */ .word .L801BEE2C_ovl7
    /* 174638 801CE5C8 801BED90 */ .word .L801BED90_ovl7
    /* 17463C 801CE5CC 801BEDC4 */ .word .L801BEDC4_ovl7
    /* 174640 801CE5D0 801BEDF8 */ .word .L801BEDF8_ovl7
enddlabel jtbl_801CE5B0_ovl7
.size jtbl_801CE5B0_ovl7, . - jtbl_801CE5B0_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801BE79C_ovl7, 0x6B8

glabel func_801BE79C_ovl7
    /* 16480C 801BE79C 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164810 801BE7A0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BE858_ovl7:
    ...
    /* 1648D4 801BE864 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1648D8 801BE868 3C03800E */  lui        $v1, %hi(D_800E77A0)
    /* 1648DC 801BE86C AF200034 */  sw         $zero, 0x34($t9)
    /* 1648E0 801BE870 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 1648F0 801BE880 3C04800D */  lui        $a0, %hi(saveCurrentFileNum)
    ...
    /* 164910 801BE8A0 8C846B88 */  lw         $a0, %lo(saveCurrentFileNum)($a0)
    ...
    /* 164950 801BE8E0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164954 801BE8E4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BE944_ovl7:
    ...
    /* 1649D8 801BE968 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1649DC 801BE96C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BE978_ovl7:
    ...
    /* 1649F8 801BE988 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1649FC 801BE98C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BE99C_ovl7:
    ...
    /* 164A20 801BE9B0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164A24 801BE9B4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BE9C0_ovl7:
    ...
    /* 164A44 801BE9D4 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164A48 801BE9D8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BEA24_ovl7:
    ...
    /* 164AA0 801BEA30 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164AA4 801BEA34 3C01800E */  lui        $at, %hi(D_800DF150)
    /* 164AA8 801BEA38 AD400034 */  sw         $zero, 0x34($t2)
    /* 164AAC 801BEA3C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 164ACC 801BEA5C 0C002DAF */  jal        ohSleep
    ...
    /* 164ADC 801BEA6C 0C02BE85 */  jal        curObjSleepForever
    /* 164AE0 801BEA70 A02DE7D4 */   sb        $t5, %lo(D_8012E7C5 + 0xF)($at)
    /* 164AE4 801BEA74 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164AE8 801BEA78 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801BEA84_ovl7:
    ...
    /* 164B60 801BEAF0 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 164B64 801BEAF4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 164B90 801BEB20 0C02E793 */  jal        saveCollectedAllShards
  ...
  .L801BEB64_ovl7:
    ...
    /* 164BE4 801BEB74 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 164BE8 801BEB78 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
  ...
  .L801BEBAC_ovl7:
    ...
    /* 164C28 801BEBB8 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 164C2C 801BEBBC 3C18800E */  lui        $t8, %hi(D_800DFBD0)
    /* 164C30 801BEBC0 ADA00034 */  sw         $zero, 0x34($t5)
    /* 164C34 801BEBC4 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
    ...
    /* 164C4C 801BEBDC 0C0291E5 */  jal        utilGetTransformSRT
    /* 164C50 801BEBE0 8F050004 */   lw        $a1, 0x4($t8)
    /* 164C54 801BEBE4 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 164C58 801BEBE8 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 164C94 801BEC24 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 164C98 801BEC28 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L801BEC54_ovl7:
    /* 164CC4 801BEC54 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 164CC8 801BEC58 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
    ...
    /* 164CF0 801BEC80 0C002DAF */  jal        ohSleep
  ...
  .L801BECB8_ovl7:
    ...
    /* 164D3C 801BECCC 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 164D40 801BECD0 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* 164D60 801BECF0 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164D64 801BECF4 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 164D88 801BED18 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 164D8C 801BED1C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 164DB8 801BED48 0C002DAF */  jal        ohSleep
    /* 164DBC 801BED4C 2404000F */   addiu     $a0, $zero, 0xF
    /* 164DC0 801BED50 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    /* 164DC4 801BED54 8D4AA7C4 */  lw         $t2, %lo(omCurrentObj)($t2)
  ...
  .L801BED90_ovl7:
    ...
    /* 164E14 801BEDA4 3C04800D */  lui        $a0, %hi(saveCurrentFileNum)
    /* 164E18 801BEDA8 8C846B88 */  lw         $a0, %lo(saveCurrentFileNum)($a0)
    /* 164E1C 801BEDAC 0C02E72D */  jal        func_800B9CB4
    /* 164E20 801BEDB0 24050002 */   addiu     $a1, $zero, 0x2
    /* 164E24 801BEDB4 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 164E28 801BEDB8 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L801BEDC4_ovl7:
    ...
    /* 164E48 801BEDD8 3C04800D */  lui        $a0, %hi(saveCurrentFileNum)
    /* 164E4C 801BEDDC 8C846B88 */  lw         $a0, %lo(saveCurrentFileNum)($a0)
    /* 164E50 801BEDE0 0C02E72D */  jal        func_800B9CB4
    /* 164E54 801BEDE4 24050005 */   addiu     $a1, $zero, 0x5
    /* 164E58 801BEDE8 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 164E5C 801BEDEC 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801BEDF8_ovl7:
    ...
    /* 164E7C 801BEE0C 3C04800D */  lui        $a0, %hi(saveCurrentFileNum)
    /* 164E80 801BEE10 8C846B88 */  lw         $a0, %lo(saveCurrentFileNum)($a0)
    /* 164E84 801BEE14 0C02E72D */  jal        func_800B9CB4
    /* 164E88 801BEE18 24050008 */   addiu     $a1, $zero, 0x8
    /* 164E8C 801BEE1C 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 164E90 801BEE20 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
