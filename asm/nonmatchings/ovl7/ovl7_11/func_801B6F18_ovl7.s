.section .late_rodata
nonmatching D_801CE350_ovl7

dlabel D_801CE350_ovl7
    /* 1743C0 801CE350 477FFF00 */ .float 65535
enddlabel D_801CE350_ovl7
.size D_801CE350_ovl7, . - D_801CE350_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801B6F18_ovl7, 0x294

glabel func_801B6F18_ovl7
    /* 15CF88 801B6F18 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 15CF8C 801B6F1C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801B7064_ovl7:
    ...
    /* 15D1D0 801B7160 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    /* 15D1D4 801B7164 000FC080 */  sll        $t8, $t7, 2
    /* 15D1D8 801B7168 00380821 */  addu       $at, $at, $t8
    /* 15D1DC 801B716C AC2EDC50 */  sw         $t6, %lo(gEntityFuncListIDArray)($at)
