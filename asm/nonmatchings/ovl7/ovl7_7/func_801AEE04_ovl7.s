.section .late_rodata
nonmatching D_801CE238_ovl7

dlabel D_801CE238_ovl7
    /* 1742A8 801CE238 3DD67750 */ .float 0.104719758
enddlabel D_801CE238_ovl7
.size D_801CE238_ovl7, . - D_801CE238_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801AEE04_ovl7, 0x1BC

glabel func_801AEE04_ovl7
    /* 154E74 801AEE04 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 154E78 801AEE08 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801AEE58_ovl7:
    ...
    /* 154EDC 801AEE6C 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 154EE0 801AEE70 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801AEE80_ovl7:
    ...
    /* 154F10 801AEEA0 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 154F14 801AEEA4 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801AEEB4_ovl7:
    ...
    /* 154F44 801AEED4 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 154F48 801AEED8 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801AEF18_ovl7:
    ...
    /* 154FB4 801AEF44 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 154FB8 801AEF48 10000002 */  b          .L801AEF54_ovl7
    /* 154FBC 801AEF4C 8CC6A7C4 */   lw        $a2, %lo(omCurrentObj)($a2)
  .L801AEF50_ovl7:
