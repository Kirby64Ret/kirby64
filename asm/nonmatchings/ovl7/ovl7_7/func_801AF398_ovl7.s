.section .late_rodata
nonmatching D_801CE240_ovl7

dlabel D_801CE240_ovl7
    /* 1742B0 801CE240 3BB60B61 */ .float 0.00555555569
enddlabel D_801CE240_ovl7
.size D_801CE240_ovl7, . - D_801CE240_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801AF398_ovl7, 0x47C

glabel func_801AF398_ovl7
    /* 155408 801AF398 27BDFFB0 */  addiu      $sp, $sp, -0x50
    /* 15540C 801AF39C AFB00018 */  sw         $s0, 0x18($sp)
    /* 155410 801AF3A0 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 155414 801AF3A4 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801AF494_ovl7:
    ...
    /* 155510 801AF4A0 0C066FA7 */  jal        eneTurnCommon
    ...
    /* 155520 801AF4B0 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
  ...
  .L801AF4F8_ovl7:
    ...
    /* 15556C 801AF4FC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 155570 801AF500 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 155574 801AF504 0C02BB48 */  jal        func_800AED20
    /* 155578 801AF508 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
  ...
  .L801AF510_ovl7:
    ...
    /* 1555A8 801AF538 0C02911F */  jal        utilFuncTableJump
  ...
  .L801AF60C_ovl7:
    ...
    /* 155780 801AF710 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 155790 801AF720 AC27DC50 */  sw         $a3, %lo(gEntityFuncListIDArray)($at)
