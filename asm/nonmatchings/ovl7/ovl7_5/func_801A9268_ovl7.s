nonmatching func_801A9268_ovl7, 0x270

glabel func_801A9268_ovl7
    /* 14F2D8 801A9268 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 14F2DC 801A926C 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
  ...
  .L801A93AC_ovl7:
    ...
    /* 14F438 801A93C8 3C028005 */  lui        $v0, %hi(omCurrentObj)
  ...
  .L801A93E0_ovl7:
    /* 14F450 801A93E0 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 14F4DC 801A946C 3C0D800D */  lui        $t5, %hi(D_800D6C90)
    /* 14F4E0 801A9470 25AD6C90 */  addiu      $t5, $t5, %lo(D_800D6C90)
  ...
  .L801A949C_ovl7:
    ...
    /* 14F518 801A94A8 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 14F51C 801A94AC 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
