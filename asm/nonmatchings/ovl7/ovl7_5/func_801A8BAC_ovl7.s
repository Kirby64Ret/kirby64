nonmatching func_801A8BAC_ovl7, 0x130

glabel func_801A8BAC_ovl7
    /* 14EC1C 801A8BAC 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 14EC20 801A8BB0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 14ECB0 801A8C40 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 14ECB4 801A8C44 8FA2001C */  lw         $v0, 0x1C($sp)
    /* 14ECB8 801A8C48 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
    ...
    /* 14ECF4 801A8C84 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    /* 14ECF8 801A8C88 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
