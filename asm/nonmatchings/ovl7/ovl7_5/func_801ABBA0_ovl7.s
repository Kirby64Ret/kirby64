.section .late_rodata
nonmatching D_801CE15C_ovl7

dlabel D_801CE15C_ovl7
    /* 1741CC 801CE15C 40490FDB */ .float 3.141592741
enddlabel D_801CE15C_ovl7
.size D_801CE15C_ovl7, . - D_801CE15C_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801ABBA0_ovl7, 0x57C

glabel func_801ABBA0_ovl7
    /* 151C10 801ABBA0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 151C14 801ABBA4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801ABDD8_ovl7:
    ...
    /* 151E54 801ABDE4 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 151E58 801ABDE8 3C02800E */  lui        $v0, %hi(D_800E7730)
    /* 151E5C 801ABDEC AD600034 */  sw         $zero, 0x34($t3)
    /* 151E60 801ABDF0 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
    ...
    /* 151EA8 801ABE38 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 151EAC 801ABE3C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801ABE54_ovl7:
    ...
    /* 151EF4 801ABE84 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 151EF8 801ABE88 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801ABEA0_ovl7:
    ...
    /* 151F3C 801ABECC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 151F40 801ABED0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801ABF2C_ovl7:
    ...
    /* 151FA4 801ABF34 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 151FA8 801ABF38 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801ABF94_ovl7:
    ...
    /* 152008 801ABF98 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 15200C 801ABF9C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
  ...
  .L801AC050_ovl7:
    ...
    /* 15210C 801AC09C 3C0A8005 */  lui        $t2, %hi(omCurrentObj)
    ...
    /* 152140 801AC0D0 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 15215C 801AC0EC 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 152160 801AC0F0 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    /* 152164 801AC0F4 8C790000 */  lw         $t9, 0x0($v1)
  .L801AC0F8_ovl7:
    /* 152168 801AC0F8 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 152178 801AC108 AC20DC50 */   sw        $zero, %lo(gEntityFuncListIDArray)($at)
