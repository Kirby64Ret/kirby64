.section .late_rodata
nonmatching D_801CDFBC_ovl7

dlabel D_801CDFBC_ovl7
    /* 17402C 801CDFBC 477FFF00 */ .float 65535
enddlabel D_801CDFBC_ovl7
.size D_801CDFBC_ovl7, . - D_801CDFBC_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801A4754_ovl7, 0x4B8

glabel func_801A4754_ovl7
    /* 14A7C4 801A4754 27BDFFB8 */  addiu      $sp, $sp, -0x48
    /* 14A7C8 801A4758 AFB10024 */  sw         $s1, 0x24($sp)
    /* 14A7CC 801A475C 3C118005 */  lui        $s1, %hi(omCurrentObj)
    /* 14A7D0 801A4760 2631A7C4 */  addiu      $s1, $s1, %lo(omCurrentObj)
  ...
  .L801A4A90_ovl7:
    /* 14AB00 801A4A90 0C002DAF */  jal        ohSleep
  ...
  .L801A4B04_ovl7:
    /* 14AB74 801A4B04 0C002DAF */  jal        ohSleep
  ...
  .L801A4B64_ovl7:
    ...
    /* 14ABF8 801A4B88 3C088005 */  lui        $t0, %hi(omCurrentObj)
    /* 14ABFC 801A4B8C 8D08A7C4 */  lw         $t0, %lo(omCurrentObj)($t0)
