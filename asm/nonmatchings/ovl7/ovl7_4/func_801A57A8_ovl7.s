.section .late_rodata
nonmatching D_801CDFCC_ovl7

dlabel D_801CDFCC_ovl7
    /* 17403C 801CDFCC 477FFF00 */ .float 65535
enddlabel D_801CDFCC_ovl7
.size D_801CDFCC_ovl7, . - D_801CDFCC_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801A57A8_ovl7, 0x640

glabel func_801A57A8_ovl7
    /* 14B818 801A57A8 27BDFFD0 */  addiu      $sp, $sp, -0x30
    /* 14B81C 801A57AC AFB00020 */  sw         $s0, 0x20($sp)
    /* 14B820 801A57B0 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 14B824 801A57B4 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801A5B14_ovl7:
    /* 14BB84 801A5B14 0C002DAF */  jal        ohSleep
  ...
  .L801A5BE8_ovl7:
    /* 14BC58 801A5BE8 0C002DAF */  jal        ohSleep
  ...
  .L801A5CE4_ovl7:
    /* 14BD54 801A5CE4 0C002DAF */  jal        ohSleep
  ...
  .L801A5D48_ovl7:
    ...
    /* 14BDDC 801A5D6C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 14BDE0 801A5D70 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
