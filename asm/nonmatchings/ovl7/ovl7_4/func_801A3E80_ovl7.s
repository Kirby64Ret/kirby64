.section .late_rodata
nonmatching D_801CDFB0_ovl7

dlabel D_801CDFB0_ovl7
    /* 174020 801CDFB0 477FFF00 */ .float 65535
enddlabel D_801CDFB0_ovl7
.size D_801CDFB0_ovl7, . - D_801CDFB0_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801A3E80_ovl7, 0x354

glabel func_801A3E80_ovl7
    /* 149EF0 801A3E80 27BDFFD0 */  addiu      $sp, $sp, -0x30
    /* 149EF4 801A3E84 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 149EF8 801A3E88 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 149F28 801A3EB8 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 149F2C 801A3EBC 0C02BB30 */  jal        func_800AECC0
    /* 149F30 801A3EC0 C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 149F34 801A3EC4 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 149F38 801A3EC8 0C02BB48 */  jal        func_800AED20
    /* 149F3C 801A3ECC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 149F40 801A3ED0 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 149F44 801A3ED4 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 14A034 801A3FC4 3C0F8005 */  lui        $t7, %hi(omCurrentObj)
    ...
    /* 14A08C 801A401C 8DEFA7C4 */  lw         $t7, %lo(omCurrentObj)($t7)
  ...
  .L801A409C_ovl7:
    ...
    /* 14A114 801A40A4 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 14A118 801A40A8 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    /* 14A11C 801A40AC 3C07800E */  lui        $a3, %hi(gEntityFuncListIDArray)
    /* 14A120 801A40B0 24E7DC50 */  addiu      $a3, $a3, %lo(gEntityFuncListIDArray)
    ...
    /* 14A14C 801A40DC 0C02911F */  jal        utilFuncTableJump
    ...
    /* 14A15C 801A40EC 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 14A160 801A40F0 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L801A4178_ovl7:
    /* 14A1E8 801A4178 3C038005 */  lui        $v1, %hi(omCurrentObj)
    /* 14A1EC 801A417C 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
    ...
    /* 14A218 801A41A8 0C002DAF */  jal        ohSleep
    /* 14A21C 801A41AC 2404000F */   addiu     $a0, $zero, 0xF
    /* 14A220 801A41B0 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 14A224 801A41B4 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
...
endlabel func_801A3E80_ovl7
.size func_801A3E80_ovl7, . - func_801A3E80_ovl7
