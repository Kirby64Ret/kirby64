.section .late_rodata
nonmatching D_801CE468_ovl7

dlabel D_801CE468_ovl7
    /* 1744D8 801CE468 BEA66666 */ .float -0.3249999881
enddlabel D_801CE468_ovl7
.size D_801CE468_ovl7, . - D_801CE468_ovl7

nonmatching D_801CE46C_ovl7

dlabel D_801CE46C_ovl7
    /* 1744DC 801CE46C 477FFF00 */ .float 65535
enddlabel D_801CE46C_ovl7
.size D_801CE46C_ovl7, . - D_801CE46C_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801BB3D4_ovl7, 0x2C8

glabel func_801BB3D4_ovl7
    /* 161444 801BB3D4 27BDFFD8 */  addiu      $sp, $sp, -0x28
    /* 161448 801BB3D8 AFB00020 */  sw         $s0, 0x20($sp)
    /* 16144C 801BB3DC 3C108005 */  lui        $s0, %hi(omCurrentObj)
    /* 161450 801BB3E0 2610A7C4 */  addiu      $s0, $s0, %lo(omCurrentObj)
  ...
  .L801BB664_ovl7:
    /* 1616D4 801BB664 0C002DAF */  jal        ohSleep
    /* 1616D8 801BB668 24040001 */   addiu     $a0, $zero, 0x1
    /* 1616DC 801BB66C 3C038005 */  lui        $v1, %hi(omCurrentObj)
    ...
    /* 1616EC 801BB67C 8C63A7C4 */   lw        $v1, %lo(omCurrentObj)($v1)
  .L801BB680_ovl7:
    /* 1616F0 801BB680 0C02BE85 */  jal        curObjSleepForever
