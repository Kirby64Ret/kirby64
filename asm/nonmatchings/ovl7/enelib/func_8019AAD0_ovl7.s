.section .late_rodata
nonmatching D_801CDBF8_ovl7

dlabel D_801CDBF8_ovl7
    /* 173C68 801CDBF8 461C3C00 */ .float 9999
enddlabel D_801CDBF8_ovl7
.size D_801CDBF8_ovl7, . - D_801CDBF8_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8019AAD0_ovl7, 0x190
...
glabel func_8019AAD0_ovl7
  ...
  .L8019AB40_ovl7:
    /* 140BB0 8019AB40 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 140BB4 8019AB44 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
  ...
  .L8019ABA0_ovl7:
    ...
    /* 140C18 8019ABA8 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    ...
    /* 140C2C 8019ABBC 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
