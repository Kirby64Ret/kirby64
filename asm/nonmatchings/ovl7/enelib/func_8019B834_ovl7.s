.section .late_rodata
nonmatching D_801CDC1C_ovl7

dlabel D_801CDC1C_ovl7
    /* 173C8C 801CDC1C 3F89999A */ .float 1.075000048
enddlabel D_801CDC1C_ovl7
.size D_801CDC1C_ovl7, . - D_801CDC1C_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8019B834_ovl7, 0xE4

glabel func_8019B834_ovl7
    /* 1418A4 8019B834 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 1418A8 8019B838 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 14190C 8019B89C 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 141910 8019B8A0 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
