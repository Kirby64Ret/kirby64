.section .late_rodata
nonmatching D_801CDC00_ovl7

dlabel D_801CDC00_ovl7
    /* 173C70 801CDC00 40C90FDB */ .float 6.283185482
enddlabel D_801CDC00_ovl7
.size D_801CDC00_ovl7, . - D_801CDC00_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8019ADB4_ovl7, 0x14C
...
glabel func_8019ADB4_ovl7
    ...
    /* 140E3C 8019ADCC 3C0E8005 */   lui       $t6, %hi(omCurrentObj)
    /* 140E40 8019ADD0 10000047 */  b          .L8019AEF0_ovl7
    /* 140E44 8019ADD4 00001025 */   or        $v0, $zero, $zero
  .L8019ADD8_ovl7:
    /* 140E48 8019ADD8 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 140E80 8019AE10 3C038005 */  lui        $v1, %hi(omCurrentObj)
  ...
  .L8019AE48_ovl7:
    /* 140EB8 8019AE48 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
