.section .late_rodata
nonmatching D_801CDBFC_ovl7

dlabel D_801CDBFC_ovl7
    /* 173C6C 801CDBFC 40C90FDB */ .float 6.283185482
enddlabel D_801CDBFC_ovl7
.size D_801CDBFC_ovl7, . - D_801CDBFC_ovl7


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_8019AC60_ovl7, 0x154
...
glabel func_8019AC60_ovl7
    ...
    /* 140CF0 8019AC80 3C0E8005 */   lui       $t6, %hi(omCurrentObj)
    /* 140CF4 8019AC84 10000047 */  b          .L8019ADA4_ovl7
    /* 140CF8 8019AC88 00001025 */   or        $v0, $zero, $zero
  .L8019AC8C_ovl7:
    /* 140CFC 8019AC8C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 140D34 8019ACC4 3C038005 */  lui        $v1, %hi(omCurrentObj)
  ...
  .L8019ACFC_ovl7:
    /* 140D6C 8019ACFC 8C63A7C4 */  lw         $v1, %lo(omCurrentObj)($v1)
