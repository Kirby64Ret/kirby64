.section .late_rodata
nonmatching D_8015C518_ovl4

dlabel D_8015C518_ovl4
    /* 103A48 8015C518 3ECCCCCD */ .float 0.400000006
enddlabel D_8015C518_ovl4
.size D_8015C518_ovl4, . - D_8015C518_ovl4

nonmatching D_8015C51C_ovl4

dlabel D_8015C51C_ovl4
    /* 103A4C 8015C51C BECCCCCD */ .float -0.400000006
enddlabel D_8015C51C_ovl4
.size D_8015C51C_ovl4, . - D_8015C51C_ovl4


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801548BC_ovl4, 0x4E4

glabel func_801548BC_ovl4
    /* FBDEC 801548BC 27BDFF78 */  addiu      $sp, $sp, -0x88
    /* FBDF0 801548C0 AFB30044 */  sw         $s3, 0x44($sp)
    /* FBDF4 801548C4 3C138005 */  lui        $s3, %hi(omCurrentObj)
    /* FBDF8 801548C8 2673A7C4 */  addiu      $s3, $s3, %lo(omCurrentObj)
    ...
    /* FBE68 80154938 3C048016 */  lui        $a0, %hi(D_8015A948_ovl4)
    /* FBE6C 8015493C 3C050001 */  lui        $a1, (0x1869F >> 16)
    /* FBE70 80154940 34A5869F */  ori        $a1, $a1, (0x1869F & 0xFFFF)
    /* FBE74 80154944 8C84A948 */  lw         $a0, %lo(D_8015A948_ovl4)($a0)
    ...
    /* FBEC8 80154998 3C018016 */  lui        $at, %hi(D_8015C51C_ovl4)
    /* FBECC 8015499C 3C178016 */  lui        $s7, %hi(D_8015A94C_ovl4)
    ...
    /* FBEF0 801549C0 26F7A94C */  addiu      $s7, $s7, %lo(D_8015A94C_ovl4)
    /* FBEF4 801549C4 C436C51C */  lwc1       $f22, %lo(D_8015C51C_ovl4)($at)
  ...
  .L80154A9C_ovl4:
    /* FBFCC 80154A9C 0C002DAF */  jal        ohSleep
  ...
  .L80154AD4_ovl4:
    /* FC004 80154AD4 13C00003 */  beqz       $fp, .L80154AE4_ovl4
  ...
  .L80154B8C_ovl4:
    /* FC0BC 80154B8C 0C002DAF */  jal        ohSleep
    ...
    /* FC0E0 80154BB0 4503FFD8 */  bc1tl      .L80154B14_ovl4
  ...
  .L80154BBC_ovl4:
    ...
    /* FC0F4 80154BC4 0C054CB3 */  jal        func_801532CC_ovl4
  ...
  .L80154D38_ovl4:
    /* FC268 80154D38 0C002DAF */  jal        ohSleep
