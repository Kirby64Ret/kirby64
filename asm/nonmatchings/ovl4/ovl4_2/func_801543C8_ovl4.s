.section .late_rodata
nonmatching D_8015C510_ovl4

dlabel D_8015C510_ovl4
    /* 103A40 8015C510 3ECCCCCD */ .float 0.400000006
enddlabel D_8015C510_ovl4
.size D_8015C510_ovl4, . - D_8015C510_ovl4

nonmatching D_8015C514_ovl4

dlabel D_8015C514_ovl4
    /* 103A44 8015C514 BECCCCCD */ .float -0.400000006
enddlabel D_8015C514_ovl4
.size D_8015C514_ovl4, . - D_8015C514_ovl4


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801543C8_ovl4, 0x4B8

glabel func_801543C8_ovl4
    /* FB8F8 801543C8 27BDFF78 */  addiu      $sp, $sp, -0x88
    /* FB8FC 801543CC AFB30044 */  sw         $s3, 0x44($sp)
    /* FB900 801543D0 3C138005 */  lui        $s3, %hi(omCurrentObj)
    /* FB904 801543D4 2673A7C4 */  addiu      $s3, $s3, %lo(omCurrentObj)
    ...
    /* FB974 80154444 3C048016 */  lui        $a0, %hi(D_8015A93C_ovl4)
    /* FB978 80154448 3C050001 */  lui        $a1, (0x1869F >> 16)
    /* FB97C 8015444C 34A5869F */  ori        $a1, $a1, (0x1869F & 0xFFFF)
    /* FB980 80154450 8C84A93C */  lw         $a0, %lo(D_8015A93C_ovl4)($a0)
    ...
    /* FB9D8 801544A8 3C1E8016 */  lui        $fp, %hi(D_8015A940_ovl4)
    ...
    /* FB9FC 801544CC 27DEA940 */  addiu      $fp, $fp, %lo(D_8015A940_ovl4)
  ...
  .L80154530_ovl4:
    ...
    /* FBAAC 8015457C 4500000A */  bc1f       .L801545A8_ovl4
  ...
  .L801545A8_ovl4:
    /* FBAD8 801545A8 0C002DAF */  jal        ohSleep
  ...
  .L80154698_ovl4:
    /* FBBC8 80154698 0C002DAF */  jal        ohSleep
  ...
  .L80154804_ovl4:
    /* FBD34 80154804 0C002DAF */  jal        ohSleep
