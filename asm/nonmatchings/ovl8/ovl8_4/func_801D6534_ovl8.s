.section .late_rodata
nonmatching D_801DB1BC_ovl8

dlabel D_801DB1BC_ovl8
    /* 17EC9C 801DB1BC BF7B0CDD */ .float -0.9806650281
enddlabel D_801DB1BC_ovl8
.size D_801DB1BC_ovl8, . - D_801DB1BC_ovl8


.section .text
/* Generated by spimdisasm 1.42.4 */

nonmatching func_801D6534_ovl8, 0x3AC

glabel func_801D6534_ovl8
    /* 17A014 801D6534 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 17A018 801D6538 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
    ...
    /* 17A030 801D6550 3C18800E */  lui        $t8, %hi(gEntityFuncListIDArray)
    ...
    /* 17A050 801D6570 8F18DC50 */  lw         $t8, %lo(gEntityFuncListIDArray)($t8)
  ...
  .L801D65F8_ovl8:
    ...
    /* 17A0E0 801D6600 3C028005 */  lui        $v0, %hi(omCurrentObj)
    /* 17A0E4 801D6604 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
    ...
    /* 17A15C 801D667C 3C188005 */  lui        $t8, %hi(omCurrentObj)
    /* 17A160 801D6680 8F18A7C4 */  lw         $t8, %lo(omCurrentObj)($t8)
  ...
  .L801D66A0_ovl8:
    ...
    /* 17A190 801D66B0 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 17A194 801D66B4 3C028005 */  lui        $v0, %hi(omCurrentObj)
    ...
    /* 17A1A8 801D66C8 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L801D66E8_ovl8:
    /* 17A1C8 801D66E8 8C42A7C4 */  lw         $v0, %lo(omCurrentObj)($v0)
