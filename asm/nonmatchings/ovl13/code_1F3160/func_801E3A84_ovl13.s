nonmatching func_801E3A84_ovl13, 0x338

glabel func_801E3A84_ovl13
    /* 1FBA04 801E3A84 27BDFFA8 */  addiu      $sp, $sp, -0x58
    /* 1FBA08 801E3A88 3C0E8005 */  lui        $t6, %hi(omCurrentObj)
    /* 1FBA0C 801E3A8C 8DCEA7C4 */  lw         $t6, %lo(omCurrentObj)($t6)
  ...
  .L801E3AD8_ovl13:
    ...
    /* 1FBAA8 801E3B28 3C0C8005 */   lui       $t4, %hi(omCurrentObj)
    /* 1FBAAC 801E3B2C 8D0A008C */  lw         $t2, 0x8C($t0)
    /* 1FBAB0 801E3B30 AD0B008C */  sw         $t3, 0x8C($t0)
    /* 1FBAB4 801E3B34 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
  ...
  .L801E3B40_ovl13:
    ...
    /* 1FBACC 801E3B4C 3C0D8005 */  lui        $t5, %hi(omCurrentObj)
    /* 1FBAD0 801E3B50 8FA90030 */  lw         $t1, 0x30($sp)
    /* 1FBAD4 801E3B54 8DADA7C4 */  lw         $t5, %lo(omCurrentObj)($t5)
  ...
  .L801E3BB8_ovl13:
    ...
    /* 1FBB44 801E3BC4 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1FBB48 801E3BC8 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
  ...
  .L801E3BFC_ovl13:
    ...
    /* 1FBB88 801E3C08 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1FBB8C 801E3C0C 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
  ...
  .L801E3C40_ovl13:
    ...
    /* 1FBBCC 801E3C4C 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1FBBD0 801E3C50 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
  ...
  .L801E3CCC_ovl13:
    ...
    /* 1FBC7C 801E3CFC 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1FBC80 801E3D00 24C6A7C4 */  addiu      $a2, $a2, %lo(omCurrentObj)
    ...
    /* 1FBCE4 801E3D64 3C0B8005 */  lui        $t3, %hi(omCurrentObj)
    /* 1FBCE8 801E3D68 8D6BA7C4 */  lw         $t3, %lo(omCurrentObj)($t3)
  ...
  .L801E3D78_ovl13:
    ...
    /* 1FBD0C 801E3D8C 3C0C8005 */  lui        $t4, %hi(omCurrentObj)
    /* 1FBD10 801E3D90 ADE2008C */  sw         $v0, 0x8C($t7)
    /* 1FBD14 801E3D94 8D8CA7C4 */  lw         $t4, %lo(omCurrentObj)($t4)
