nonmatching func_801DD888_ovl13, 0x254

glabel func_801DD888_ovl13
    /* 1F5808 801DD888 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1F580C 801DD88C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801DD8D4_ovl13:
    ...
    /* 1F5864 801DD8E4 3C198005 */  lui        $t9, %hi(omCurrentObj)
    /* 1F5868 801DD8E8 8F39A7C4 */  lw         $t9, %lo(omCurrentObj)($t9)
    ...
    /* 1F5898 801DD918 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1F589C 801DD91C 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
  ...
  .L801DDA30_ovl13:
    ...
    /* 1F59C4 801DDA44 3C098005 */  lui        $t1, %hi(omCurrentObj)
    /* 1F59C8 801DDA48 8D29A7C4 */  lw         $t1, %lo(omCurrentObj)($t1)
    ...
    /* 1F59F0 801DDA70 3C068005 */  lui        $a2, %hi(omCurrentObj)
    /* 1F59F4 801DDA74 8CC6A7C4 */  lw         $a2, %lo(omCurrentObj)($a2)
    ...
    /* 1F5A1C 801DDA9C 3C01800E */   lui       $at, %hi(gEntityFuncListIDArray)
    /* 1F5A20 801DDAA0 00230821 */  addu       $at, $at, $v1
    /* 1F5A24 801DDAA4 AC2DDC50 */  sw         $t5, %lo(gEntityFuncListIDArray)($at)
