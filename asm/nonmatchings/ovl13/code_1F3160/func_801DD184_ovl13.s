nonmatching func_801DD184_ovl13, 0x224

glabel func_801DD184_ovl13
    ...
    /* 1F5124 801DD1A4 3C01800D */  lui        $at, %hi(gameTicksPerDraw)
    /* 1F5128 801DD1A8 0C02BB30 */  jal        func_800AECC0
    /* 1F512C 801DD1AC C42C6B10 */   lwc1      $f12, %lo(gameTicksPerDraw)($at)
    /* 1F5130 801DD1B0 3C128005 */  lui        $s2, %hi(omCurrentObj)
    /* 1F5134 801DD1B4 2652A7C4 */  addiu      $s2, $s2, %lo(omCurrentObj)
    ...
    /* 1F51F8 801DD278 0C002DAF */  jal        ohSleep
    ...
    /* 1F524C 801DD2CC 0C002DAF */  jal        ohSleep
    ...
    /* 1F527C 801DD2FC 0C002DAF */  jal        ohSleep
  ...
  .L801DD33C_ovl13:
    /* 1F52BC 801DD33C 0C002DAF */  jal        ohSleep
  ...
  .L801DD36C_ovl13:
    ...
    /* 1F52FC 801DD37C 3C01800E */  lui        $at, %hi(gEntityFuncListIDArray)
    ...
    /* 1F531C 801DD39C AC2ADC50 */  sw         $t2, %lo(gEntityFuncListIDArray)($at)
    /* 1F5320 801DD3A0 03E00008 */  jr         $ra
    /* 1F5324 801DD3A4 27BD0028 */   addiu     $sp, $sp, 0x28
endlabel func_801DD184_ovl13
