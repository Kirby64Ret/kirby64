...
void func_80180510_ovl5(s32 arg0) {
    ...
    u32 temp_a0_5;
    u32 temp_v1_2;
    union _anonymous *temp_v0_3;
    union _anonymous *temp_v1_3;

    if (D_8018EDE0_ovl5 == 0) {
        temp_a0 = omCurrentObj->objId;
        temp_v0 = &D_800E98E0[temp_a0];
        temp_v1 = *temp_v0;
        if (temp_v1 != 0) {
            *temp_v0 = temp_v1 - 1;
            return;
        }
        if (gPlayerControllers->buttonHeld & 0xF00) {
            temp_v0_2 = &D_800E9C60[temp_a0];
            *temp_v0_2 += 1;
        } else {
            D_800E9AA0[temp_a0].as_u32 = 0;
            D_800E9C60[omCurrentObj->objId] = 0;
        }
        temp_a0_2 = omCurrentObj->objId;
        temp_v0_3 = &D_800E9AA0[temp_a0_2];
        temp_v1_2 = temp_v0_3->as_u32;
        if (temp_v1_2 != 0) {
            temp_v0_3->as_u32 = temp_v1_2 - 1;
            return;
        }
        temp_a2 = &D_800E98E0[D_8018EDEC_ovl5];
        if (*temp_a2 == 0) {
            ...
            if (gPlayerControllers->buttonPressed & 0x9000) {
                temp_v1_3 = &D_800E9AA0[D_8018EDEC_ovl5];
                temp_a0_3 = temp_v1_3->as_u32;
                if (temp_a0_3 == 0) {
                    temp_v1_3->as_u32 = 1;
                    if (D_8018EDE1_ovl5 == 0) {
                        D_8018EDF4_ovl5 = (u32) D_8018EDE4_ovl5;
                        func_8018043C_ovl5(D_8018EDE4_ovl5);
                        play_music(0, 0x99999999);
                        play_music(0, *(D_8018A128_ovl5 + (D_8018EDE4_ovl5 * 8)));
                        return;
                    }
                    D_8018EDF8_ovl5 = (u32) D_8018EDE8_ovl5;
                    auFunc80020C88();
                    play_sound(get_sound_id_from_index(D_8018EDE8_ovl5));
                    return;
                }
                ...
                if ((gPlayerControllers->buttonPressed & 0x200) && (D_8018EDE1_ovl5 == 1)) {
                    *temp_a2 = 1;
                    D_800EA8A0[D_8018EDEC_ovl5] = -4.0f;
                    D_8018EDE1_ovl5 = 0;
                    D_800E9AA0[D_8018EDEC_ovl5].as_u32 = 0;
                    auFunc80020C88();
                    D_8018EDF4_ovl5 = 0x1869F;
                    play_sound(0x113);
                    return;
                }
                if ((gPlayerControllers->buttonPressed & 0x100) && (D_8018EDE1_ovl5 == 0)) {
                    play_sound(0x113);
                    D_800E98E0[D_8018EDEC_ovl5] = 1;
                    D_800EA8A0[D_8018EDEC_ovl5] = 4.0f;
                    D_8018EDE1_ovl5 = 1;
                ...
                if (gPlayerControllers->buttonHeld & 0x800) {
                    if (D_8018EDE1_ovl5 == 0) {
                        var_v1 = 1;
                        if (D_800E9C60[temp_a0_2] >= 0x29) {
                            var_v1 = 0xA;
                        }
                        temp_t7 = D_8018EDE4_ovl5 + var_v1;
                        D_8018EDE4_ovl5 = temp_t7;
                        if (temp_t7 >= 0x3E) {
                            D_8018EDE4_ovl5 = temp_t7 - 0x3E;
                        }
                    } else {
                        var_v1_2 = 1;
                        if (D_800E9C60[temp_a0_2] >= 0x29) {
                        ...
                        temp_t6 = D_8018EDE8_ovl5 + var_v1_2;
                        D_8018EDE8_ovl5 = temp_t6;
                        if (D_8018EDFC_ovl5 < temp_t6) {
                            D_8018EDE8_ovl5 = (temp_t6 - D_8018EDFC_ovl5) - 1;
                        }
                    }
                    temp_a0_4 = omCurrentObj->objId;
                    if (D_800E9C60[temp_a0_4] >= 0x10) {
                        D_800E9AA0[temp_a0_4].as_u32 = (u32) (s32) 1.0f;
                        return;
                    }
                    D_800E9AA0[temp_a0_4].as_u32 = (u32) (s32) 5.0f;
                    return;
                }
                if (gPlayerControllers->buttonHeld & 0x400) {
                    if (D_8018EDE1_ovl5 == 0) {
                        ...
                        temp_t4 = D_8018EDE4_ovl5 - var_v1_3;
                        D_8018EDE4_ovl5 = temp_t4;
                        if (temp_t4 < 0) {
                            D_8018EDE4_ovl5 = temp_t4 + 0x3E;
                        }
                    } else {
                        var_v1_4 = 1;
                        if (D_800E9C60[temp_a0_2] >= 0x29) {
                        ...
                        temp_t9 = D_8018EDE8_ovl5 - var_v1_4;
                        D_8018EDE8_ovl5 = temp_t9;
                        if (temp_t9 < 0) {
                            D_8018EDE8_ovl5 = temp_t9 + D_8018EDFC_ovl5 + 1;
                        }
                    }
                    temp_a0_5 = omCurrentObj->objId;
                    if (D_800E9C60[temp_a0_5] >= 0x10) {
                        D_800E9AA0[temp_a0_5].as_u32 = (u32) (s32) 1.0f;
                        return;
                    }
                    D_800E9AA0[temp_a0_5].as_u32 = (u32) (s32) 5.0f;
                }
            }
        }
    }
