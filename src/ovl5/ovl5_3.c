 ...
 * animation, 1 retime it to func_8016A69C_ovl5's frame for the current
 * difficulty, 2 play the bonked sequence (drop, shrink, respawn). */
void func_8016626C_ovl5(GObj *arg0, s32 arg1) {
    ...
    func_800AECC0(0.0f);
    func_800AED20(0.0f);
    gEntitiesNextPosXArray[omCurrentObj->objId] = ((f32) (arg1 % 8) * 300.0f) - 1050.0f;
    gEntitiesNextPosYArray[omCurrentObj->objId] = 0.0f;
    gEntitiesNextPosZArray[omCurrentObj->objId] = ((f32) row * 300.0f) - 1050.0f;
