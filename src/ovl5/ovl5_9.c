...
// RESOLVED. This was a padding trap -- 4 words of fill sat after the
// listing's .size, so decompiling the function shortened the object and shifted
// everything after it in the segment. It is CLOSED now: a `pad` subsegment (kirby64.yaml, `- [0x126AC0, pad]`)
