...
extern f32 D_801F4C20_ovl10;
extern f32 D_801F4C24_ovl10;
extern f32 D_801F4C28_ovl10;
extern f32 D_801F4C2C_ovl10;
extern f32 D_801F4C30_ovl10;
extern f32 D_801F4C34_ovl10;
extern f32 D_801F4C38_ovl10;
...
void func_801EF3F0_ovl10(struct GObj *this) {
    ...
    D_800E3750[omCurrentObj->objId] = D_801F4C20_ovl10;
    D_800E3C90[omCurrentObj->objId] = 8.0f;
    if (D_800EC2E0[omCurrentObj->objId].as_s32 == 1) {
        D_800E64D0[omCurrentObj->objId] *= D_801F4C24_ovl10;
        D_800E3750[omCurrentObj->objId] *= D_801F4C24_ovl10;
        D_800E3210[omCurrentObj->objId] *= D_801F4C24_ovl10;
    }
    if (D_800EC2E0[omCurrentObj->objId].as_s32 == 2) {
        D_800E64D0[omCurrentObj->objId] *= D_801F4C28_ovl10;
        D_800E3750[omCurrentObj->objId] *= D_801F4C28_ovl10;
        D_800E3210[omCurrentObj->objId] *= D_801F4C28_ovl10;
    }
    if (D_800EC2E0[omCurrentObj->objId].as_s32 == 3) {
        gEntitiesNextPosYArray[omCurrentObj->objId] += 20.0f;
        D_800E64D0[omCurrentObj->objId] *= D_801F4C2C_ovl10;
    }
    D_800E8920[omCurrentObj->objId] = 0;
    while (D_800E8920[omCurrentObj->objId] == 0) {
        ohSleep(1);
    }
    D_800E64D0[omCurrentObj->objId] *= D_801F4C30_ovl10;
    D_800E3210[omCurrentObj->objId] = D_801F4C34_ovl10;
    D_800E3750[omCurrentObj->objId] = D_801F4C38_ovl10;
    D_800E3C90[omCurrentObj->objId] = 8.0f;
    D_800E8920[omCurrentObj->objId] = 0;
    while (D_800E8920[omCurrentObj->objId] == 0) {
        ohSleep(1);
