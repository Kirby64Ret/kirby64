...
void func_801DB770_ovl10(GObj *obj) {
    ...
    if (D_800EC2E0[omCurrentObj->objId].as_u32 == 0) {
        ...
        obj->data.dobj->pos.v.x = gEntitiesNextPosXArray[omCurrentObj->objId];
        obj->data.dobj->pos.v.y = gEntitiesNextPosYArray[omCurrentObj->objId];
        obj->data.dobj->pos.v.z = gEntitiesNextPosZArray[omCurrentObj->objId];
        obj->data.dobj->angle.v.x = gEntitiesAngleXArray[omCurrentObj->objId];
        obj->data.dobj->angle.v.y = gEntitiesAngleYArray[omCurrentObj->objId];
        obj->data.dobj->angle.v.z = gEntitiesAngleZArray[omCurrentObj->objId];
        obj->data.dobj->scale.v.x = gEntitiesScaleXArray[omCurrentObj->objId];
        obj->data.dobj->scale.v.y = gEntitiesScaleYArray[omCurrentObj->objId];
        obj->data.dobj->scale.v.z = gEntitiesScaleZArray[omCurrentObj->objId];
