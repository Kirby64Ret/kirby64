...
void func_80198DBC_ovl7(void) {
    ...
    if (temp_v0 != NULL) {
        ...
        if (temp_v0->unk10 != 0) {
            ...
            temp_a0 = (*(&D_800E1B50 + (temp_v1_2 * 4)))->unk84;
            if ((D_800DD710[temp_v1_2] == 0x1A) && (((temp_a1 = D_800E0D50[temp_v1_2], var_v0 = temp_a1 * 4, (temp_a1 != -1)) && (D_800DD710[temp_a1] == 0x17)) || (var_v0 = temp_a1 * 4, (D_800DD710[temp_a1] == 0x12))) && (temp_a0 != NULL)) {
                ...
                if (D_800E0D50[omCurrentObj->objId] == 0) {
                    temp_a0->unk8 = temp_a0->unk8 + 20.0f;
                }
...
void func_80199084_ovl7(void) {
    ...
    if ((var_a3 != 0) && (var_a1 != 0)) {
        ...
        (*(&D_800DE350 + (temp_v0_2 * 4)))->unk3C->unk1C = gEntitiesNextPosXArray[temp_v0_2];
        temp_v0_3 = omCurrentObj->objId;
        (*(&D_800DE350 + (temp_v0_3 * 4)))->unk3C->unk20 = gEntitiesNextPosYArray[temp_v0_3];
        temp_v0_4 = omCurrentObj->objId;
        (*(&D_800DE350 + (temp_v0_4 * 4)))->unk3C->unk24 = gEntitiesNextPosZArray[temp_v0_4];
        var_a0 = omCurrentObj->objId;
        var_a2 = D_800E7730[var_a0];
    }
    if (var_a2 == 6) {
...
void func_80199384_ovl7(void) {
    ...
    if (temp_v0 != NULL) {
        ...
        if (temp_a0 != NULL) {
            ...
            if (temp_v0_2 != -1) {
                if (temp_v0_2 != NULL) {
                    temp_v0_2(*(&D_800DE350 + temp_a1), temp_a1);
                    var_v1 = omCurrentObj->objId;
                }
...
s32 func_80199628_ovl7(s32 arg0) {
    ...
    temp_v1 = omCurrentObj->objId;
    temp_a1 = (*(&D_800E1B50 + (temp_v1 * 4)))->unk9C;
    var_v0 = 0;
    if (temp_a1 != 0) {
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_801997C0_ovl7.s")
#endif

#ifdef MIPS_TO_C

void func_8019985C_ovl7(s32 arg0) {
    void *sp1C;
    void *temp_v1;
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019985C_ovl7.s")
#endif

#ifdef MIPS_TO_C

void func_80199918_ovl7(s32 arg0) {
    (*(&D_800E1B50 + (omCurrentObj->objId * 4)))->unk40 = 1;
...
void func_80199A38_ovl7(s32 arg0) {
    ...
    if (temp_v0 & 0xE3F) {
        if (temp_v0 & 0xE00) {
            ...
            if (temp_a0 != 0) {
                sp1C = temp_a3;
                var_f12 = func_800F8824(temp_a0, D_800E17D0[temp_v1->objId], temp_a2_2, temp_a3);
            } else {
                var_f12 = 0.0f;
            }
        } else if (temp_v0 & 7) {
        ...
        temp_a2_3 = temp_v1->objId;
        var_f0 = D_800EB320[temp_a2_3] + var_f12;
        ...
        if ((var_f0 >= 2.3561945f) && (var_f0 < 3.9269907f)) {
            D_800E83E0[temp_a2_3] = 1;
            temp_a3->unk44 = 1;
            gEntityVtableIndexArray[omCurrentObj->objId] = -1;
            assign_new_process_entry(NULL, 1.5707964f, gEntityGObjProcessArray[omCurrentObj->objId], &func_801A6DF0_ovl7, temp_a2_3 * 4, temp_a3);
            return;
        }
        if ((var_f0 >= 1.9198622f) && (var_f0 < 4.363323f)) {
            D_800E9AA0[temp_a2_3] = 0xF;
        ...
        temp_a3->unk44 = 1;
        gEntityVtableIndexArray[omCurrentObj->objId] = -1;
        assign_new_process_entry(gEntityGObjProcessArray[omCurrentObj->objId], (bitwise f32) &func_801A6DF0_ovl7, temp_a2_2, temp_a3);
    }
}
#else
...
void func_80199D50_ovl7(void) {
    ...
    temp_v1 = omCurrentObj->objId;
    temp_a2 = *(&D_800E1B50 + (temp_v1 * 4));
    if (!(D_800E8AE0[temp_v1] & 1)) {
        D_800E8920[temp_v1] = 0;
        D_800E83E0[omCurrentObj->objId] = 1;
        temp_a2->unk44 = 1;
        gEntityVtableIndexArray[omCurrentObj->objId] = -1;
        assign_new_process_entry(gEntityGObjProcessArray[omCurrentObj->objId], &func_801A6DF0_ovl7, temp_a2, &omCurrentObj);
        return;
    }
    func_80199A38_ovl7(temp_a2, &omCurrentObj);
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199D50_ovl7.s")
#endif
...
void func_80199E14_ovl7(s32 arg0) {
    ...
    (*(&D_800E1B50 + (omCurrentObj->objId * 4)))->unk98 = &D_801CD2AC_ovl7;
    temp_a0 = omCurrentObj->objId;
    D_800E3210[temp_a0] = D_800EA6E0[temp_a0];
    temp_a0_2 = omCurrentObj->objId;
    D_800E3750[temp_a0_2] = -D_800EA8A0[temp_a0_2];
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199E14_ovl7.s")
#endif
...
void func_80199E90_ovl7(s32 arg0) {
    ...
    (*(&D_800E1B50 + (omCurrentObj->objId * 4)))->unk98 = &D_801CD288_ovl7;
    D_800E3750[omCurrentObj->objId] = 0.0f;
    temp_a0 = omCurrentObj->objId;
    D_800E3210[temp_a0] = D_800E3750[temp_a0];
    D_800E3C90[omCurrentObj->objId] = 65535.0f;
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199E90_ovl7.s")
#endif
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199F1C_ovl7.s")
#endif

#ifdef MIPS_TO_C

void func_80199F58_ovl7(s32 arg0) {
    (*(&D_800E1B50 + (omCurrentObj->objId * 4)))->unk3C = 0;
    D_800E9020[omCurrentObj->objId] = 0.0f;
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199F58_ovl7.s")
#endif

#ifdef MIPS_TO_C
void func_80199FA0_ovl7(s32 arg0) {
    D_800E8920[omCurrentObj->objId] = 0;
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_80199FA0_ovl7.s")
#endif

#ifdef MIPS_TO_C
void func_80199FC4_ovl7(s32 arg0) {
    u32 temp_v1;
...
#ifdef MIPS_TO_C
void func_8019A4C0_ovl7(s32 arg0) {
    u32 temp_v1;

    D_800E3210[omCurrentObj->objId] = 0.0f;
    temp_v1 = omCurrentObj->objId;
    D_800E64D0[temp_v1] = D_800E3210[temp_v1];
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019A4C0_ovl7.s")
#endif

#ifdef MIPS_TO_C
void func_8019A508_ovl7(s32 arg0) {
    u32 temp_v1;
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019A508_ovl7.s")
#endif
...
void func_8019A62C_ovl7(s32 arg0) {
    ...
    temp_v0 = omCurrentObj->objId;
    if ((*(&D_800E1B50 + (temp_v0 * 4)))->unk3C == 0) {
...
void func_8019A740_ovl7(s32 arg0) {
    *(&D_8012E7C5 + 8) = -2;
    gEntityVtableIndexArray[omCurrentObj->objId] = -1;
    assign_new_process_entry(gEntityGObjProcessArray[omCurrentObj->objId], &func_801AC448_ovl7);
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019A740_ovl7.s")
#endif
...
void func_8019AF00_ovl7(f32 arg0) {
    ...
    temp_f2 = sinf(D_800EB320[omCurrentObj->objId]) * arg0;
    sp1C = temp_f2;
    temp_f0 = cosf(D_800EB320[omCurrentObj->objId]);
    D_800E6690[omCurrentObj->objId] = temp_f2 * 0.5f;
    if (temp_f2 < 0.0f) {
        var_f12 = -temp_f2;
    } else {
        var_f12 = temp_f2;
    ...
    if (var_f12 < 0.0f) {
        ...
        D_800E6850[omCurrentObj->objId] = -var_f14;
    } else {
        if (temp_f2 < 0.0f) {
            var_f12_2 = -temp_f2;
        } else {
        ...
        D_800E6850[omCurrentObj->objId] = var_f12_2;
    }
    temp_v1 = omCurrentObj->objId;
    temp_f2_2 = temp_f0 * arg0;
    D_800E3750[temp_v1] = D_800EB160[temp_v1] + (temp_f2_2 * 0.5f);
    if (temp_f2_2 < 0.0f) {
        var_f14_2 = -temp_f2_2;
    } else {
        var_f14_2 = temp_f2_2;
    ...
    temp_v1_2 = omCurrentObj->objId;
    temp_f0_2 = D_800EB160[temp_v1_2];
    if (temp_f0_2 < 0.0f) {
        var_f12_3 = -temp_f0_2;
    } else {
        var_f12_3 = temp_f0_2;
    }
    if ((var_f12_3 + var_f14_2) < 0.0f) {
        if (temp_f2_2 < 0.0f) {
            var_f14_3 = -temp_f2_2;
        } else {
            var_f14_3 = temp_f2_2;
        ...
        D_800E3C90[temp_v1_2] = -(var_f12_4 + var_f14_3);
        return;
    }
    if (temp_f2_2 < 0.0f) {
        var_f12_5 = -temp_f2_2;
    ...
    D_800E3C90[temp_v1_2] = var_f2 + var_f12_5;
}
#else
...
void func_8019B2C0_ovl7(s32 arg0) {
    ...
    temp_v0 = omCurrentObj->objId;
    temp_a2 = (*(&D_800E1B50 + (temp_v0 * 4)))->unk78;
    if (temp_a2 != 0) {
        ...
        switch (arg0) {                             /* irregular */
            case 1:
                (*(&D_800DE350 + (omCurrentObj->objId * 4)))->unk3C->unk10->unk30 = -var_f2;
                return;
            case 2:
                temp_v0_2 = omCurrentObj->objId;
                (*(&D_800DE350 + (temp_v0_2 * 4)))->unk3C->unk10->unk38 = var_f2 * D_800E6A10[temp_v0_2];
                break;
        }
    }
}
...
void func_8019B424_ovl7(s32 arg0) {
    ...
    sp24 = *(&D_800E1B50 + (omCurrentObj->objId * 4));
...
s32 func_8019B834_ovl7(void) {
    ...
    if ((func_8019A900_ovl7(&sp1C) != 0) && (sp1C != D_800E6A10[omCurrentObj->objId]) && (func_800A4F48(D_800D799C->unk3C, &sp24, 1.075f, 1.075f) == 0)) {
        return 1;
    }
    return 0;
}
...
void func_8019C71C_ovl7(f32 arg0) {
    ...
    sp1C = *(&D_800E1B50 + (omCurrentObj->objId * 4));
...
void func_8019C844_ovl7(void *arg0) {
    ...
    *temp_v0_4 = -*temp_v0_4;
    temp_a1 = omCurrentObj->objId;
    D_800E64D0[temp_a1] = D_800E6A10[temp_a1] * arg0->unk0;
    temp_a1_2 = omCurrentObj->objId;
    D_800E6690[temp_a1_2] = D_800E6A10[temp_a1_2] * arg0->unk4;
    temp_f0 = arg0->unk8;
    if (temp_f0 < 0.0f) {
...
void func_8019C9B0_ovl7(f32 arg0, u8 arg1) {
    ...
    var_a1 = arg1 & 0xFF;
    temp_a2 = *(&D_800E1B50 + (omCurrentObj->objId * 4));
...
void func_8019CD68_ovl7(void) {
    ...
    sp2C->unkC = gEntitiesNextPosXArray[omCurrentObj->objId] + sp20;
    sp2C->unk14 = gEntitiesNextPosZArray[omCurrentObj->objId] + sp28;
}
#else
...
s32 func_8019CE28_ovl7(void) {
    ...
    temp_f0 = gEntitiesNextPosXArray[temp_v1] - temp_v0->unkC;
    temp_f2 = gEntitiesNextPosZArray[temp_v1] - temp_v0->unk14;
    if (D_800E6A10[temp_v1] == 1.0f) {
        if (!(temp_f0 >= 0.0f)) {
            if (temp_f0 < 0.0f) {
                var_f12 = -temp_f0;
...
void func_8019D214_ovl7(void) {
    ...
    sp28 = 0.0f;
    sp2C = 0.0f;
    temp_a3 = *(&D_800E1B50 + (temp_v0 * 4));
    sp34 = temp_a3;
    sp30 = D_800E6A10[omCurrentObj->objId] * temp_a3->unk1C;
    lbvector_Rotate(&sp28, 2, -D_800E6A10[temp_v0] * gEntitiesAngleYArray[temp_v0]);
    sp34->unkC = gEntitiesNextPosXArray[omCurrentObj->objId] + sp28;
    sp34->unk14 = gEntitiesNextPosZArray[omCurrentObj->objId] + sp30;
}
#else
...
void func_8019D2FC_ovl7(f32 arg0, u8 arg1) {
    ...
    temp_a0 = *(&D_800E1B50 + (omCurrentObj->objId * 4));
...
void func_8019D8A0(s32 arg0) {
    ...
    sp24 = temp_v0;
    func_800A2300(*(&D_800DE350 + temp_v1));
    temp_v0->unk34 = 0;
    func_8019BBA8_ovl7(temp_s0);
    func_801A32A8_ovl7(temp_s0);
    temp_v1_2 = D_800E76C0[temp_s0];
    temp_v0_2 = temp_v1_2 + (&D_800D6C68 + 0x28);
    if (temp_v1_2 < 0x40) {
        *temp_v0_2 &= 0x80;
    }
...
void func_8019D958_ovl7(s32 arg0) {
    ...
    temp_a1_2 = temp_v1 + &D_800DE350;
    sp24 = temp_a1_2;
    sp2C = temp_v0;
    func_800A2300(*temp_a1_2, temp_a1_2);
    temp_v0->unk34 = 0;
    (*temp_a1_2)->unk48 = 0;
    func_8019BBA8_ovl7(temp_s0, temp_a1_2);
    func_801A32A8_ovl7(temp_s0);
    temp_v1_2 = D_800E76C0[temp_s0];
    if (temp_v1_2 < 0x40) {
        temp_v0_2 = temp_v1_2 + (&D_800D6C68 + 0x28);
        if ((D_801290E0 + (temp_v1_2 * 0x2C))->unk5 & 1) {
            *temp_v0_2 &= 0x80;
        }
    }
    func_800B1900(temp_s0 & 0xFFFF);
...
f32 func_8019DA70_ovl7(s32 arg0) {
    ...
    if (temp_f0 == 9999.0f) {
        temp_v0_2 = omCurrentObj->objId;
        temp_f0_2 = gEntitiesNextPosXArray[temp_v0_2] - gEntitiesNextPosXArray[arg0];
        temp_f2 = gEntitiesNextPosZArray[temp_v0_2] - gEntitiesNextPosZArray[arg0];
...
void func_8019DB58_ovl7(s32 arg0, s32 arg1) {
    ...
    temp_v0 = &D_800E76C0[arg0];
    D_800E76C0[arg1] = *temp_v0;
    *temp_v0 = 0xFF;
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019DB58_ovl7.s")
#endif

#ifdef MIPS_TO_C

s32 func_8019DB7C_ovl7(u8 arg0, u8 arg1, u8 arg2) {
    s32 sp1C;
    f32 temp_f0;
    s32 temp_a1;
    s32 temp_v0;
    ...
    D_800E7730[temp_v0] = arg0;
    D_800E77A0[temp_v0] = arg1;
    D_800E7880[temp_v0] = arg2;
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/ovl7/enelib/func_8019DB7C_ovl7.s")
#endif
