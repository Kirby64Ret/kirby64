...
void func_80222220_ovl18(UNUSED s32 arg0) {
    ...
    utilFuncTableJump(D_800E7880[omCurrentObj->objId], 1, &D_8022AB80_ovl18[20]);
}

void func_80222280_ovl18(UNUSED s32 arg0) {
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[21]);
}

void func_802222C8_ovl18(UNUSED s32 arg0) {
    struct EnemyRecord *tmp = D_800E1B50[omCurrentObj->objId];
    func_8021F4A0_ovl18();
    tmp->unk98 = &D_8022A9AC_ovl18;
    ...
    func_801A0D50_ovl7(&func_80222280_ovl18);
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[21]);
}

void func_802223D8_ovl18(void) {
    if (func_801A0D74_ovl7() == 0) {
        utilFuncTableJump(D_800DDFD0[omCurrentObj->objId], 1, &D_8022AB80_ovl18[22]);
    }
    func_8021F5CC_ovl18();
}
...
void func_80222510_ovl18(UNUSED s32 arg0) {
    D_800DEF90[omCurrentObj->objId] = &func_800B72AC;
    utilFuncTableJump(D_800E7880[omCurrentObj->objId], 1, &D_8022AB80_ovl18[23]);
}

void func_80222570_ovl18(UNUSED s32 arg0) {
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[24]);
}
...
void func_802225B8_ovl18(UNUSED s32 *arg0) {
    ...
    func_8021F4A0_ovl18();
    sp1C->unk98 = &D_8022A9D0_ovl18;
    D_800DF150[omCurrentObj->objId] = &func_802226E0_ovl18;
    gEntitiesScaleZArray[omCurrentObj->objId] = 2.0f;
    gEntitiesScaleXArray[omCurrentObj->objId] = gEntitiesScaleYArray[omCurrentObj->objId] = gEntitiesScaleZArray[omCurrentObj->objId];
    func_8019BC34_ovl7(120.0f);
    gEntityFuncListIDArray[omCurrentObj->objId] = 0;
    func_801A0D50_ovl7(&func_80222570_ovl18);
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[24]);
}

void func_802226E0_ovl18(void) {
    if (func_801A0D74_ovl7() == 0) {
        utilFuncTableJump(D_800DDFD0[omCurrentObj->objId], 1, &D_8022AB80_ovl18[25]);
    }
    eneTurnCommon(1);
...
void func_80222748_ovl18(UNUSED s32 arg0) {
    ...
    curObjSleepForever(&D_800E6690, D_800E64D0, &D_800E6850);
}
...
void func_80222898_ovl18(UNUSED s32 arg0) {
    ...
    utilFuncTableJump(D_800E7880[omCurrentObj->objId], 1, &D_8022AB80_ovl18[26]);
}

void func_802228F8_ovl18(UNUSED s32 arg0) {
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 7, &D_8022AB80_ovl18[27]);
}
...
void func_80222A54_ovl18(s32 arg0) {
    ...
    temp_v0 = func_801A0D74_ovl7();
    if (D_800E9C60[omCurrentObj->objId] != 0) {
        func_8019B424_ovl7(arg0);
    }
    if (temp_v0 == 0) {
        utilFuncTableJump(D_800DDFD0[omCurrentObj->objId], 7, &D_8022AB80_ovl18[34]);
    }
    if (D_800E9C60[omCurrentObj->objId] != 0) {
        eneTurnCommon(6);
    }
...
void func_80222B10_ovl18(UNUSED s32 arg0) {
    ...
    temp_a1->unk98 = &D_8022A9F4_ovl18;
    D_800DDFD0[omCurrentObj->objId] = 0;
...
void func_80222BB4_ovl18(UNUSED s32 arg0) {
    ...
    if (tmp->unk3C == 0 && func_8019A7E8_ovl7(560.0f) != 0) {
        gEntityFuncListIDArray[omCurrentObj->objId] = func_8019B260_ovl7(80.0f) == 1 ? 1 : 3;
...
void func_80222C84_ovl18(UNUSED s32 arg0) {
    ...
    temp_a1->unk98 = &D_8022AA3C_ovl18;
...
void func_80222DA4_ovl18(UNUSED s32 arg0) {
    struct EnemyRecord *temp_a2 = D_800E1B50[omCurrentObj->objId];
...
block_2:
            ...
            temp_a2->unk98 = &D_8022AA18_ovl18;
...
void func_8022309C_ovl18(UNUSED s32 arg0, s32 arg1, f32 arg2) {
    ...
    if (arg1 == 0) {
        if ((s32)arg2 == 1) {
            func_801ACCA0_ovl7(0x2F, 0, 64.0f, 0);
            temp_v0 = func_801AE940_ovl7(5, 0, -40.0f);
...
void func_80223684_ovl18(UNUSED s32 arg0) {
    D_800DEF90[omCurrentObj->objId] = &func_800B7138;
    utilFuncTableJump(D_800E7880[omCurrentObj->objId], 1, &D_8022AB80_ovl18[41]);
}

void func_802236E4_ovl18(UNUSED s32 arg0) {
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[42]);
}
...
void func_8022372C_ovl18(UNUSED s32 arg0) {
    ...
    func_8021F4A0_ovl18();
    sp1C->unk98 = &D_8022AA60_ovl18;
    D_800DF150[omCurrentObj->objId] = &func_8022383C_ovl18;
    gEntitiesScaleZArray[omCurrentObj->objId] = 1.5f;
    gEntitiesScaleXArray[omCurrentObj->objId] = gEntitiesScaleYArray[omCurrentObj->objId] = gEntitiesScaleZArray[omCurrentObj->objId];
    gEntityFuncListIDArray[omCurrentObj->objId] = 0;
    func_801A0D50_ovl7(&func_802236E4_ovl18);
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 1, &D_8022AB80_ovl18[42]);
}

void func_8022383C_ovl18(void) {
    if (func_801A0D74_ovl7() == 0) {
        utilFuncTableJump(D_800DDFD0[omCurrentObj->objId], 1, &D_8022AB80_ovl18[43]);
    }
    eneTurnCommon(6);
    func_8021F5CC_ovl18();
}
...
void func_8022396C_ovl18(UNUSED s32 arg0) {
    ...
    utilFuncTableJump(D_800E7880[omCurrentObj->objId], 1, &D_8022AB80_ovl18[44]);
}

void func_802239CC_ovl18(UNUSED s32 arg0) {
    utilFuncTableJump(gEntityFuncListIDArray[omCurrentObj->objId], 5, &D_8022AB80_ovl18[45]);
}
...
void func_80223B4C_ovl18(UNUSED s32 arg0) {
    ...
    utilFuncTableJump(D_800DDFD0[omCurrentObj->objId], 5, &D_8022AB80_ovl18[50]);
    func_8021F5CC_ovl18();
}
...
void func_80223BB8_ovl18(void) {
    ...
    gEntitiesNextPosXArray[omCurrentObj->objId] = D_8022AC5C_ovl18[phi_v1];
