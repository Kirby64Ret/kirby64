...
void func_80223200_ovl19(GObj *arg0) {
    ...
    if (var_a0 == -1) {
        D_800E9FE0[D_8004A7C4->objId].as_u32 = 0;
        ...
        D_800E0490[D_8004A7C4->objId] = &D_80192FF4;
    ...
    loop_9:
                if (D_800E6850[D_8004A7C4->objId] > 4.0f) {
                    ...
                    if (rand != D_800E9AA0[D_8004A7C4->objId]) {
        ...
        case 2:
            ...
            if (!(gEntitiesAngleXArray[D_8004A7C4->objId] > 0.0f) || !(gEntitiesAngleXArray[D_8004A7C4->objId] >= 0.7853982f)) {
                D_800EC2E0[1].as_u32 = temp_v0->unk8;
                D_800EC4A0[1] = temp_v0->unkC;
                D_800EC2E0[2].as_u32 = temp_v0->unk10;
                D_800EC4A0[2] = temp_v0->unk14;
        ...
        case 4:
            ...
            gKirbyState.unk3C = 1;
            D_800E8920[D_8004A7C4->objId] = 0;
            D_800E3210[D_8004A7C4->objId] = 18.0f;
            D_800E3750[D_8004A7C4->objId] = -0.980665f;
            D_800E3C90[D_8004A7C4->objId] = 18.0f;
        ...
        case 5:
            func_80020C88();
            func_800A7EB4();
            if (D_800E9FE0[D_8004A7C4->objId].as_u32 != 0) {
                func_800B1900(D_800E9FE0[D_8004A7C4->objId].as_u32);
            }
            func_80227C88_ovl19();
            play_sound(0x144);
            D_800E8920[D_8004A7C4->objId] = 0;
        ...
        case 7:
            ...
            D_800E6850[D_8004A7C4->objId] = 18.0f;
...
void func_80228EF4_ovl19(GObj *arg0) {
    ...
    omSleep(0x1E);
    D_800E64D0[D_8004A7C4->objId] = D_800E6690[D_8004A7C4->objId] = 0;
    D_800E6850[D_8004A7C4->objId] = 65535.0f;
    D_800E3210[D_8004A7C4->objId] = D_800E3750[D_8004A7C4->objId] = 0;
    D_800E3C90[D_8004A7C4->objId] = 65535.0f;
    func_800AFA14();
}
