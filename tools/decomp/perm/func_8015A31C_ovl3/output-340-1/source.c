...
void func_8015A31C_ovl3(s32 arg0)
{
  ...
  {
    case 1:
      new_var3 = D_800E6BD0[omCurrentObj->objId];
      if ((D_800E5F90[omCurrentObj->objId] == 5) && (D_80196FB4_ovl3 <= new_var3))
    {
 ...
 dummy_label_239999: ;
    ...
    {
      case 2:
        if (gKirbyState.unk30 != new_var)
      {
        D_800BE52C = D_800BE500;
        D_800BE530 = D_800BE504;
        D_800BE534 = D_800BE508 + 1;
 do { new_var2 = 0; D_800BE538 = new_var2; } while (0);
        D_800BE4FC = 1;
        D_800BE4F8 = 2;
        gKirbyState.unk30 = new_var2;
      }
        break;
